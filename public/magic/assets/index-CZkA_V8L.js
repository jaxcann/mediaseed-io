...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ps(e,t,n){let r=new Float32Array(bs),i=new H(0,1,0);return new Aa({name:`SphericalGaussianBlur`,defines:{n:bs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ls(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(){return new Aa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ls(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Is(){return new Aa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ls(),fragmentShader:`
	...
	`}var Rs=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=tl(i,i.VERTEX_SHADER,y),S=tl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=sl(i,x,`vertex`),n=sl(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      }`,depthTest:!1,depthWrite:!1}),g=zu(m),v=new Aa({uniforms:{tSrc:{value:o.texture},threshold:{value:Lu.bloomThreshold}},vertexShader:Ru,fragmentShader:`uniform sampler2D tSrc; uniform float threshold; varying vec2 vUv;
      void main(){ vec3 c = texture2D(tSrc, vUv).rgb; float l = dot(c, vec3(0.299,0.587,0.114));
        float k = smoothstep(threshold, threshold + 0.35, l); gl_FragColor = vec4(c * k, 1.0); }`,depthTest:!1,depthWrite:!1}),y=new Aa({uniforms:{tSrc:{value:null},dir:{value:new V(1,0)},res:{value:new V(1,1)}},vertexShader:Ru,fragmentShader:`uniform sampler2D tSrc; uniform vec2 dir, res; varying vec2 vUv;
      void main(){ vec2 px = dir / res; vec3 s = texture2D(tSrc, vUv).rgb * 0.227;
        ...
        gl_FragColor = vec4(s, 1.0); }`,depthTest:!1,depthWrite:!1}),b=zu(v),x=zu(y),S=new Aa({uniforms:{tDiffuse:{value:l.texture},tBloom:{value:u.texture},bloomAmount:{value:Lu.bloomAmount},res:{value:new V(1,1)}},vertexShader:Ru,fragmentShader:`
      ...
      void main(){
        ...
        gl_FragColor = vec4(col, 1.0);
        #include <colorspace_fragment>
      }`,depthTest:!1,depthWrite:!1}),C=zu(S);function w(t,n){let a=e.getPixelRatio();r=Math.floor(t*a),i=Math.floor(n*a),o.setSize(r,i),c.setSize(r,i),l.setSize(r,i),u.setSize(Math.max(1,r>>2),Math.max(1,i>>2)),d.setSize(Math.max(1,r>>2),Math.max(1,i>>2)),m.uniforms.res.value.set(r,i),S.uniforms.res.value.set(r,i),y.uniforms.res.value.set(r>>2,i>>2),m.uniforms.thick.value=Lu.thickness*Math.max(1,a*.75)}let T=new K;function E(){e.shadowMap.needsUpdate=!0;let r=m.uniforms;r.near.value=n.near,r.far.value=n.far,e.getClearColor(T);let i=n.layers.mask;e.setRenderTarget(o),e.render(t,n),t.overrideMaterial=f,n.layers.disable(1),e.setClearColor(8421631,1),e.setRenderTarget(c),e.render(t,n),t.overrideMaterial=null,n.layers.mask=i,e.setClearColor(T,1),e.setRenderTarget(l),e.render(g,p),v.uniforms.threshold.value=Lu.bloomThreshold,e.setRenderTarget(u),e.render(b,p),y.uniforms.tSrc.value=u.texture,y.uniforms.dir.value.set(1,0),e.setRenderTarget(d),e.render(x,p),y.uniforms.tSrc.value=d.texture,y.uniforms.dir.value.set(0,1),e.setRenderTarget(u),e.render(x,p),S.uniforms.bloomAmount.value=Lu.bloomAmount,e.setRenderTarget(null),e.render(C,p)}return{render:E,resize:w}}function Vu(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Nr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=Hu(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=Hu(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function Hu(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new vr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}function Uu(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}var Wu=new H;function Gu(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;Wu.copy(t),Wu[r]=0,Wu.normalize();let l=.5*o/(o+s),u=1-Wu.angleTo(e)/c;return Math.sign(Wu[n])===1?u*l:s/(o+s)+l+l*(1-u)}var Ku=class e extends ua{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new H,c=new H,l=new H(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new H,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=Gu(m,c,`z`,`y`,i,n),f[a+1]=1-Gu(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-Gu(m,c,`z`,`y`,i,n),f[a+1]=1-Gu(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-Gu(m,c,`x`,`z`,i,e),f[a+1]=Gu(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-Gu(m,c,`x`,`z`,i,e),f[a+1]=1-Gu(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-Gu(m,c,`x`,`y`,i,e),f[a+1]=1-Gu(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=Gu(m,c,`x`,`y`,i,e),f[a+1]=1-Gu(m,c,`y`,`x`,i,t)}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}},qu=null;function Ju(){if(qu)return qu;let e=new Uint8Array([176,212,238,252,255]);return qu=new vi(e,e.length,1,O),qu.minFilter=qu.magFilter=i,qu.needsUpdate=!0,qu}function X(e){return new Pa({color:e,gradientMap:Ju()})}function Yu(e){return new Pa({...e,gradientMap:Ju()})}function Xu(e,t,n,r=.04){return new Ku(e,t,n,2,Math.min(r,e/2,t/2,n/2))}function Zu(e,t,n,r={}){let i=new qr({...r});return i.color.setRGB(e,t,n),i}function Z(e,t){let n=Math.hypot(e,t),r=Math.sin(e*.061)*Math.cos(t*.053)*1.5+Math.sin(e*.13+1.7)*Math.sin(t*.117+.4)*.55+Math.sin((e-t)*.023+.9)*1.9+Math.sin((e+t*1.7)*.011)*2.6;return r*=Au(9,24,n),r+=Au(72,112,n)*7,r}var Qu=class{group=new An;monoliths=[];timeU={value:0};runeRing;clouds;constructor(){let e=Iu(7),t=(t,n)=>t+(n-t)*e(),n=new kn,r=new K;{let e=new va(260,260,110,110);e.rotateX(-Math.PI/2);let t=e.attributes.position,n=new Float32Array(t.count*3),i=new K(8836953),a=new K(7193163),o=new K(6074435);for(let e=0;e<t.count;e++){let s=t.getX(e),c=t.getZ(e);t.setY(e,Z(s,c));let l=(s+1e3)/8.5%2,u=l<1?Au(.9,1,l):1-Au(1.9,2,l);r.copy(i).lerp(a,u);let d=Math.sin(s*.041+1.3)*Math.sin(c*.036+4.1)+.5*Math.sin((s+c)*.019);r.lerp(o,Au(.6,1.25,d)*.6),n[e*3]=r.r,n[e*3+1]=r.g,n[e*3+2]=r.b}e.setAttribute(`color`,new vr(n,3)),e.computeVertexNormals();let s=new q(e,Yu({vertexColors:!0}));s.receiveShadow=!0,this.group.add(s)}{let e=new q(new fa(9.6,56).rotateX(-Math.PI/2),X(14472125));e.position.y=.03,e.receiveShadow=!0;let t=new q(new ya(9.6,10.5,56).rotateX(-Math.PI/2),X(13089181));t.position.y=.028,t.receiveShadow=!0,this.group.add(e,t);let n=Zu(1.9,.82,.24,{transparent:!0,opacity:.42,depthWrite:!1,blending:2});this.runeRing=new q(new ya(5.6,6.05,48,1).rotateX(-Math.PI/2),n),this.runeRing.position.y=.05,this.runeRing.layers.set(1),this.group.add(this.runeRing)}{let e=X(14274488);for(let n=0;n<8;n++){let r=n/8*Math.PI*2+.18,i=Math.cos(r)*13.2,a=Math.sin(r)*13.2,o=t(2.3,3.3);this.monoliths.push(new H(i,o,a));let s=new q(Xu(1,o,.72,.07),e);s.castShadow=s.receiveShadow=!0,s.position.set(i,Z(i,a)+o/2-.08,a),s.rotation.set(t(-.05,.05),Math.atan2(-i,-a),t(-.06,.06));let c=new q(new va(.15,o*.5),Zu(1.7,1.08,.42));c.position.set(0,.1,.39),c.layers.set(1),s.add(c),this.group.add(s)}}{let i=new Ai(new pa(.17,.31,1.8,7),X(9068348),26),a=new Ai(new ga(1,1),Yu({color:16777215}),78),o=[5551175,6800466,4694078,7982167],s=0;for(let c=0;c<26;c++){let l=e()*Math.PI*2,u=t(30,102),d=Math.cos(l)*u,f=Math.sin(l)*u,p=Z(d,f),m=t(.85,1.45);n.position.set(d,p+.85*m,f),n.rotation.set(t(-.04,.04),e()*Math.PI*2,t(-.04,.04)),n.scale.setScalar(m),n.updateMatrix(),i.setMatrixAt(c,n.matrix);let h=o[Math.floor(e()*o.length)],g=[{o:[0,2.35,0],s:t(1.5,1.95)},{o:[t(-.9,-.55),1.85,t(.35,.7)],s:t(.95,1.3)},{o:[t(.55,.9),1.95,t(-.7,-.35)],s:t(.95,1.3)}];for(let t of g)n.position.set(d+t.o[0]*m,p+t.o[1]*m,f+t.o[2]*m),n.rotation.set(e()*.4,e()*Math.PI,0),n.scale.set(t.s*m,t.s*m*.88,t.s*m),n.updateMatrix(),a.setMatrixAt(s,n.matrix),a.setColorAt(s,r.setHex(h)),s++}i.castShadow=i.receiveShadow=!0,a.castShadow=a.receiveShadow=!0,this.group.add(i,a)}{let i=new Ai(new ga(1,0),Yu({color:16777215}),30);for(let a=0;a<30;a++){let o=e()*Math.PI*2,s=t(14,108),c=Math.cos(o)*s,l=Math.sin(o)*s,u=t(.3,1.5);n.position.set(c,Z(c,l)+u*.3,l),n.rotation.set(e()*Math.PI,e()*Math.PI,e()*Math.PI),n.scale.set(u,u*t(.55,.8),u*t(.8,1.2)),n.updateMatrix(),i.setMatrixAt(a,n.matrix),i.setColorAt(a,r.setHex(12893100).offsetHSL(0,0,t(-.03,.03)))}i.castShadow=i.receiveShadow=!0,this.group.add(i)}{let i=2200,a=new va(.17,.34,1,2).translate(0,.17,0),o=Vu([a,a.clone().rotateY(Math.PI/2)]),s=Yu({color:16777215,side:2}),c=this.timeU;s.onBeforeCompile=e=>{e.uniforms.uTime=c,e.vertexShader=`uniform float uTime;
`+e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
          ...
          }`)};let l=new Ai(o,s,i),u=new K(7982159),d=new K(9690467),f=new K(6468933);for(let a=0;a<i;a++){let i=e()*Math.PI*2,o=10.8+Math.sqrt(e())*100,s=Math.cos(i)*o,c=Math.sin(i)*o;n.position.set(s,Z(s,c)-.02,c),n.rotation.set(t(-.1,.1),e()*Math.PI*2,t(-.1,.1));let p=t(.7,1.3);n.scale.set(p,p*t(.8,1.2),p),n.updateMatrix(),l.setMatrixAt(a,n.matrix);let m=e();l.setColorAt(a,r.copy(m<.5?u:m<.8?d:f))}l.layers.set(1),this.group.add(l);let p=new Ai(new ba(.075,7,5),X(16775920),150),m=new Ai(new ba(.032,6,5),X(16765501),150);for(let r=0;r<150;r++){let i=e()*Math.PI*2,a=t(12,105),o=Math.cos(i)*a,s=Math.sin(i)*a,c=Z(o,s),l=t(.8,1.3);n.position.set(o,c+.05,s),n.rotation.set(0,0,0),n.scale.set(l,l*.35,l),n.updateMatrix(),p.setMatrixAt(r,n.matrix),n.position.set(o,c+.085,s),n.scale.setScalar(l),n.updateMatrix(),m.setMatrixAt(r,n.matrix)}p.layers.set(1),m.layers.set(1),this.group.add(p,m);let h=new Ai(new ba(.05,6,5),Yu({color:16777215}),110);for(let i=0;i<110;i++){let a=e()*Math.PI*2,o=t(12,100),s=Math.cos(a)*o+t(-1,1),c=Math.sin(a)*o+t(-1,1);n.position.set(s,Z(s,c)+.06,c),n.rotation.set(0,0,0),n.scale.setScalar(t(.7,1.2)),n.updateMatrix(),h.setMatrixAt(i,n.matrix),h.setColorAt(i,r.setHex(e()<.7?16765501:16752059))}h.layers.set(1),this.group.add(h);let g=new Ai(new ga(.09,1),Yu({color:16777215}),70);for(let i=0;i<70;i++){let a=e()*Math.PI*2,o=t(12,108),s=Math.cos(a)*o,c=Math.sin(a)*o;n.position.set(s,Z(s,c)+.03,c),n.rotation.set(e()*3,e()*3,e()*3);let l=t(.6,1.6);n.scale.set(l,l*.65,l),n.updateMatrix(),g.setMatrixAt(i,n.matrix),g.setColorAt(i,r.setHex(13288116).offsetHSL(0,0,t(-.04,.02)))}g.receiveShadow=!0,this.group.add(g)}this.clouds=new Ai(new ga(1,1),Yu({color:16645119,emissive:8884920,emissiveIntensity:.38,fog:!1}),16);for(let r=0;r<16;r++){let i=e()*Math.PI*2,a=t(85,200);n.position.set(Math.cos(i)*a,t(46,74),Math.sin(i)*a),n.rotation.set(0,e()*Math.PI,0),n.scale.set(t(6.5,12),t(1.9,2.8),t(5,9)),n.updateMatrix(),this.clouds.setMatrixAt(r,n.matrix)}this.group.add(this.clouds)}update(e,t){this.timeU.value=e,this.runeRing.rotation.y=e*.08,this.clouds.rotation.y+=t*.0016}},$u=10119744,ed=7621676,td=14206106,nd=5922664,rd=13616301,id=class{ringRadius;group=new An;flames=[];banners=[];lanterns=[];constructor(e=10.6){this.ringRadius=e;let t=Iu(4242);this.buildRopeLine(t),this.buildBraziers(),this.buildBanners(),this.buildSeating(t),this.buildStalls(t,(e,n)=>e+(n-e)*t())}buildRopeLine(e){let t=this.ringRadius+1.5;for(let e=0;e<18;e++){let n=e/18*Math.PI*2,r=Math.cos(n)*t,i=Math.sin(n)*t,a=Z(r,i),o=new q(new pa(.075,.095,.92,7),X($u));o.position.set(r,a+.46,i),o.rotation.y=n,o.castShadow=o.receiveShadow=!0,this.group.add(o);let s=new q(new ba(.1,8,6),X(ed));s.position.set(r,a+.95,i),this.group.add(s);let c=(e+1)/18*Math.PI*2,l=Math.cos(c)*t,u=Math.sin(c)*t,d=Z(l,u),f=new H((r+l)/2,(a+d)/2+.72,(i+u)/2),p=new q(new pa(.028,.028,Math.hypot(l-r,u-i),5),X(td));p.position.copy(f),p.rotation.z=Math.PI/2,p.rotation.y=-Math.atan2(u-i,l-r),this.group.add(p)}}buildBraziers(){let e=this.ringRadius+.6;for(let t=0;t<4;t++){let n=t/4*Math.PI*2+Math.PI/4,r=Math.cos(n)*e,i=Math.sin(n)*e,a=Z(r,i),o=new q(new ma(.38,1.25,4,1,!0),X(nd));o.position.set(r,a+.62,i),o.rotation.y=Math.PI/4;let s=new q(new pa(.44,.3,.32,8),X(nd));s.position.set(r,a+1.32,i);let c=new q(new ba(.34,8,6),X(3812134));c.position.set(r,a+1.42,i),o.castShadow=s.castShadow=!0,this.group.add(o,s,c);for(let e=0;e<5;e++){let t=e/5*Math.PI*2,n=new q(new ma(.14,.66,5),new qr({color:new K(e%2?3.4:2.8,e%2?1.4:.85,.2)}));n.position.set(r+Math.cos(t)*.16,a+1.75,i+Math.sin(t)*.16),n.layers.set(1),this.flames.push(n),this.group.add(n)}}}buildBanners(){let e=this.ringRadius+3.4,t=[4019668,14241599,5212732,14201423,8343512,14711359];for(let n=0;n<6;n++){let r=n/6*Math.PI*2+.35,i=Math.cos(r)*e,a=Math.sin(r)*e,o=Z(i,a),s=new q(new pa(.075,.095,5.2,7),X(ed));s.position.set(i,o+2.6,a),s.castShadow=!0;let c=new q(new _a(.17,0),X(14201423));c.position.set(i,o+5.3,a),this.group.add(s,c);let l=new q(new va(.92,1.75,6,5),Yu({color:t[n],side:2}));l.position.set(i+Math.cos(r)*.5,o+3.85,a+Math.sin(r)*.5),l.rotation.y=r+Math.PI/2,l.castShadow=!0,this.banners.push({mesh:l,phase:n*1.7}),this.group.add(l)}}buildSeating(e){let t=this.ringRadius+5.6;for(let n=0;n<7;n++){let r=n/7*Math.PI*2+.9,i=Math.cos(r)*t,a=Math.sin(r)*t,o=Z(i,a),s=new An;s.position.set(i,o,a),s.rotation.y=-r+Math.PI/2+(e()-.5)*.25;let c=new q(Xu(2.3,.14,.56,.05),X($u));c.position.y=.5;let l=new q(Xu(2.3,.42,.1,.04),X(ed));l.position.set(0,.78,-.24),s.add(c,l);for(let e of[-.9,.9]){let t=new q(Xu(.14,.5,.46,.03),X(ed));t.position.set(e,.25,0),s.add(t)}s.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!0,t.receiveShadow=!0)}),this.group.add(s)}}buildStalls(e,t){for(let n=0;n<5;n++){let r=n/5*Math.PI*2+1.9,i=this.ringRadius+t(4.2,7.5),a=Math.cos(r)*i,o=Math.sin(r)*i,s=2+Math.floor(e()*3);for(let n=0;n<s;n++){let n=a+t(-1.3,1.3),r=o+t(-1.3,1.3),i=Z(n,r);if(e()<.5){let a=t(.5,.78),o=new q(Xu(a,a,a,.04),X(e()<.5?$u:ed));o.position.set(n,i+a/2,r),o.rotation.y=e()*Math.PI,o.castShadow=o.receiveShadow=!0,this.group.add(o);let s=new q(Xu(a*1.02,a*.13,a*1.02,.02),X(13082730));s.position.copy(o.position),s.rotation.y=o.rotation.y,this.group.add(s)}else{let e=t(.72,.95),a=new q(new pa(.34,.3,e,10),X(11105343));a.position.set(n,i+e/2,r),a.castShadow=a.receiveShadow=!0,this.group.add(a);for(let t of[.3,.7]){let a=new q(new xa(.345,.035,5,12),X(nd));a.position.set(n,i+e*t,r),a.rotation.x=Math.PI/2,this.group.add(a)}}}let c=a+t(-.6,.6),l=o+t(-.6,.6),u=Z(c,l),d=new q(new pa(.05,.06,2.1,6),X(ed));d.position.set(c,u+1.05,l);let f=new q(new pa(.04,.04,.5,5),X(ed));f.position.set(c+.22,u+2.05,l),f.rotation.z=Math.PI/2,d.castShadow=!0,this.group.add(d,f);let p=new q(new _a(.17,0),new qr({color:new K(3,2.1,.85)}));p.position.set(c+.44,u+1.88,l),p.layers.set(1),this.lanterns.push(p),this.group.add(p)}}static plinth(){let e=new q(new pa(12.4,12.9,.34,40),X(rd));return e.position.y=-.16,e.receiveShadow=!0,e}update(e,t){for(let t=0;t<this.flames.length;t++){let n=this.flames[t],r=.62+.5*Math.sin(e*11+t*1.9)+.2*Math.sin(e*24+t);n.scale.set(.85+.25*Math.sin(e*8+t),Math.max(.2,r),.85+.25*Math.cos(e*9+t)),n.rotation.y=e*1.6+t}for(let t of this.banners)t.mesh.rotation.z=Math.sin(e*1.7+t.phase)*.08,t.mesh.scale.x=1+Math.sin(e*2.3+t.phase)*.05,t.mesh.position.y+=Math.sin(e*1.9+t.phase)*.0016;for(let n=0;n<this.lanterns.length;n++){let r=this.lanterns[n];r.rotation.y+=t*.8;let i=1+Math.sin(e*2.4+n)*.1;r.scale.setScalar(i)}}};function ad(e){let t=new Aa({uniforms:{sunDir:{value:e.clone()},top:{value:new K(5217508)},mid:{value:new K(11129838)},horizon:{value:new K(16770237)},below:{value:new K(14926746)},sunColor:{value:new K(16773328)}},vertexShader:`
      varying vec3 vDir;
      void main(){
        vDir = position;
      ...
      void main(){
        ...
        gl_FragColor = vec4(col, 1.0);
      }`,side:1,depthWrite:!1,fog:!1}),n=new q(new ba(380,32,20),t);return n.layers.set(1),n.renderOrder=-10,n.frustumCulled=!1,n}var od=class{sun;hemi;dirToSun=new H(.55,.58,.38).normalize();lightRight=new H;lightUp=new H;tmp=new H;constructor(e){this.sun=new Fo(16771524,3.1),this.sun.castShadow=!0;let t=this.sun.shadow;t.mapSize.set(2048,2048),t.camera.left=-26,t.camera.right=26,t.camera.top=26,t.camera.bottom=-26,t.camera.near=2,t.camera.far=170,t.bias=-3e-4,t.normalBias=.5,e.add(this.sun,this.sun.target),this.hemi=new go(12375807,15193e3,.85),e.add(this.hemi);let n=this.tmp.copy(this.dirToSun).negate();this.lightRight.crossVectors(new H(0,1,0),n).normalize(),this.lightUp.crossVectors(n,this.lightRight).normalize()}follow(e){let t=(this.sun.shadow.camera.right-this.sun.shadow.camera.left)/this.sun.shadow.mapSize.width,n=Math.round(e.dot(this.lightRight)/t)*t,r=Math.round(e.dot(this.lightUp)/t)*t,i=this.tmp.copy(this.dirToSun).multiplyScalar(e.dot(this.dirToSun)).addScaledVector(this.lightRight,n).addScaledVector(this.lightUp,r);this.sun.target.position.copy(i),this.sun.position.copy(i).addScaledVector(this.dirToSun,85)}},sd=new G().makeScale(0,0,0),cd=class{mesh;wind=null;pool=[];cursor=0;dummy=new kn;tmp=new H;col=new K;constructor(e,t=256,n,r=1){let i=n??new ba(1,6,5),a=new qr;a.color.setScalar(r),this.mesh=new Ai(i,a,t),this.mesh.layers.set(1),this.mesh.frustumCulled=!1,this.mesh.castShadow=!1;for(let e=0;e<t;e++)this.pool.push({alive:!1,pos:new H,vel:new H,life:0,maxLife:1,size:.05,gravity:0,drag:0}),this.mesh.setMatrixAt(e,sd),this.mesh.setColorAt(e,this.col.setScalar(1));e.add(this.mesh)}spawn(e,t,n={}){let r=this.cursor;this.cursor=(this.cursor+1)%this.pool.length;let i=this.pool[r];i.alive=!0,i.pos.copy(e),i.vel.copy(t),i.maxLife=i.life=n.life??.6,i.size=n.size??.06,i.gravity=n.gravity??0,i.drag=n.drag??2,n.color!==void 0&&(this.mesh.setColorAt(r,this.col.set(n.color)),this.mesh.instanceColor.needsUpdate=!0)}update(e,t){let n=this.dummy;for(let r=0;r<this.pool.length;r++){let i=this.pool[r];if(!i.alive)continue;if(i.life-=e,i.life<=0){i.alive=!1,this.mesh.setMatrixAt(r,sd);continue}this.wind&&(this.wind(t,i.pos,this.tmp),i.vel.addScaledVector(this.tmp,e)),i.vel.y+=i.gravity*e,i.vel.multiplyScalar(Math.max(0,1-i.drag*e)),i.pos.addScaledVector(i.vel,e);let a=i.life/i.maxLife,o=i.size*Math.min(1,(1-a)*9+.15)*(.25+.75*a);n.position.copy(i.pos),n.scale.setScalar(o),n.rotation.set(0,0,0),n.updateMatrix(),this.mesh.setMatrixAt(r,n.matrix)}this.mesh.instanceMatrix.needsUpdate=!0}},ld={run:7,sprint:10.6,groundLambda:11.5,stopLambda:9,pivotLambda:22,airAccel:30,airDrag:.4,gravity:26,jumpV:8.6,shortHopGravityMul:2.5,coyote:.12,jumpBuffer:.14,dashV0:14.2,dashV1:9.4,dashTime:.22,dashCooldown:.5,dashSteer:2.6,sprintHold:.16,terminal:34},ud=class{pos=new H(0,0,3);vel=new H;yaw=0;grounded=!0;planarSpeed=0;speed01=0;sprint01=0;dash01=0;turnRate=0;localAccel=new V;skidding=!1;airT=0;chargeDrag=0;commitT=0;hangTime=0;events={land:0,jumped:!1,dashed:!1,landedOnConstruct:!1};platforms=null;supportY=0;t=0;coyote=0;jumpBuf=0;snapLock=0;dashT=-1;dashCD=0;airDashes=1;dashDir=new V(0,1);shiftDownAt=-10;sprinting=!1;prevVel=new V;prevYaw=0;wish=new V;update(e,t,n){this.t+=e,this.events.land=0,this.events.jumped=!1,this.events.dashed=!1,this.events.landedOnConstruct=!1;let r=t.moveAxis(),i=Math.sin(n),a=Math.cos(n);this.wish.set(i*r.y-a*r.x,a*r.y+i*r.x);let o=this.wish.lengthSq()>.01;(t.pressed(`ShiftLeft`)||t.pressed(`ShiftRight`))&&(this.shiftDownAt=this.t,this.tryDash(o));let s=t.down(`ShiftLeft`)||t.down(`ShiftRight`);this.sprinting=s&&this.t-this.shiftDownAt>ld.sprintHold&&o;let c=(this.sprinting?ld.sprint:ld.run)*(1-.22*this.chargeDrag);this.commitT=Math.max(0,this.commitT-e),this.hangTime=Math.max(0,this.hangTime-e),this.dashCD=Math.max(0,this.dashCD-e),this.coyote=Math.max(0,this.coyote-e),this.snapLock=Math.max(0,this.snapLock-e),this.jumpBuf=t.pressed(`Space`)?ld.jumpBuffer:Math.max(0,this.jumpBuf-e);let l=this.dashT>=0;if(l){this.dashT+=e;let t=Ou(this.dashT/ld.dashTime);o&&(this.dashDir.x+=this.wish.x*ld.dashSteer*e,this.dashDir.y+=this.wish.y*ld.dashSteer*e,this.dashDir.normalize());let n=ku(ld.dashV0,ld.dashV1,Pu(t));this.vel.x=this.dashDir.x*n,this.vel.z=this.dashDir.y*n,t>=1&&(this.dashT=-1)}else if(this.commitT>0){let t=this.grounded?3.4:.8;this.vel.x=ju(this.vel.x,0,t,e),this.vel.z=ju(this.vel.z,0,t,e)}else if(this.grounded){let t=this.wish.x*c,n=this.wish.y*c,r=Math.hypot(this.vel.x,this.vel.z),i=o&&r>5&&(this.wish.x*this.vel.x+this.wish.y*this.vel.z)/Math.max(r,.01)<-.4,a=o?i?ld.pivotLambda:ld.groundLambda:ld.stopLambda;this.vel.x=ju(this.vel.x,t,a,e),this.vel.z=ju(this.vel.z,n,a,e)}else{let t=Math.hypot(this.vel.x,this.vel.z);if(o){this.vel.x+=this.wish.x*ld.airAccel*e,this.vel.z+=this.wish.y*ld.airAccel*e;let n=Math.hypot(this.vel.x,this.vel.z),r=Math.max(t,c);if(n>r){let e=r/n;this.vel.x*=e,this.vel.z*=e}}else this.vel.x=ju(this.vel.x,0,ld.airDrag,e),this.vel.z=ju(this.vel.z,0,ld.airDrag,e)}if(this.jumpBuf>0&&(this.grounded||this.coyote>0)&&(this.jumpBuf=0,this.coyote=0,this.grounded=!1,this.snapLock=.2,this.vel.y=ld.jumpV,l&&(this.dashT=-1),this.events.jumped=!0),!this.grounded){let n=ld.gravity;this.vel.y>0&&!t.down(`Space`)&&(n*=ld.shortHopGravityMul),this.dashT>=0&&(n*=.22),this.hangTime>0&&(n*=.12,this.vel.y<-2&&(this.vel.y=-2)),this.vel.y=Math.max(this.vel.y-n*e,-ld.terminal)}let u=this.pos.y;this.pos.addScaledVector(this.vel,e);let d=Z(this.pos.x,this.pos.z),f=this.platforms?.supportUnder(this.pos.x,this.pos.z,u,this.pos.y,this.vel.y)??null,p=f!==null&&f>d,m=p?f:d;if(this.supportY=m,this.vel.y<=0&&this.pos.y<=m){if(!this.grounded){let e=-this.vel.y;e>5.5&&(this.events.land=e),this.events.landedOnConstruct=p,this.airDashes=1}this.pos.y=m,this.vel.y=0,this.grounded=!0}else this.grounded&&(this.snapLock<=0&&this.vel.y<=.001&&this.pos.y-m<.5?(this.pos.y=m,this.vel.y=0):(this.grounded=!1,this.snapLock<=0&&(this.coyote=ld.coyote)));this.airT=this.grounded?0:this.airT+e;let h=Math.hypot(this.pos.x,this.pos.z);if(h>118){let e=this.pos.x/h,t=this.pos.z/h;this.pos.x=e*118,this.pos.z=t*118;let n=this.vel.x*e+this.vel.z*t;n>0&&(this.vel.x-=e*n,this.vel.z-=t*n)}let g=Math.hypot(this.vel.x,this.vel.z);if(g>.6){let t=Math.atan2(this.vel.x,this.vel.z),n=this.dashT>=0?24:this.grounded?13:7;this.yaw=Nu(this.yaw,t,n,e)}this.planarSpeed=g,this.speed01=Ou(g/ld.sprint),this.sprint01=ju(this.sprint01,this.sprinting||g>ld.run+1?1:0,6,e),this.dash01=this.dashT>=0?1-Ou(this.dashT/ld.dashTime)*.5:ju(this.dash01,0,10,e),this.skidding=this.grounded&&!o&&g>6;let _=(this.vel.x-this.prevVel.x)/Math.max(e,1e-4),v=(this.vel.z-this.prevVel.y)/Math.max(e,1e-4),y=Math.sin(this.yaw),b=Math.cos(this.yaw);this.localAccel.x=ju(this.localAccel.x,_*b-v*y,5,e),this.localAccel.y=ju(this.localAccel.y,_*y+v*b,5,e),this.prevVel.set(this.vel.x,this.vel.z),this.turnRate=ju(this.turnRate,Mu(this.yaw-this.prevYaw)/Math.max(e,1e-4),8,e),this.prevYaw=this.yaw}applyImpulse(e,t,n){this.vel.x+=e,this.vel.y+=t,this.vel.z+=n,this.vel.y>1.5&&(this.grounded=!1,this.snapLock=.15,this.coyote=0,this.pos.y+=.02)}lunge(e,t=0){let n=Math.sin(this.yaw),r=Math.cos(this.yaw),i=this.vel.x*n+this.vel.z*r,a=Math.max(i,e);this.vel.x=n*a,this.vel.z=r*a,t>0&&(this.vel.y=Math.max(this.vel.y,t),this.grounded=!1,this.snapLock=.15,this.coyote=0,this.pos.y+=.02)}commit(e){this.commitT=e}tryDash(e){this.dashCD>0||!this.grounded&&this.airDashes<=0||(this.grounded||this.airDashes--,this.dashCD=ld.dashCooldown,this.dashT=0,this.commitT=0,e?this.dashDir.copy(this.wish).normalize():this.dashDir.set(Math.sin(this.yaw),Math.cos(this.yaw)),this.grounded||(this.vel.y=Math.max(this.vel.y*.3,0)),this.events.dashed=!0)}};function dd(e){let t=new Map,n=new Map,r=e.clone();return fd(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function fd(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)fd(e.children[r],t.children[r],n)}var pd=class extends so{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new yd(e)}),this.register(function(e){return new bd(e)}),this.register(function(e){return new kd(e)}),this.register(function(e){return new Ad(e)}),this.register(function(e){return new jd(e)}),this.register(function(e){return new Sd(e)}),this.register(function(e){return new Cd(e)}),this.register(function(e){return new wd(e)}),this.register(function(e){return new Td(e)}),this.register(function(e){return new vd(e)}),this.register(function(e){return new Ed(e)}),this.register(function(e){return new xd(e)}),this.register(function(e){return new Od(e)}),this.register(function(e){return new Dd(e)}),this.register(function(e){return new gd(e)}),this.register(function(e){return new Md(e,Q.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Md(e,Q.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Nd(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=Io.extractUrlBase(e);a=Io.resolveURL(t,this.path)}else a=Io.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new uo(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer){if(s.decode(new Uint8Array(e,0,4))===Pd){try{a[Q.KHR_BINARY_GLTF]=new Ld(e)}catch(e){r&&r(e);return}i=JSON.parse(a[Q.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e))}else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new uf(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case Q.KHR_MATERIALS_UNLIT:a[t]=new _d;break;case Q.KHR_DRACO_MESH_COMPRESSION:a[t]=new Rd(i,this.dracoLoader);break;case Q.KHR_TEXTURE_TRANSFORM:a[t]=new zd;break;case Q.KHR_MESH_QUANTIZATION:a[t]=new Bd;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function md(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function hd(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var Q={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},gd=class{constructor(e){this.parser=e,this.name=Q.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new K(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ke);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Fo(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new Mo(s),o.distance=c;break;case`spot`:o=new Ao(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),tf(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},_d=class{constructor(){this.name=Q.KHR_MATERIALS_UNLIT}getMaterialType(){return qr}extendParams(e,t,n){let r=[];e.color=new K(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ke),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Ge))}return Promise.all(r)}},vd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},yd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new V(e,e)}return Promise.all(r)}},bd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_DISPERSION}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},xd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Sd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_SHEEN}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new K(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ke)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Ge)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Cd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},wd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_VOLUME}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new K().setRGB(i[0],i[1],i[2],Ke),Promise.all(r)}},Td=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_IOR}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Ed=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_SPECULAR}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new K().setRGB(i[0],i[1],i[2],Ke),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Ge)),Promise.all(r)}},Dd=class{constructor(e){this.parser=e,this.name=Q.EXT_MATERIALS_BUMP}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Od=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return hd(this.parser,e,this.name)===null?null:Na}extendMaterialParams(e,t){let n=hd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},kd=class{constructor(e){this.parser=e,this.name=Q.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Ad=class{constructor(e){this.parser=e,this.name=Q.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},jd=class{constructor(e){this.parser=e,this.name=Q.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Md=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}return null}},Nd=class{constructor(e){this.name=Q.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Wd.TRIANGLES&&e.mode!==Wd.TRIANGLE_STRIP&&e.mode!==Wd.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new G,n=new H,a=new Pt,s=new H(1,1,1),c=new Ai(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new Si(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);kn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Pd=`glTF`,Fd=12,Id={JSON:1313821514,BIN:5130562},Ld=class{constructor(e){this.name=Q.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Fd),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Pd)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Fd,i=new DataView(e,Fd),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Id.JSON){let r=new Uint8Array(e,Fd+a,t);this.content=n.decode(r)}else if(r===Id.BIN){let n=Fd+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Rd=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=Q.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=Yd[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=Yd[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=Gd[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ke,n)})})}},zd=class{constructor(){this.name=Q.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Bd=class{constructor(){this.name=Q.KHR_MESH_QUANTIZATION}},Vd=class extends Ha{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},Hd=new Pt,Ud=class extends Vd{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return Hd.fromArray(i).normalize().toArray(i),i}},Wd={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},Gd={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Kd={9728:i,9729:s,9984:a,9985:c,9986:o,9987:l},qd={33071:n,33648:r,10497:t},Jd={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Yd={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},Xd={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},Zd={CUBICSPLINE:void 0,LINEAR:P,STEP:Re},Qd={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function $d(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Ma({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function ef(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function tf(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function nf(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function rf(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function af(e){let t,n=e.extensions&&e.extensions[Q.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+of(n.attributes):e.indices+`:`+of(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+of(e.targets[n]);return t}function of(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function sf(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function cf(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var lf=new G,uf=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new md,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}this.textureLoader=typeof createImageBitmap>`u`||n&&r<17||i&&a<98?new mo(this.options.manager):new Ro(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new uo(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return ef(i,a,r),tf(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e)}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Q.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(Io.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Jd[r.type],t=Gd[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new vr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Jd[r.type],o=Gd[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Pr(f,u/s),t.cache.add(n,c)),p=new Ir(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new vr(f,a,d);if(r.sparse!==void 0){let t=Jd.SCALAR,n=Gd[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new vr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=Kd[n.magFilter]||1006,t.minFilter=Kd[n.minFilter]||1008,t.wrapS=qd[n.wrapS]||1e3,t.wrapT=qd[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Xt(e);t.needsUpdate=!0,n(t)}),t.load(Io.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),tf(e,a),e.userData.mimeType=a.mimeType||cf(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[Q.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[Q.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[Q.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new $i,Rr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new zi,Rr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Ma}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[Q.KHR_MATERIALS_UNLIT]){let e=r[Q.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new K(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ke),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Ge)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||Qd.OPAQUE;if(l===Qd.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Qd.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==qr&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new V(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==qr&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==qr){let e=i.emissiveFactor;o.emissive=new K().setRGB(e[0],e[1],e[2],Ke)}return i.emissiveTexture!==void 0&&a!==qr&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Ge)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),tf(n,i),t.associations.set(n,{materials:e}),i.extensions&&ef(r,n,i),n})}createUniqueName(e){let t=ts.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[Q.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return ff(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=af(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[Q.KHR_DRACO_MESH_COMPRESSION]?i(o):ff(new Nr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?$d(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Wd.TRIANGLES||u.mode===Wd.TRIANGLE_STRIP||u.mode===Wd.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new gi(l,f):new q(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Wd.TRIANGLE_STRIP?d.geometry=Uu(d.geometry,1):u.mode===Wd.TRIANGLE_FAN&&(d.geometry=Uu(d.geometry,2));else if(u.mode===Wd.LINES)d=new Zi(l,f);else if(u.mode===Wd.LINE_STRIP)d=new qi(l,f);else if(u.mode===Wd.LINE_LOOP)d=new Qi(l,f);else if(u.mode===Wd.POINTS)d=new ia(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&rf(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),tf(d,i),u.extensions&&ef(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&ef(r,c[0],i),c[0];let l=new An;i.extensions&&ef(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Oo(Nt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new No(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),tf(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new G;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new xi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new to(i,void 0,l);return tf(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,lf)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new H().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new _i:t.length>1?new An:t.length===1?t[0]:new kn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),tf(o,i),i.extensions&&ef(n,o,i),i.matrix!==void 0){let e=new G;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new An;n.name&&(i.name=r.createUniqueName(n.name)),tf(i,n),n.extensions&&ef(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(dd(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Rr||e instanceof Xt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}Xd[i.path]===Xd.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(Xd[i.path]){case Xd.weights:l=Xa;break;case Xd.rotation:l=Qa;break;case Xd.translation:case Xd.scale:l=eo;break;default:switch(n.itemSize){case 1:l=Xa;break;default:l=eo}}let u=r.interpolation===void 0?P:Zd[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+Xd[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=sf(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Qa?Ud:Vd)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function df(e,t,n){let r=t.attributes,i=new er;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new H(t[0],t[1],t[2]),new H(a[0],a[1],a[2])),e.normalized){let t=sf(Gd[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new H,t=new H;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=sf(Gd[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Tr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function ff(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=Yd[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return W.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${W.workingColorSpace}" not supported.`),tf(e,t),df(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:nf(e,t.targets,n)})}var pf=1.7,mf=class{group=new An;charge01=0;phase=0;ready=!1;tilt=new An;mixer=null;actions={};base=``;overlayUntil=0;overlayAction=null;handLBone=null;handRBone=null;staffTip=null;crystal=null;crystalColor=new K(1.9,2.9,4);squash=new Fu(240,.5);airB=0;t=0;v1=new H;constructor(){this.group.add(this.tilt),new pd().load(`/magic/models/Mage.glb`,e=>{let t=e.scene,n=new er().setFromObject(t),r=n.getSize(this.v1.clone()),i=pf/Math.max(.01,r.y);t.scale.setScalar(i),t.position.y=-n.min.y*i,t.traverse(e=>{let t=e;if(t.isMesh){t.castShadow=!0;let e=t.material,n=e=>new Pa({map:e.map??null,color:e.color,gradientMap:Ju()});t.material=Array.isArray(e)?e.map(n):n(e)}}),this.handLBone=t.getObjectByName(`handl`)??t.getObjectByName(`hand.l`)??null,this.handRBone=t.getObjectByName(`handr`)??t.getObjectByName(`hand.r`)??null,this.mixer=new is(t);for(let t of e.animations)this.actions[t.name]=this.mixer.clipAction(t);this.tilt.add(t),this.setBase(`Idle`),this.ready=!0,this.attachStaff()})}attachStaff(){let e=this.tilt.getObjectByName(`handslotr`)??this.tilt.getObjectByName(`handslot.r`);e&&new pd().load(`/magic/models/staff.gltf`,t=>{let n=t.scene;n.traverse(e=>{let t=e;if(!t.isMesh)return;t.castShadow=!0;let n=t.material,r=e=>new Pa({map:e.map??null,color:e.color,gradientMap:Ju()});t.material=Array.isArray(n)?n.map(r):r(n)});let r=new er().setFromObject(n),i=new kn;i.position.set(0,r.max.y,0),n.add(i);let a=new q(new _a(.07,0),new qr({color:this.crystalColor.clone()}));a.layers.set(1),i.add(a),e.add(n),this.staffTip=i,this.crystal=a})}setCrystalColor(e){this.crystalColor.copy(e),this.crystal&&this.crystal.material.color.copy(e)}attack(e,t,n){this.oneShot(e,t,.04,n),this.squash.impulse(1.1)}castBolt(e){this.oneShot(`Spellcast_Shoot`,2,.05,.55),this.squash.impulse(.8)}blastPose(){this.oneShot(`Spellcast_Long`,2.4,.05,.5),this.squash.impulse(2.6)}getHandWorld(e,t){let n=this.staffTip??(e>0?this.handLBone:this.handRBone);return n?(n.updateWorldMatrix(!0,!1),n.getWorldPosition(t)):t.copy(this.group.position).add(this.v1.set(0,1.1,0))}update(e,t,n){if(this.t=t,!this.mixer)return;n.events.jumped&&(this.oneShot(`Jump_Start`,1.6,.05,.3),this.squash.impulse(3.2)),n.events.dashed&&(this.oneShot(`Dodge_Forward`,1.7,.05,.45),this.squash.impulse(2)),n.events.land&&(n.events.land>9&&this.oneShot(`Jump_Land`,1.5,.05,.45),this.squash.impulse(-Du(n.events.land,0,20)*.7));let r=n.planarSpeed;this.phase+=e*(2+r*1.75),this.airB=ju(this.airB,+!n.grounded,9,e),this.t<this.overlayUntil||(this.overlayAction&&=(this.overlayAction.fadeOut(.12),null),!n.grounded&&n.airT>.08?this.setBase(`Jump_Idle`,1,.14):this.charge01>.05&&r<1.5?this.setBase(`Spellcasting`,1,.16):r<.5?this.setBase(`Idle`,1,.2):r<4?this.setBase(`Walking_A`,Du(r/2.4,.7,1.6),.14):this.setBase(`Running_A`,Du(r/7,.75,1.65)*1.1,.14)),this.mixer.update(e);let i=Du(n.localAccel.y*.016,-.2,.22)+.06*n.sprint01+n.dash01*.22+this.airB*(n.vel.y>0?-.04:.1),a=Du(-n.turnRate*.05,-.2,.2)*Math.min(1,r/ld.run)+Du(-n.localAccel.x*.008,-.09,.09);this.tilt.rotation.x=ju(this.tilt.rotation.x,i,10,e),this.tilt.rotation.z=ju(this.tilt.rotation.z,a,10,e),this.squash.update(e);let o=Du(this.squash.value*.085,-.16,.14);if(this.tilt.scale.set(1-o*.62,1+o,1-o*.62),this.crystal){let n=1+Math.sin(t*3.1)*.08+this.charge01*1.5;this.crystal.scale.setScalar(n),this.crystal.rotation.y+=e*1.4,this.crystal.rotation.x+=e*.7}}setBase(e,t=1,n=.15){let r=this.actions[e];if(!r)return;if(this.base===e){r.setEffectiveTimeScale(t),r.setEffectiveWeight(1);return}let i=this.actions[this.base];r.reset(),r.setEffectiveTimeScale(t),r.setEffectiveWeight(1),r.play(),i&&r.crossFadeFrom(i,n,!1),this.base=e}oneShot(e,t,n,r){let i=this.actions[e];if(!i)return;this.overlayAction&&this.overlayAction!==i&&this.overlayAction.fadeOut(.08),i.reset(),i.setLoop(N,1),i.clampWhenFinished=!0,i.setEffectiveTimeScale(t),i.setEffectiveWeight(1),i.fadeIn(n),i.play();let a=this.actions[this.base];a&&a.setEffectiveWeight(.15),this.overlayAction=i,this.overlayUntil=this.t+r}},hf=.0062,gf=class{camera;yaw=Math.PI;pitch=.3;sens=parseFloat(localStorage.getItem(`story.sens`)??``)||hf;onSensChange=null;dist=7.2;distT=7.2;follow=new H(0,1.5,3);lookAhead=new H;fovKick=new Fu(130,.75);shakeAmp=0;tmp=new H;constructor(e){this.camera=new Oo(55,e,.1,700)}kick(e){this.fovKick.impulse(e*55)}addShake(e){this.shakeAmp=Math.min(.8,this.shakeAmp+e)}get forwardYaw(){return this.yaw+Math.PI}update(e,t,n,r){n.pressed(`BracketLeft`)&&this.adjustSens(1/1.15),n.pressed(`BracketRight`)&&this.adjustSens(1.15),this.yaw-=n.mouseDX*this.sens,this.pitch=Du(this.pitch+n.mouseDY*this.sens,-.42,1.2),this.distT=Du(this.distT*Math.exp(n.wheelDelta*.0011),3.2,10.5),this.dist=ju(this.dist,this.distT,12,e),this.lookAhead.x=ju(this.lookAhead.x,r.vel.x*.09,6,e),this.lookAhead.z=ju(this.lookAhead.z,r.vel.z*.09,6,e);let i=.38,a=r.pos.x+this.lookAhead.x+Math.cos(this.yaw)*i,o=r.pos.y+1.5,s=r.pos.z+this.lookAhead.z-Math.sin(this.yaw)*i;this.follow.x=ju(this.follow.x,a,24,e),this.follow.y=ju(this.follow.y,o,10,e),this.follow.z=ju(this.follow.z,s,24,e);let c=Math.cos(this.pitch),l=this.camera.position;l.set(this.follow.x+Math.sin(this.yaw)*c*this.dist,this.follow.y+Math.sin(this.pitch)*this.dist,this.follow.z+Math.cos(this.yaw)*c*this.dist);let u=Z(l.x,l.z)+.45;if(l.y<u&&(l.y=u),this.shakeAmp>.002){let n=this.shakeAmp;l.x+=Math.sin(t*39.7)*.05*n,l.y+=Math.sin(t*47.3+1.7)*.05*n,l.z+=Math.sin(t*43.1+3.1)*.05*n,this.shakeAmp=ju(this.shakeAmp,0,7,e)}this.camera.lookAt(this.tmp.copy(this.follow).add(this.lookAhead.set(this.lookAhead.x,.1,this.lookAhead.z))),this.fovKick.update(e);let d=Ou((r.planarSpeed-7.5)/4)*4,f=55+r.sprint01*6+d+this.fovKick.value;Math.abs(f-this.camera.fov)>.01&&(this.camera.fov=f,this.camera.updateProjectionMatrix())}setAspect(e){this.camera.aspect=e,this.camera.updateProjectionMatrix()}adjustSens(e){this.sens=Du(this.sens*e,.0012,.02),localStorage.setItem(`story.sens`,String(this.sens)),this.onSensChange?.(Math.round(this.sens/hf*100))}aimDir(e){return this.camera.getWorldDirection(e)}aimPoint(e){return this.camera.getWorldDirection(e),e.multiplyScalar(45).add(this.camera.position)}},_f=2*Math.PI*15,vf=2*Math.PI*9,yf=class{hint=document.getElementById(`hint`);fps=document.getElementById(`fps`);speed=document.getElementById(`speed`);reticle=document.getElementById(`reticle`);flowArc=document.getElementById(`ret-flow`);chargeArc=document.getElementById(`ret-charge`);frames=0;acc=0;hintRetired=!1;toastEl=document.getElementById(`toast`);toastTimer=0;comboEl=document.getElementById(`combo`);comboNum=document.getElementById(`combo-n`);comboTag=document.getElementById(`combo-tag`);lastCombo=-1;popTimer=0;schoolEl=document.getElementById(`school`);schoolName=document.getElementById(`school-name`);schoolKeys=document.getElementById(`school-keys`);dot=document.getElementById(`ret-dot`);promptEl=document.getElementById(`prompt`);lastPrompt=``;bannerEl=document.getElementById(`banner`);bannerRound=document.getElementById(`banner-round`);bannerName=document.getElementById(`banner-name`);bannerSub=document.getElementById(`banner-sub`);foeEl=document.getElementById(`foe`);foeName=document.getElementById(`foe-name`);foeFill=document.getElementById(`foe-fill`);vitalsEl=document.getElementById(`vitals`);hpFill=document.getElementById(`hp-fill`);purseEl=document.getElementById(`purse`);coinsEl=document.getElementById(`coins`);bestEl=document.getElementById(`best`);calloutEl=document.getElementById(`callout`);lastCallout=``;shopEl=document.getElementById(`shop`);shopList=document.getElementById(`shop-list`);shopFoot=document.getElementById(`shop-foot`);lastShopSig=``;toast(e){this.toastEl.textContent=e,this.toastEl.classList.add(`on`),clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>this.toastEl.classList.remove(`on`),1100)}setLocked(e){this.hint.classList.toggle(`hidden`,e),this.reticle.classList.toggle(`on`,e)}retireHint(){this.hintRetired||(this.hintRetired=!0,this.hint.classList.add(`retired`))}setPrompt(e){e!==this.lastPrompt&&(this.lastPrompt=e,this.promptEl.textContent=e,this.promptEl.classList.toggle(`on`,e.length>0))}setMagic(e,t,n){this.flowArc.setAttribute(`stroke-dasharray`,`${e*_f} ${_f}`),this.flowArc.classList.toggle(`low`,n),this.chargeArc.setAttribute(`stroke-dasharray`,`${Math.max(0,t)*vf} ${vf}`)}banner(e,t,n,r=!1){let i=t.length>0;this.bannerEl.classList.toggle(`on`,i),this.bannerEl.classList.toggle(`boss`,r),i&&(this.bannerRound.textContent=e,this.bannerName.textContent=t,this.bannerSub.textContent=n)}setFoe(e,t){let n=e.length>0;this.foeEl.classList.toggle(`on`,n),n&&(this.foeName.textContent=e,this.foeFill.style.width=`${Math.max(0,t)*100}%`)}setVitals(e){this.vitalsEl.classList.add(`on`),this.vitalsEl.classList.toggle(`hurt`,e<.35),this.hpFill.style.width=`${Math.max(0,e)*100}%`}hurtFlash(){document.body.classList.remove(`hurt`),document.body.offsetWidth,document.body.classList.add(`hurt`)}setPurse(e,t){this.purseEl.classList.add(`on`),this.coinsEl.textContent=String(e),this.bestEl.textContent=t>0?`BEST · ROUND ${t}`:``}setCallout(e){e!==this.lastCallout&&(this.lastCallout=e,this.calloutEl.textContent=e,this.calloutEl.classList.toggle(`on`,e.length>0))}setShop(e,t,n){if(this.shopEl.classList.toggle(`on`,e),!e)return;let r=t.map(e=>`${e.key}${e.name}${e.price}${e.afford}${e.sold}`).join(`|`)+n;if(r!==this.lastShopSig){this.lastShopSig=r,this.shopList.innerHTML=``;for(let e of t){let t=document.createElement(`li`);t.className=e.sold?`sold`:e.afford?`afford`:``,t.innerHTML=`<span class="key">${e.key}</span><span class="nm">${e.name}</span><span class="bl">${e.blurb}</span><span class="pr">${e.sold?`SOLD`:e.price}</span>`,this.shopList.appendChild(t)}this.shopFoot.textContent=n}}setSchool(e,t,n){this.schoolEl.classList.add(`on`),this.schoolName.textContent=e.toUpperCase(),this.schoolKeys.textContent=t,this.schoolEl.style.setProperty(`--sc`,n),this.flowArc.style.stroke=n,this.dot.style.fill=n}setCombo(e,t){if(e===this.lastCombo)return;let n=e>this.lastCombo;this.lastCombo=e,this.comboEl.classList.toggle(`on`,e>0),this.comboEl.classList.toggle(`perfect`,t>0),e>0&&(this.comboNum.textContent=`${e}`,this.comboTag.textContent=t>1?`PERFECT`:``,n&&(this.comboEl.classList.remove(`pop`),this.comboEl.offsetWidth,this.comboEl.classList.add(`pop`),clearTimeout(this.popTimer),this.popTimer=window.setTimeout(()=>this.comboEl.classList.remove(`pop`),130)))}tick(e,t){this.frames++,this.acc+=e,this.acc>=.5&&(this.fps.textContent=`${Math.round(this.frames/this.acc)} fps`,this.frames=0,this.acc=0),this.speed.textContent=t>.4?`${t.toFixed(1)} m/s`:``}},bf=new K(10475760),xf=14201973,Sf=15781757,Cf=10119744,wf=class{pos=new H;alive=!0;height=1.9;radius=.42;chill=0;root=new An;pivot=new An;wobX=new Fu(110,.22);wobZ=new Fu(110,.22);spin=new Fu(80,.3);flash=0;mats=[];baseColors=[];constructor(e,t,n){this.pos.set(e,0,t),this.root.position.set(e,.03,t),this.root.rotation.y=n+Math.PI/2,this.root.add(this.pivot);let r=e=>{let t=X(e);return this.mats.push(t),this.baseColors.push(t.color.clone()),t},i=new q(new pa(.07,.09,.6,8),r(Cf));i.position.y=.3;let a=new q(new da(.26,.42,4,12),r(xf));a.position.y=.95;let o=new q(new pa(.265,.272,.09,12),r(9068348));o.position.y=.92;let s=new q(new pa(.05,.05,1,8),r(Cf));s.rotation.z=Math.PI/2,s.position.y=1.18;let c=new q(new ba(.21,14,10),r(Sf));c.position.y=1.52;let l=new q(new ba(.028,6,5),new qr({color:2760984}));l.position.set(.075,1.56,.185);let u=l.clone();u.position.x=-.075;let d=new q(Xu(.14,.14,.02,.02),r(12622424));d.position.set(.06,1,.25),d.rotation.z=.3,this.pivot.add(i,a,o,s,c,l,u,d),this.pivot.traverse(e=>{e.isMesh&&(e.castShadow=!0)})}takeHit(e,t,n){let r=1-this.chill*.75;this.wobX.impulse(t*n*r),this.wobZ.impulse(-e*n*r),this.spin.impulse((Math.random()-.5)*n*1.6*r),this.flash=1}takeChill(e){this.chill=Math.min(1,this.chill+e)}update(e){this.wobX.update(e),this.wobZ.update(e),this.spin.update(e),this.pivot.rotation.set(this.wobX.value*.055,this.spin.value*.05,this.wobZ.value*.055),this.flash=ju(this.flash,0,9,e),this.chill=Math.max(0,this.chill-e*.28);let t=this.flash*this.flash;for(let e=0;e<this.mats.length;e++){let n=this.mats[e];n.emissive.setRGB(t+this.chill*.16,t*.95+this.chill*.3,t*.8+this.chill*.42),n.color.copy(this.baseColors[e]).lerp(bf,this.chill*.6)}}},Tf=class{group=new An;list=[];constructor(e){for(let[t,n]of[[.95,6.9],[2.75,7.1],[4.9,6.7]]){let r=new wf(Math.cos(t)*n,Math.sin(t)*n,-t+Math.PI/2);this.group.add(r.root),this.list.push(r),e.add(r)}}update(e){for(let t of this.list)t.update(e)}setVisible(e){this.group.visible=e;for(let t of this.list)t.alive=e}},Ef=class{list=[];add(e){this.list.push(e)}remove(e){let t=this.list.indexOf(e);t>=0&&this.list.splice(t,1)}clear(){this.list.length=0}tryHit(e,t){for(let n of this.list){if(!n.alive)continue;let r=e.x-n.pos.x,i=e.z-n.pos.z,a=n.radius+t;if(!(r*r+i*i>a*a)&&!(e.y<n.pos.y-.5||e.y>n.pos.y+n.height))return n}return null}hitSphere(e,t,n,r,i){for(let a of this.list){if(!a.alive)continue;let o=e-a.pos.x,s=n-a.pos.z,c=r+a.radius;o*o+s*s>c*c||t<a.pos.y-.9||t>a.pos.y+a.height+1.4||i(a)}}blastAt(e,t,n,r,i){for(let r of this.list){if(!r.alive)continue;let a=r.pos.x-e.x,o=r.pos.z-e.z,s=r.pos.y+r.height*.5-e.y,c=Math.sqrt(a*a+s*s+o*o);if(c>n)continue;let l=1/Math.max(c,.001);a*l*t.x+s*l*t.y+o*l*t.z<.2&&c>1.7||i(r)}}nearestInCone(e,t,n,r,i){let a=Math.sin(n),o=Math.cos(n),s=null,c=1/0;for(let n of this.list){if(!n.alive)continue;let l=n.pos.x-e,u=n.pos.z-t,d=Math.hypot(l,u);d>r||d<.001||l/d*a+u/d*o<i||d<c&&(c=d,s=n)}return s}hit(e,t,n,r){e.takeHit(t,n,r)}chill(e,t){e.takeChill(t)}chillOf(e){return e.chill}get liveCount(){let e=0;for(let t of this.list)t.alive&&e++;return e}},Df=new G().makeScale(0,0,0),Of=48;function kf(e){switch(e){case`card`:return new ua(.34,.03,.5);case`shard`:return new ma(.12,.5,5).rotateX(Math.PI/2);default:return new ba(.13,10,8)}}var Af=class{mesh;items=[];m4=new G;q=new Pt;scale=new H;col=new K;constructor(e,t){let n=new qr;this.mesh=new Ai(kf(t),n,Of),this.mesh.layers.set(1),this.mesh.frustumCulled=!1;for(let e=0;e<Of;e++)this.items.push({active:!1,pos:new H,vel:new H,life:0,cfg:null,pierce:0,bounces:0,spinPhase:0,age:0,hit:new Set}),this.mesh.setMatrixAt(e,Df),this.mesh.setColorAt(e,this.col.setScalar(1));e.add(this.mesh)}acquire(){for(let e of this.items)if(!e.active)return e;return null}write(e,t){if(!t.active){this.mesh.setMatrixAt(e,Df);return}let n=t.cfg,r=Mf.copy(t.vel);r.lengthSq()<1e-6&&r.set(0,0,1),r.normalize(),this.q.setFromUnitVectors(Nf,r),n.spin&&(Pf.setFromAxisAngle(r,t.spinPhase),this.q.premultiply(Pf));let i=n.size??1;this.scale.set(i,i,i),this.m4.compose(t.pos,this.q,this.scale),this.mesh.setMatrixAt(e,this.m4)}},jf=class{targets;monoliths;pools;v1=new H;col=new K;constructor(e,t,n){this.targets=t,this.monoliths=n,this.pools={orb:new Af(e,`orb`),card:new Af(e,`card`),shard:new Af(e,`shard`)}}handlers={};blockedBy=null;spawn(e,t,n,r){let i=this.pools[n.shape],a=i.acquire();if(!a)return null;a.active=!0,a.cfg=n,a.life=n.life,a.age=0,a.pierce=n.pierce??0,a.bounces=n.bounces??0,a.spinPhase=Math.random()*Math.PI*2,a.hit.clear(),a.pos.copy(e),a.vel.copy(t).normalize().multiplyScalar(n.speed),r&&n.inherit&&a.vel.addScaledVector(r,n.inherit);let o=i.items.indexOf(a);return i.mesh.setColorAt(o,this.col.copy(n.color)),i.mesh.instanceColor.needsUpdate=!0,a}update(e){for(let t of[`orb`,`card`,`shard`]){let n=this.pools[t];for(let t=0;t<n.items.length;t++){let r=n.items[t];r.active&&this.advance(r,e),n.write(t,r)}n.mesh.instanceMatrix.needsUpdate=!0}}advance(e,t){let n=e.cfg;if(e.life-=t,e.age+=t,e.spinPhase+=(n.spin??0)*t,e.life<=0){e.active=!1,this.handlers.onEnd?.(e,`expire`);return}n.gravity&&(e.vel.y+=n.gravity*t),n.drag&&e.vel.multiplyScalar(Math.max(0,1-n.drag*t));let r=e.vel.length()*t,i=Math.max(1,Math.min(8,Math.ceil(r/.25))),a=t/i,o=n.radius??.16;for(let t=0;t<i;t++){e.pos.addScaledVector(e.vel,a);let t=Z(e.pos.x,e.pos.z);if(e.pos.y<=t+.06){if(e.bounces>0)e.bounces--,e.pos.y=t+.06,e.vel.y=Math.abs(e.vel.y)*.55+1.2,e.vel.x*=.86,e.vel.z*=.86;else{e.active=!1,this.handlers.onEnd?.(e,`ground`);return}}for(let t of this.monoliths){let n=e.pos.x-t.x,r=e.pos.z-t.z;if(n*n+r*r<.72&&e.pos.y<t.y+.4){e.active=!1,this.handlers.onEnd?.(e,`wall`);return}}if(this.blockedBy?.(e.pos)){e.active=!1,this.handlers.onEnd?.(e,`wall`);return}let n=this.targets.tryHit(e.pos,o);if(n&&!e.hit.has(n)){if(e.hit.add(n),this.handlers.onHit?.(e,n),e.pierce>0)e.pierce--;else{e.active=!1,this.handlers.onEnd?.(e,`spent`);return}}}this.handlers.onStep?.(e,t)}clear(){for(let e of[`orb`,`card`,`shard`])for(let t of this.pools[e].items)t.active=!1}countActive(){let e=0;for(let t of[`orb`,`card`,`shard`])for(let n of this.pools[t].items)n.active&&e++;return e}},Mf=new H,Nf=new H(0,0,1),Pf=new Pt,Ff=new H(0,0,1),If=class{scene;sparks;rings=[];beams=[];v1=new H;constructor(e){this.scene=e,this.sparks=new cd(e,320,new ba(1,5,4),2);for(let t=0;t<10;t++){let t=new qr({transparent:!0,opacity:0,depthWrite:!1}),n=new q(new xa(1,.055,8,44),t);n.layers.set(1),n.visible=!1,e.add(n),this.rings.push({mesh:n,mat:t,t:1,dur:1,r0:1,r1:1,fade:.85})}for(let t=0;t<6;t++){let t=new qr({transparent:!0,opacity:0,depthWrite:!1}),n=new q(new pa(1,1,1,8,1,!0),t);n.layers.set(1),n.visible=!1,e.add(n),this.beams.push({mesh:n,mat:t,life:0})}}burst(e,t,n,r,i,a=-3){for(let o=0;o<t;o++)this.v1.set(Math.random()*2-1,Math.random()*1.6-.3,Math.random()*2-1).normalize().multiplyScalar(n*(.45+Math.random()*.8)),this.sparks.spawn(e,this.v1,{life:.26+Math.random()*.3,size:r*(.6+Math.random()*.8),color:i,gravity:a,drag:3.2})}cone(e,t,n,r,i,a,o,s=.3,c=0){for(let l=0;l<n;l++)this.v1.copy(t).addScaledVector(this.v1.set(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1).normalize(),i).normalize().multiplyScalar(r*(.7+Math.random()*.6)),this.sparks.spawn(e,this.v1,{life:s*(.7+Math.random()*.6),size:a*(.6+Math.random()*.7),color:o,gravity:c,drag:1.4})}ring(e,t,n,r,i,a,o=.85,s=1){for(let c of this.rings)if(!(c.t<c.dur)){c.t=0,c.dur=i,c.r0=n,c.r1=r,c.fade=o,c.mat.color.copy(a),c.mesh.position.copy(e),c.mesh.quaternion.setFromUnitVectors(Ff,t),c.mesh.visible=!0,c.mesh.userData.thickness=s;return}}groundRing(e,t,n,r,i,a=.85){this.ring(this.v1.copy(e).setY(e.y+.06),Lf,t,n,r,i,a)}beam(e,t,n,r,i,a=.8){for(let o of this.beams){if(o.life>0)continue;o.life=i,o.mat.color.copy(r),o.mat.opacity=a,o.mesh.userData.life0=i,o.mesh.userData.opacity0=a;let s=this.v1.copy(e).add(t).multiplyScalar(.5),c=e.distanceTo(t);o.mesh.position.copy(s),o.mesh.scale.set(n,Math.max(.01,c),n),o.mesh.quaternion.setFromUnitVectors(Lf,Rf.copy(t).sub(e).normalize()),o.mesh.visible=!0;return}}update(e,t){this.sparks.update(e,t);for(let t of this.rings){if(t.t>=t.dur){t.mesh.visible&&(t.mesh.visible=!1);continue}t.t+=e;let n=Ou(t.t/t.dur),r=1-(1-n)*(1-n),i=t.r0+(t.r1-t.r0)*r,a=t.mesh.userData.thickness??1;t.mesh.scale.set(i,i,i*.55*a),t.mat.opacity=(1-n)*t.fade}for(let t of this.beams){if(t.life<=0){t.mesh.visible&&(t.mesh.visible=!1);continue}t.life-=e;let n=Ou(t.life/t.mesh.userData.life0);t.mat.opacity=n*t.mesh.userData.opacity0,t.life<=0&&(t.mesh.visible=!1)}}},Lf=new H(0,1,0),Rf=new H,zf=64,Bf=class{items=[];group=new An;geo;v1=new H;onBounce=null;constructor(e){e.add(this.group),this.geo={disc:new pa(1,.92,1,14),box:new ua(2,1,2),pillar:new pa(1,1.15,1,8),puff:new ga(1,1)};for(let e=0;e<zf;e++){let e=new q(this.geo.disc,new qr);e.visible=!1,e.castShadow=!0,this.group.add(e),this.items.push({active:!1,spec:null,pos:new H,yaw:0,age:0,life:0,mesh:e,solidity:0})}}spawn(e,t,n,r){let i=this.items.find(e=>!e.active)??null;return i||=this.items.reduce((e,t)=>e.age>t.age?e:t),i.active=!0,i.spec=n,i.pos.copy(e),i.yaw=t,i.age=0,i.life=n.life,i.solidity=0,i.mesh.geometry=this.geo[n.shape],i.mesh.material=r,i.mesh.visible=!0,i.mesh.castShadow=!n.hot,i.mesh.layers.set(+!!n.hot),this.place(i),i}place(e){let t=e.spec,n=t.fadeIn?Ou(e.age/t.fadeIn):1,r=n*n*(3-2*n);e.solidity=r;let i=t.height*r,a=t.radius*(.35+.65*r);e.mesh.position.set(e.pos.x,e.pos.y+i*.5,e.pos.z),e.mesh.rotation.y=e.yaw,t.shape===`box`?e.mesh.scale.set(a,Math.max(.02,i),(t.depth??.3)*(.35+.65*r)):e.mesh.scale.set(a,Math.max(.02,i),a)}supportUnder(e,t,n,r,i,a=.34){if(i>.01)return null;let o=null;for(let i of this.items){if(!i.active||!i.spec.standable||i.solidity<.5)continue;let s=i.pos.y+i.spec.height*i.solidity;r>s+.03||n<s-.38||this.overlaps(i,e,t,a)&&(o===null||s>o)&&(o=s)}return o}at(e,t,n,r=.34){for(let i of this.items){if(!i.active||!i.spec.standable)continue;let a=i.pos.y+i.spec.height*i.solidity;if(!(Math.abs(a-n)>.05)&&this.overlaps(i,e,t,r))return i}return null}blocks(e){for(let t of this.items){if(!t.active||!t.spec.solid||t.solidity<.4)continue;let n=t.pos.y+t.spec.height*t.solidity;if(!(e.y<t.pos.y-.1||e.y>n)&&this.overlaps(t,e.x,e.z,.05))return!0}return!1}overlaps(e,t,n,r){let i=t-e.pos.x,a=n-e.pos.z;if(e.spec.shape===`box`){let t=Math.cos(-e.yaw),n=Math.sin(-e.yaw),o=i*t-a*n,s=i*n+a*t,c=e.spec.radius+r,l=(e.spec.depth??.3)+r;return Math.abs(o)<=c&&Math.abs(s)<=l}let o=e.spec.radius+r;return i*i+a*a<=o*o}update(e,t){for(let t of this.items){if(!t.active)continue;if(t.age+=e,t.life-=e,t.spec.rise&&(t.pos.y+=t.spec.rise*e),t.life<=0){t.active=!1,t.mesh.visible=!1;continue}this.place(t);let n=Ou(t.life/.9),r=t.mesh.material;r.transparent&&(r.opacity=(t.spec.opacity??1)*n*(.35+.65*t.solidity))}}clear(){for(let e of this.items)e.active=!1,e.mesh.visible=!1}get activeCount(){let e=0;for(let t of this.items)t.active&&e++;return e}},Vf=new K(1.5,2.6,3.6),Hf=.7,Uf=.2,Wf=1.3,Gf=class{id=`arcane`;name=`Arcane`;blurb=`Staff and bolt. Surge recoil moves you.`;primaryLabel=`Staff string`;secondaryLabel=`Bolt · hold to surge`;color=Vf;glyph=`M50 8 L64 36 L94 40 L72 61 L78 92 L50 77 L22 92 L28 61 L6 40 L36 36 Z`;charge01=-1;prompt=``;rung=0;lastFire=-10;charging=!1;v1=new H;v2=new H;v3=new H;primaryPress(e){}secondaryPress(e){if(e.t-this.lastFire>Wf&&(this.rung=0),!e.spend(8)){e.sfx.fizzle();return}this.lastFire=e.t,e.melee.cancelInto(),e.rig.castBolt(1),e.sfx.bolt(this.rung);let t=e.castOrigin(this.v1),n=this.v2.copy(e.aimPoint(this.v3)).sub(t).normalize();e.proj.spawn(t,n,{shape:`orb`,speed:40,inherit:.55,life:1.4,radius:.16,size:1,color:Vf,kind:1},e.ctrl.vel),e.vfx.burst(t,3,2.2,.05,Vf),this.rung++}secondaryHold(e,t,n){if(!this.charging){if(n<Uf||e.flow<26)return;this.charging=!0,this.charge01=0,e.sfx.chargeStart()}this.charge01=Ou(this.charge01+t/Hf),e.ctrl.chargeDrag=this.charge01,e.rig.charge01=this.charge01,e.sfx.chargeUpdate(this.charge01)}secondaryRelease(e){if(!this.charging)return;let t=this.charge01;if(this.charging=!1,this.charge01=-1,e.ctrl.chargeDrag=0,e.rig.charge01=0,e.sfx.chargeStop(),t<.12)return;e.spend(18+24*t),e.melee.cancelInto(),e.rig.blastPose(),e.sfx.blast(t);let n=e.aimDir(this.v1),r=5.5+9.5*t;e.ctrl.applyImpulse(-n.x*r,-n.y*r,-n.z*r);let i=this.v2.copy(e.ctrl.pos);i.y+=1.15;let a=this.v3.copy(i).addScaledVector(n,1.1);e.vfx.ring(a,n,.5,2.6+2.8*t,.3,Vf),e.vfx.burst(a,Math.round(10+14*t),5+6*t,.07,Vf),e.cam.kick(1.1+1.3*t),e.cam.addShake(.12+.26*t);let o=0;e.targets.blastAt(i,n,3.2+3.6*t,t,n=>{let r=n.pos.x-i.x,a=n.pos.z-i.z,s=1/Math.max(.001,Math.hypot(r,a));e.damage(n,.7+.5*t,r*s,a*s),e.sfx.hit(.7+.3*t,o++),e.vfx.burst(this.v1.set(n.pos.x,1.1,n.pos.z),8,4,.06,Vf)}),o&&e.hitStop(.055)}reset(e){this.charging&&(this.charging=!1,this.charge01=-1,e.ctrl.chargeDrag=0,e.rig.charge01=0,e.sfx.chargeStop())}},Kf=new K(2.4,1.5,3.2),qf=6,Jf=3,Yf=class{id=`spades`;name=`Spades`;blurb=`Card fan. Mark a spot, then cut to it.`;primaryLabel=`Fan of blades`;secondaryLabel=`Cut the deck · blink`;color=Kf;glyph=`M50 10 C50 10 18 38 18 56 C18 68 27 76 38 76 C43 76 47 74 50 71 C53 74 57 76 62 76 C73 76 82 68 82 56 C82 38 50 10 50 10 Z M44 74 L40 92 L60 92 L56 74 Z`;charge01=-1;prompt=``;marker=null;markerPos=new H;markerT=0;armed=!1;v1=new H;v2=new H;v3=new H;primaryPress(e){if(!e.spend(7)){e.sfx.fizzle();return}e.melee.cancelInto(),e.rig.castBolt(1),e.sfx.bolt(0);let t=e.castOrigin(this.v1),n=this.v2.copy(e.aimPoint(this.v3)).sub(t).normalize(),r=this.v3.crossVectors(n,Xf).normalize();for(let i=0;i<Jf;i++){let a=(i-1)*.075,o=new H().copy(n).addScaledVector(r,a).normalize();e.proj.spawn(t,o,{shape:`card`,speed:34,inherit:.4,life:1.5,radius:.2,size:1,color:Kf,spin:22,pierce:1,bounces:1,kind:10},e.ctrl.vel)}e.vfx.cone(t,n,4,3,.2,.045,Kf,.22)}secondaryPress(e){if(this.armed&&this.marker){this.cut(e);return}if(!e.spend(14)){e.sfx.fizzle();return}e.melee.cancelInto(),e.rig.castBolt(-1),e.sfx.bolt(2);let t=e.castOrigin(this.v1),n=this.v2.copy(e.aimPoint(this.v3)).sub(t).normalize();e.proj.spawn(t,n,{shape:`card`,speed:30,inherit:.35,life:1.6,radius:.22,size:1.5,color:Kf,spin:14,kind:11},e.ctrl.vel),this.prompt=`card in flight`}placeMarker(e,t){if(this.markerPos.copy(t),this.markerPos.y=Math.max(t.y,Z(t.x,t.z)+.9),!this.marker){let t=new qr({color:Kf,transparent:!0,opacity:.95});this.marker=new q(new ua(.42,.03,.62),t),this.marker.layers.set(1),e.scene.add(this.marker)}this.marker.visible=!0,this.marker.position.copy(this.markerPos),this.markerT=qf,this.armed=!0,this.prompt=`RMB again to cut`,e.vfx.ring(this.markerPos,Xf,.15,1.1,.35,Kf),e.vfx.burst(this.markerPos,8,3,.05,Kf)}cut(e){if(!this.marker)return;let t=this.v1.copy(e.ctrl.pos);t.y+=1,e.vfx.burst(t,16,6,.06,Kf),e.vfx.ring(t,Xf,.2,1.8,.3,Kf);let n=this.markerPos;e.ctrl.pos.set(n.x,Math.max(Z(n.x,n.z),n.y-.9),n.z),e.ctrl.vel.multiplyScalar(.55),e.ctrl.commit(0);let r=this.v2.copy(e.ctrl.pos);r.y+=1,e.vfx.beam(t,r,.22,Kf,.22,.7),e.vfx.burst(r,20,7,.07,Kf),e.vfx.ring(r,Xf,.25,2.6,.34,Kf),e.sfx.blast(.5),e.cam.kick(.8),e.cam.addShake(.18);let i=0;e.targets.hitSphere(e.ctrl.pos.x,e.ctrl.pos.y+1,e.ctrl.pos.z,2.2,t=>{let n=t.pos.x-e.ctrl.pos.x,r=t.pos.z-e.ctrl.pos.z,a=1/Math.max(.001,Math.hypot(n,r));e.damage(t,.75,n*a,r*a),e.sfx.hit(.7,i++),e.vfx.burst(this.v3.set(t.pos.x,1.1,t.pos.z),10,4.5,.06,Kf)}),i&&e.hitStop(.06),this.clearMarker()}clearMarker(){this.armed=!1,this.markerT=0,this.prompt=``,this.marker&&(this.marker.visible=!1)}update(e,t){if(!this.armed||!this.marker)return;if(this.markerT-=t,this.markerT<=0){e.vfx.burst(this.markerPos,6,2,.04,Kf),this.clearMarker();return}this.marker.rotation.y+=t*3.4,this.marker.position.y=this.markerPos.y+Math.sin(e.t*4)*.07;let n=this.marker.material;n.opacity=this.markerT<1.5?.5+.45*Math.sin(e.t*26):.95}reset(e){this.armed&&(e.vfx.burst(this.markerPos,5,2,.04,Kf),this.clearMarker())}},Xf=new H(0,1,0),Zf=new K(3.4,1.3,.25),Qf=new K(3,1,.18),$f=13,ep=1.5,tp=5,np=.35,rp=72,ip=class{id=`fire`;name=`Fire`;blurb=`Lob embers. Raise a wall across the ground.`;primaryLabel=`Ember lob`;secondaryLabel=`Wall of fire · two points`;color=Zf;glyph=`M50 6 C58 30 78 36 78 58 C78 78 65 92 50 92 C35 92 22 78 22 58 C22 44 32 40 36 30 C40 44 48 44 50 34 C52 24 46 16 50 6 Z`;charge01=-1;prompt=``;flames;preview;anchor=null;walls=[];slotUsed=new Uint8Array(rp);dummy=new kn;v1=new H;v2=new H;v3=new H;built=!1;build(e){if(this.built)return;this.built=!0;let t=new qr({transparent:!0,opacity:.92,depthWrite:!1});t.color.copy(Zf),this.flames=new Ai(new ma(.34,1.5,6),t,rp),this.flames.layers.set(1),this.flames.frustumCulled=!1,this.flames.count=rp;for(let e=0;e<rp;e++)this.flames.setMatrixAt(e,op);e.scene.add(this.flames);let n=new qr({transparent:!0,opacity:.5,depthWrite:!1});n.color.copy(Zf),this.preview=new q(new ua(1,.05,.16),n),this.preview.layers.set(1),this.preview.visible=!1,e.scene.add(this.preview)}primaryPress(e){if(!e.spend(9)){e.sfx.fizzle();return}e.melee.cancelInto(),e.rig.castBolt(1),e.sfx.bolt(1);let t=e.castOrigin(this.v1),n=this.v2.copy(e.aimPoint(this.v3)).sub(t).normalize();n.y+=.16,n.normalize(),e.proj.spawn(t,n,{shape:`orb`,speed:26,inherit:.4,life:2.2,gravity:-14,radius:.28,size:1.5,color:Qf,kind:20},e.ctrl.vel),e.vfx.cone(t,n,5,2.4,.25,.055,Qf,.28,-2)}emberBurst(e,t){e.sfx.blast(.25),e.vfx.groundRing(t,.2,2.1,.35,Zf),e.vfx.burst(t,14,5,.075,Qf,-2),e.cam.addShake(.07);let n=0;e.targets.hitSphere(t.x,t.y+.6,t.z,1.7,r=>{let i=r.pos.x-t.x,a=r.pos.z-t.z,o=1/Math.max(.001,Math.hypot(i,a));e.damage(r,.5,i*o,a*o),e.sfx.hit(.5,n++)}),n&&e.hitStop(.04)}secondaryPress(e){this.build(e);let t=e.groundAim(this.v1,34);if(!this.anchor){if(e.flow<30){e.sfx.fizzle();return}this.anchor=t.clone(),this.prompt=`set the far end`,e.sfx.bolt(0),e.vfx.groundRing(this.anchor,.1,.9,.3,Zf);return}let n=this.anchor,r=t.clone(),i=Math.hypot(r.x-n.x,r.z-n.z);if(i<ep){this.anchor=null,this.prompt=``,e.sfx.fizzle();return}if(i>$f){let e=$f/i;r.x=n.x+(r.x-n.x)*e,r.z=n.z+(r.z-n.z)*e}if(this.anchor=null,this.prompt=``,this.preview.visible=!1,!e.spend(30)){e.sfx.fizzle();return}this.raise(e,n,r)}raise(e,t,n){let r=Math.hypot(n.x-t.x,n.z-t.z),i=Math.min(rp,Math.max(4,Math.round(r*2.6))),a=this.reserve(i);if(!(a<0)){this.walls.push({a:t.clone(),b:n.clone(),life:tp,slot0:a,count:i,cooldown:new Map}),e.sfx.blast(.85),e.cam.addShake(.26),e.cam.kick(.6),e.rig.blastPose();for(let r=0;r<i;r++){let a=r/Math.max(1,i-1);this.v1.set(t.x+(n.x-t.x)*a,0,t.z+(n.z-t.z)*a),this.v1.y=Z(this.v1.x,this.v1.z),e.vfx.burst(this.v1,3,4,.07,Qf,-1.5)}e.vfx.groundRing(t,.2,1.6,.4,Zf),e.vfx.groundRing(n,.2,1.6,.4,Zf)}}reserve(e){for(let t=0;t+e<=rp;t++){let n=!0;for(let r=0;r<e;r++)if(this.slotUsed[t+r]){n=!1,t+=r;break}if(n){for(let n=0;n<e;n++)this.slotUsed[t+n]=1;return t}}return-1}update(e,t){if(this.built){if(this.anchor){let t=e.groundAim(this.v1,34),n=this.anchor,r=t.x-n.x,i=t.z-n.z,a=Math.hypot(r,i);if(a>$f){let e=$f/a;r*=e,i*=e,a=$f}let o=n.x+r*.5,s=n.z+i*.5;this.preview.visible=!0,this.preview.position.set(o,Z(o,s)+.12,s),this.preview.scale.set(Math.max(.1,a),1,1),this.preview.rotation.y=Math.atan2(r,i)+Math.PI/2,this.preview.material.opacity=a<ep?.15:.35+.2*Math.sin(e.t*9)}else this.preview.visible&&(this.preview.visible=!1);for(let n=this.walls.length-1;n>=0;n--){let r=this.walls[n];r.life-=t;let i=Ou(r.life/.6)*Ou((tp-r.life)/.25);for(let t=0;t<r.count;t++){let n=r.count>1?t/(r.count-1):.5,a=r.a.x+(r.b.x-r.a.x)*n,o=r.a.z+(r.b.z-r.a.z)*n,s=Z(a,o),c=(.72+.36*Math.sin(e.t*11+t*1.7)+.16*Math.sin(e.t*23+t*.9))*i;this.dummy.position.set(a,s+.75*c,o),this.dummy.rotation.set(Math.sin(e.t*5+t)*.12,e.t*1.5+t,Math.cos(e.t*4.4+t*1.3)*.12),this.dummy.scale.set(.85+.2*Math.sin(e.t*8+t),Math.max(.05,c),.85),this.dummy.updateMatrix(),this.flames.setMatrixAt(r.slot0+t,this.dummy.matrix)}if(Math.random()<t*22){let t=Math.random(),n=r.a.x+(r.b.x-r.a.x)*t,i=r.a.z+(r.b.z-r.a.z)*t;this.v1.set(n,Z(n,i)+.3,i),this.v2.set((Math.random()-.5)*.6,1.4+Math.random()*1.6,(Math.random()-.5)*.6),e.vfx.sparks.spawn(this.v1,this.v2,{life:.7,size:.05,color:Qf,gravity:.6,drag:.7})}for(let[t,n]of r.cooldown)n<=e.t&&r.cooldown.delete(t);for(let t of e.targets.list){if(r.cooldown.has(t)||ap(t.pos.x,t.pos.z,r.a,r.b)>1)continue;r.cooldown.set(t,e.t+np);let n=t.pos.x-r.a.x,i=t.pos.z-r.a.z,a=1/Math.max(.001,Math.hypot(n,i));e.damage(t,.32,n*a,i*a),e.sfx.hit(.3,1),this.v1.set(t.pos.x,1,t.pos.z),e.vfx.burst(this.v1,5,3,.05,Qf,-1)}if(r.life<=0){for(let e=0;e<r.count;e++)this.slotUsed[r.slot0+e]=0,this.flames.setMatrixAt(r.slot0+e,op);this.walls.splice(n,1)}}this.flames.instanceMatrix.needsUpdate=!0}}reset(e){this.anchor=null,this.prompt=``,this.built&&(this.preview.visible=!1)}};function ap(e,t,n,r){let i=r.x-n.x,a=r.z-n.z,o=e-n.x,s=t-n.z,c=i*i+a*a,l=c<1e-6?0:Du((o*i+s*a)/c,0,1);return Math.hypot(o-i*l,s-a*l)}var op=new G().makeScale(0,0,0),sp=new K(1.4,2.8,3.8),cp=new K(1.6,3,4),lp=17,up=26,dp=.16,fp=.85,pp=90,mp=5,hp=class{id=`ice`;name=`Ice`;blurb=`Chill with the beam, then erupt a star of spires.`;primaryLabel=`Frost beam · hold`;secondaryLabel=`Starfall · charge`;color=sp;glyph=`M50 6 L50 94 M50 6 L50 94 M11 28 L89 72 M89 28 L11 72 M50 22 L38 12 M50 22 L62 12 M50 78 L38 88 M50 78 L62 88 M27 35 L14 33 M27 35 L25 22 M73 65 L86 67 M73 65 L75 78 M73 35 L86 33 M73 35 L75 22 M27 65 L14 67 M27 65 L25 78`;charge01=-1;prompt=``;spires;live=[];slotUsed=new Uint8Array(pp);built=!1;beaming=!1;beamTick=0;charging=!1;dummy=new kn;v1=new H;v2=new H;v3=new H;build(e){if(this.built)return;this.built=!0;let t=new qr({transparent:!0,opacity:.85,depthWrite:!1});t.color.copy(cp),this.spires=new Ai(new ma(.26,1,5),t,pp),this.spires.layers.set(1),this.spires.frustumCulled=!1;for(let e=0;e<pp;e++)this.spires.setMatrixAt(e,gp);e.scene.add(this.spires)}primaryHold(e,t){if(!e.spend(up*t)){this.beaming&&this.stopBeam(e);return}this.beaming||(this.beaming=!0,e.melee.cancelInto(),e.sfx.chargeStart()),e.sfx.chargeUpdate(.35+.15*Math.sin(e.t*7)),e.rig.charge01=.55,e.ctrl.chargeDrag=.5;let n=e.castOrigin(this.v1),r=this.v2.copy(e.aimPoint(this.v3)).sub(n).normalize(),i=lp,a=null,o=this.v3;for(let t=.6;t<lp;t+=.35){if(o.copy(n).addScaledVector(r,t),o.y<=Z(o.x,o.z)){i=t;break}let s=e.targets.tryHit(o,.5);if(s){i=t,a=s;break}}let s=this.v3.copy(n).addScaledVector(r,i);e.vfx.beam(n,s,.1,sp,.09,.85),Math.random()<t*40&&e.vfx.cone(s,r,2,2.2,.7,.05,sp,.35,-1.5),this.beamTick-=t,this.beamTick<=0&&a&&(this.beamTick=dp,e.targets.chill(a,.55),e.damage(a,.16,r.x,r.z),e.sfx.hit(.22,0),e.vfx.burst(s,4,2.5,.045,sp,-1))}primaryRelease(e){this.stopBeam(e)}stopBeam(e){this.beaming&&(this.beaming=!1,this.beamTick=0,e.sfx.chargeStop(),e.rig.charge01=0,e.ctrl.chargeDrag=0)}secondaryHold(e,t,n){if(this.build(e),!this.charging){if(n<.08||e.flow<30)return;this.charging=!0,this.charge01=0,e.melee.cancelInto(),e.sfx.chargeStart()}if(this.charge01=Ou(this.charge01+t/fp),e.sfx.chargeUpdate(this.charge01),e.rig.charge01=this.charge01,e.ctrl.chargeDrag=this.charge01*.8,this.prompt=this.charge01>.98?`full`:``,Math.random()<t*30){let t=e.groundAim(this.v1,30);this.v2.set((Math.random()-.5)*3,1.5+Math.random(),(Math.random()-.5)*3),e.vfx.sparks.spawn(this.v1.set(t.x+this.v2.x,t.y+.1,t.z+this.v2.z),this.v2.set(-this.v2.x*1.6,.6,-this.v2.z*1.6),{life:.4,size:.05,color:sp,drag:1.2})}}secondaryRelease(e){if(!this.charging)return;let t=this.charge01;if(this.charging=!1,this.charge01=-1,this.prompt=``,e.sfx.chargeStop(),e.rig.charge01=0,e.ctrl.chargeDrag=0,t<.15)return;if(!e.spend(22+22*t)){e.sfx.fizzle();return}let n=e.groundAim(this.v1,30).clone(),r=2.4+4.6*t,i=Math.random()*Math.PI*2;e.rig.blastPose(),e.sfx.blast(.4+.6*t),e.cam.addShake(.18+.3*t),e.cam.kick(.7+.6*t),e.vfx.groundRing(n,.3,r*1.15,.42,cp);let a=4+Math.round(t*3);for(let e=0;e<mp;e++){let o=i+e/mp*Math.PI*2;for(let e=0;e<a;e++){let i=(e+1)/a,s=n.x+Math.sin(o)*r*i,c=n.z+Math.cos(o)*r*i;this.spawnSpire(s,c,(1.6+1.5*t)*(1.15-i*.5),i*.09,o)}}this.spawnSpire(n.x,n.z,2.2+1.8*t,0,i);let o=0;e.targets.hitSphere(n.x,n.y+1,n.z,r*.95,r=>{let i=r.pos.x-n.x,a=r.pos.z-n.z,s=1/Math.max(.001,Math.hypot(i,a)),c=1+e.targets.chillOf(r)*.9;e.damage(r,(.8+.7*t)*c,i*s,a*s),e.targets.chill(r,1),e.sfx.hit(.8,o++),e.vfx.burst(this.v2.set(r.pos.x,1.2,r.pos.z),14,5.5,.07,cp,-2)}),o&&e.hitStop(.07+.05*t),Math.hypot(e.ctrl.pos.x-n.x,e.ctrl.pos.z-n.z)<r*.8&&e.ctrl.applyImpulse(0,7+4*t,0)}spawnSpire(e,t,n,r,i){let a=-1;for(let e=0;e<pp;e++)if(!this.slotUsed[e]){a=e;break}a<0||(this.slotUsed[a]=1,this.live.push({slot:a,t:0,dur:1.5+Math.random()*.5,x:e,z:t,y:Z(e,t),h:n,tilt:(Math.random()-.5)*.35,yaw:i,delay:r}))}update(e,t){if(this.built){for(let e=this.live.length-1;e>=0;e--){let n=this.live[e];n.t+=t;let r=n.t-n.delay;if(r<0)continue;let i=Pu(Ou(r/.14))*(1-Ou((r-(n.dur-.3))/.3));if(i<=.001&&r>.2){this.spires.setMatrixAt(n.slot,gp),this.slotUsed[n.slot]=0,this.live.splice(e,1);continue}let a=n.h*i;this.dummy.position.set(n.x,n.y+a*.5-.15,n.z),this.dummy.rotation.set(Math.sin(n.yaw)*n.tilt,n.yaw,Math.cos(n.yaw)*n.tilt),this.dummy.scale.set(1,Math.max(.02,a),1),this.dummy.updateMatrix(),this.spires.setMatrixAt(n.slot,this.dummy.matrix)}this.spires.instanceMatrix.needsUpdate=!0}}reset(e){this.stopBeam(e),this.charging&&(this.charging=!1,this.charge01=-1,e.sfx.chargeStop(),e.rig.charge01=0,e.ctrl.chargeDrag=0)}},gp=new G().makeScale(0,0,0),_p=new K(2.2,2.5,3),vp=new K(1.35,1.5,2.1),yp=class{id=`cloud`;name=`Cloud`;blurb=`Step on the sky. Nothing here hits — you just leave.`;primaryLabel=`Cirrus step`;secondaryLabel=`Thunderhead · bounce`;color=_p;glyph=`M26 70 C12 70 6 60 10 50 C13 42 22 39 28 41 C30 26 44 18 57 22 C66 25 71 33 71 40 C84 38 92 47 90 57 C88 66 80 70 70 70 Z`;charge01=-1;prompt=``;stepMat;headMat;lastStep=-10;v1=new H;constructor(){this.stepMat=Yu({color:15922943,emissive:9412808,emissiveIntensity:.4,transparent:!0,opacity:.97}),this.headMat=Yu({color:13950190,emissive:6977704,emissiveIntensity:.45,transparent:!0,opacity:.98})}primaryPress(e){if(e.t-this.lastStep<.14)return;if(!e.spend(6)){e.sfx.fizzle();return}this.lastStep=e.t,e.melee.cancelInto(),e.rig.castBolt(1),e.sfx.bolt(0);let t=e.aimSpot(this.v1,11).clone();t.y=Math.max(t.y,Z(t.x,t.z)+.05),e.constructs.spawn(t,Math.random()*Math.PI,{shape:`puff`,radius:1.15,height:.5,life:5.5,fadeIn:.12,color:_p,opacity:.97,standable:!0},this.stepMat),e.vfx.burst(t,6,2.2,.06,_p,-.4)}secondaryPress(e){if(!e.spend(24)){e.sfx.fizzle();return}e.melee.cancelInto(),e.rig.blastPose(),e.sfx.blast(.4);let t=e.aimSpot(this.v1,13).clone();t.y=Math.max(t.y,Z(t.x,t.z)+.05),e.constructs.spawn(t,Math.random()*Math.PI,{shape:`puff`,radius:2.2,height:1.1,life:8,fadeIn:.2,color:vp,opacity:.98,standable:!0,solid:!0,bounce:12.5},this.headMat),e.vfx.ring(t,bp,.4,3,.4,_p),e.vfx.burst(t,16,3.4,.08,_p,-.3),e.cam.kick(.3)}update(e,t){}},bp=new H(0,1,0),xp=13221286,Sp=11114878,Cp=new K(1.6,1.4,1.1),wp=11,Tp=1.2,Ep=class{id=`stone`;name=`Stone`;blurb=`Raise spires and walls. Take the ground away.`;primaryLabel=`Spire`;secondaryLabel=`Bulwark · two points`;color=new K(1.5,1.35,1.05);glyph=`M14 86 L30 30 L50 52 L70 18 L86 86 Z`;charge01=-1;prompt=``;mat=X(xp);wallMat=X(Sp);preview;anchor=null;built=!1;v1=new H;build(e){if(this.built)return;this.built=!0;let t=new qr({color:Cp,transparent:!0,opacity:.45,depthWrite:!1});this.preview=new q(new ua(1,.06,.2),t),this.preview.layers.set(1),this.preview.visible=!1,e.scene.add(this.preview)}primaryPress(e){if(!e.spend(14)){e.sfx.fizzle();return}e.melee.cancelInto(),e.rig.castBolt(-1),e.sfx.blast(.3);let t=e.groundAim(this.v1,22).clone();t.y=Z(t.x,t.z),e.constructs.spawn(t,Math.random()*Math.PI,{shape:`pillar`,radius:.62,height:2.4,life:9,fadeIn:.16,color:this.color,standable:!0,solid:!0},this.mat),e.vfx.groundRing(t,.3,1.7,.3,Cp),e.vfx.burst(t,12,4.5,.07,Cp,-5),e.cam.addShake(.12);let n=0;e.targets.hitSphere(t.x,t.y+1,t.z,1.1,r=>{let i=r.pos.x-t.x,a=r.pos.z-t.z,o=1/Math.max(.001,Math.hypot(i,a));e.damage(r,.6,i*o,a*o),e.sfx.hit(.6,n++)}),n&&e.hitStop(.05)}secondaryPress(e){this.build(e);let t=e.groundAim(this.v1,26);if(!this.anchor){if(e.flow<28){e.sfx.fizzle();return}this.anchor=t.clone(),this.prompt=`set the far end`,e.sfx.bolt(0),e.vfx.groundRing(this.anchor,.1,.9,.3,Cp);return}let n=this.anchor,r=t.clone(),i=Math.hypot(r.x-n.x,r.z-n.z);if(this.anchor=null,this.prompt=``,this.preview.visible=!1,i<Tp){e.sfx.fizzle();return}if(i>wp){let e=wp/i;r.x=n.x+(r.x-n.x)*e,r.z=n.z+(r.z-n.z)*e,i=wp}if(!e.spend(28)){e.sfx.fizzle();return}let a=this.v1.set((n.x+r.x)/2,0,(n.z+r.z)/2);a.y=Z(a.x,a.z),e.constructs.spawn(a,Math.atan2(r.x-n.x,r.z-n.z)+Math.PI/2,{shape:`box`,radius:i/2,depth:.36,height:2.2,life:10,fadeIn:.22,color:this.color,standable:!0,solid:!0},this.wallMat),e.sfx.blast(.8),e.cam.addShake(.28),e.rig.blastPose();let o=Math.max(3,Math.round(i));for(let t=0;t<=o;t++){let i=t/o;this.v1.set(n.x+(r.x-n.x)*i,0,n.z+(r.z-n.z)*i),this.v1.y=Z(this.v1.x,this.v1.z),e.vfx.burst(this.v1,3,4,.07,Cp,-6)}}update(e,t){if(this.built){if(this.anchor){let t=e.groundAim(this.v1,26),n=this.anchor,r=t.x-n.x,i=t.z-n.z,a=Math.hypot(r,i);if(a>wp){let e=wp/a;r*=e,i*=e,a=wp}let o=n.x+r*.5,s=n.z+i*.5;this.preview.visible=!0,this.preview.position.set(o,Z(o,s)+.12,s),this.preview.scale.set(Math.max(.1,a),1,1),this.preview.rotation.y=Math.atan2(r,i)+Math.PI/2,this.preview.material.opacity=a<Tp?.15:.3+.2*Math.sin(e.t*9)}else this.preview.visible&&(this.preview.visible=!1)}}reset(e){this.anchor=null,this.prompt=``,this.built&&(this.preview.visible=!1)}},Dp={max:100,baseRegen:5,speedRegen:1.1,dashBonus:7,hitRefund:6},Op=class{ctrl;cam;rig;melee;targets;sfx;flow=Dp.max;all={};loadout=[];slot=0;switchFlash=0;onHitStop=()=>{};onSwitch=null;proj;vfx;constructs;ctx;lmbHeld=0;rmbHeld=0;wasLmb=!1;wasRmb=!1;t=0;frozen=!1;v1=new H;v2=new H;constructor(e,t,n,r,i,a,o,s){this.ctrl=t,this.cam=n,this.rig=r,this.melee=i,this.targets=a,this.sfx=s,this.constructs=new Bf(e),this.proj=new jf(e,a,o),this.proj.blockedBy=e=>this.constructs.blocks(e),this.vfx=new If(e),t.platforms=this.constructs;for(let e of[new Gf,new Yf,new ip,new hp,new yp,new Ep])this.all[e.id]=e;let c=this;this.ctx={scene:e,ctrl:t,cam:n,rig:r,melee:i,targets:a,sfx:s,proj:this.proj,vfx:this.vfx,constructs:this.constructs,get t(){return c.t},get flow(){return c.flow},spend(e){return c.flow<e?!1:(c.flow-=e,!0)},refund(e){c.flow=Du(c.flow+e,0,Dp.max)},hitStop(e){c.onHitStop(e)},damage(e,t,n,r){a.hit(e,n,r,6+16*t),c.flow=Du(c.flow+Dp.hitRefund*Ou(t),0,Dp.max)},aimDir:e=>n.aimDir(e),aimPoint:e=>n.aimPoint(e),groundAim:(e,t=34)=>c.aimRay(e,t,!0),aimSpot:(e,t=34)=>c.aimRay(e,t,!1),castOrigin:e=>r.getHandWorld(1,e)},this.proj.handlers={onHit:(e,t)=>this.projectileHit(e,t),onEnd:(e,t)=>this.projectileEnd(e,t)}}get school(){return this.all[this.loadout[this.slot]??this.loadout[0]??`arcane`]}get current(){return this.loadout[this.slot]??this.loadout[0]}get charge01(){return this.school?.charge01??-1}get lowFlow(){return this.flow<8}get full(){return this.loadout.length>=4}has(e){return this.loadout.includes(e)}equip(e){return this.full||this.has(e)||!this.all[e]?!1:(this.loadout.push(e),!0)}reset(e){for(let e of Object.values(this.all))e.reset?.(this.ctx);this.constructs.clear(),this.proj.clear(),this.loadout=[e],this.slot=0,this.flow=Dp.max,this.applySwitch()}cycle(e){let t=this.loadout.length;t<=1||this.selectSlot((this.slot+e%t+t)%t)}selectSlot(e){if(e===this.slot||e<0||e>=this.loadout.length)return;this.school?.reset?.(this.ctx),this.slot=e,this.switchFlash=1,this.lmbHeld=0,this.rmbHeld=0,this.wasLmb=!1,this.wasRmb=!1,this.applySwitch();let t=this.school,n=this.rig.getHandWorld(1,this.v1),r=this.cam.aimDir(this.v2);this.vfx.ring(n,r,.12,1.5,.34,t.color,.9),this.vfx.ring(n,r,.3,.9,.5,t.color,.55),this.vfx.burst(n,16,4.5,.055,t.color,-1),this.sfx.switchSchool(),this.cam.kick(.28)}select(e){let t=this.loadout.indexOf(e);t>=0&&this.selectSlot(t)}applySwitch(){let e=this.school;e&&(this.rig.setCrystalColor(e.color),this.onSwitch?.(e))}freeze(e){e&&!this.frozen&&(this.school?.reset?.(this.ctx),this.constructs.clear(),this.proj.clear()),this.frozen=e}aimRay(e,t,n){let r=this.cam.camera.position,i=this.cam.aimDir(this.v2),a=0;for(let n=1;n<=t;n+=.5){if(e.copy(r).addScaledVector(i,n),e.y<=Z(e.x,e.z)){let t=(a+n)*.5;return e.copy(r).addScaledVector(i,t),e.y=Z(e.x,e.z),e}a=n}return e.copy(r).addScaledVector(i,t),n&&(e.y=Z(e.x,e.z)),e}update(e,t){this.t+=e,this.switchFlash=ju(this.switchFlash,0,7,e),this.flow+=Dp.baseRegen*e,this.flow+=Math.max(0,this.ctrl.planarSpeed-5)*Dp.speedRegen*e,this.ctrl.events.dashed&&(this.flow+=Dp.dashBonus),this.flow=Du(this.flow,0,Dp.max);let n=this.school;if(n&&!this.frozen){let r=t.mouseDown(0);t.mousePressed(0)&&(this.lmbHeld=0,n.primaryPress?.(this.ctx)),r?(this.lmbHeld+=e,n.primaryHold?.(this.ctx,e,this.lmbHeld)):this.wasLmb&&(n.primaryRelease?.(this.ctx,this.lmbHeld),this.lmbHeld=0),this.wasLmb=r;let i=t.mouseDown(2);t.mousePressed(2)&&(this.rmbHeld=0,n.secondaryPress?.(this.ctx)),i?(this.rmbHeld+=e,n.secondaryHold?.(this.ctx,e,this.rmbHeld)):this.wasRmb&&(n.secondaryRelease?.(this.ctx,this.rmbHeld),this.rmbHeld=0),this.wasRmb=i}n?.update?.(this.ctx,e),this.proj.update(e),this.constructs.update(e,this.t),this.vfx.update(e,this.t)}projectileHit(e,t){let n=1/Math.max(.001,Math.hypot(e.vel.x,e.vel.z)),r=e.vel.x*n,i=e.vel.z*n;switch(e.cfg.kind){case 1:this.ctx.damage(t,.45,r,i),this.sfx.hit(.45,0),this.onHitStop(.045),this.cam.addShake(.05);break;case 10:this.ctx.damage(t,.3,r,i),this.sfx.hit(.3,1),this.cam.addShake(.03);break;case 11:this.ctx.damage(t,.25,r,i),this.sfx.hit(.3,2)}this.vfx.burst(e.pos,7,4,.055,e.cfg.color)}projectileEnd(e,t){switch(e.cfg.kind){case 20:t!==`expire`&&this.all.fire.emberBurst(this.ctx,e.pos);break;case 11:t===`expire`?this.vfx.burst(e.pos,5,2,.04,e.cfg.color):this.all.spades.placeMarker(this.ctx,e.pos);break;case 1:this.vfx.burst(e.pos,8,4.5,.055,e.cfg.color),this.vfx.ring(e.pos,this.v1.copy(e.vel).normalize(),.12,.85,.22,e.cfg.color);break;default:this.vfx.burst(e.pos,4,3,.045,e.cfg.color)}}},kp=(e,t,n)=>new qr({color:new K(e,t,n)});function $(e,t,n,r=0){t?t.add(n):(n.position.y+=r*e.unit,e.root.add(n))}var Ap={name:`RUST-7`,model:`Knight`,stance:`brawler`,hp:100,scale:1.08,speed:2.6,preferred:2,attackRange:2.6,telegraph:.62,recovery:.75,damage:12,cadence:1.5,tint:8358553,accent:4645119,attackClip:`1H_Melee_Attack_Chop`,dress(e){let t=e.unit;e.hideParts(/sword|shield|axe|crossbow|dagger|mug|quiver|arrow|hat|cape/i);let n=new q(Xu(.26*t,.075*t,.03*t,.02*t),X(2831424));n.position.set(0,.03*t,.16*t);let r=new q(new ua(.2*t,.03*t,.01*t),kp(.3,2.6,3.4));r.position.set(0,.03*t,.18*t),e.hot(r);let i=new q(new pa(.012*t,.012*t,.26*t,5),X(3752527));i.position.set(.09*t,.24*t,0);let a=new q(new ba(.045*t,8,6),kp(3.2,.6,.4));a.position.set(.09*t,.38*t,0),e.hot(a),$(e,e.head,n,1.5),$(e,e.head,r,1.5),$(e,e.head,i,1.5),$(e,e.head,a,1.5);let o=new q(Xu(.3*t,.24*t,.06*t,.03*t),X(6055539));o.position.set(0,.1*t,.16*t);let s=new q(new ba(.06*t,10,8),kp(.4,2.4,3.2));s.position.set(0,.1*t,.21*t),e.hot(s),$(e,e.spine,o,1.1),$(e,e.spine,s,1.1),e.tick((e,t)=>{a.material.color.setRGB(3.2,.6+Math.sin(t*6)*.4,.4);let n=1+Math.sin(t*3.4)*.12;s.scale.setScalar(n)})}},jp={name:`DEAD-EYE MAE`,model:`Rogue`,stance:`shooter`,hp:85,scale:1,speed:3.4,preferred:7.5,attackRange:12,telegraph:.45,recovery:.5,damage:9,cadence:1.5,tint:11568724,accent:14238527,attackClip:`1H_Ranged_Shoot`,dress(e){let t=e.unit;e.hideParts(/sword|shield|axe|crossbow|dagger|mug|quiver|arrow|hat|hood|cape/i);let n=new q(new pa(.3*t,.32*t,.022*t,14),X(7162927));n.position.set(0,.14*t,.01*t),n.rotation.x=-.06;let r=new q(new pa(.15*t,.17*t,.19*t,12),X(8214582));r.position.set(0,.24*t,.01*t);let i=new q(new pa(.172*t,.176*t,.045*t,12),X(e.accent));i.position.set(0,.165*t,.01*t),$(e,e.head,n,1.5),$(e,e.head,r,1.5),$(e,e.head,i,1.5);let a=new q(new ma(.34*t,.5*t,8,1,!0),X(e.accent));a.material.side=2,a.position.set(0,.02*t,0),$(e,e.spine,a,1.15);let o=new An,s=new q(Xu(.045*t,.045*t,.24*t,.015*t),X(3881794));s.position.z=.1*t;let c=new q(Xu(.05*t,.13*t,.06*t,.02*t),X(7028514));c.position.set(0,-.08*t,-.02*t),o.add(s,c),$(e,e.handR,o,1)}},Mp={name:`KEEPER BRAMBLE`,model:`Barbarian`,stance:`brawler`,hp:110,scale:1.05,speed:2.8,preferred:6,attackRange:3,telegraph:.55,recovery:.7,damage:10,cadence:2,tint:10463331,accent:5212732,attackClip:`2H_Melee_Attack_Chop`,packSize:3,dress(e){let t=e.unit;e.hideParts(/sword|shield|axe|crossbow|dagger|mug|quiver|arrow|hat|cape/i);let n=new q(new pa(.26*t,.27*t,.02*t,12),X(4220730));n.position.set(0,.15*t,.02*t);let r=new q(new ba(.18*t,12,8,0,Math.PI*2,0,Math.PI*.55),X(5212732));r.position.set(0,.15*t,0),$(e,e.head,n,1.5),$(e,e.head,r,1.5);let i=new q(Xu(.2*t,.16*t,.1*t,.03*t),X(9071164));i.position.set(.22*t,-.02*t,-.06*t),$(e,e.spine,i,1.05);let a=new q(new pa(.02*t,.025*t,.7*t,6),X(7031338));a.rotation.x=Math.PI/2,a.position.z=.2*t,$(e,e.handR,a,1)}},Np={name:`LION`,model:``,stance:`beast`,hp:34,scale:1,speed:5.4,preferred:1.4,attackRange:2,telegraph:.34,recovery:.45,damage:7,cadence:1.1,accent:13202991,attackClip:``,build(e){let t=14262363,n=10246692,r=e.root,i=new q(new da(.26,.5,4,10),X(t));i.rotation.z=Math.PI/2,i.position.set(0,.62,0);let a=new q(new ba(.27,10,8),X(t));a.position.set(0,.64,.3);let o=new q(new ba(.2,12,9),X(t));o.position.set(0,.76,.62);let s=new q(new xa(.24,.11,7,14),X(n));s.position.set(0,.75,.56);let c=new q(new ba(.1,9,7),X(15782820));c.position.set(0,.71,.78);let l=new q(new ba(.028,6,5),new qr({color:2366740}));l.position.set(.075,.83,.76);let u=l.clone();u.position.x=-.075;let d=new q(new pa(.025,.035,.45,5),X(t));d.position.set(0,.72,-.36),d.rotation.x=-.7;let f=new q(new ba(.06,7,6),X(n));f.position.set(0,.86,-.5);let p=[];for(let[e,n]of[[.17,.3],[-.17,.3],[.17,-.24],[-.17,-.24]]){let i=new q(new da(.07,.34,3,7),X(t));i.position.set(e,.3,n),p.push(i),r.add(i)}r.add(i,a,o,s,c,l,u,d,f),r.traverse(e=>{e.isMesh&&(e.castShadow=!0)});let m=0;e.tick((e,t)=>{m+=e*9;for(let e=0;e<p.length;e++){let t=e===0||e===3?0:Math.PI;p[e].position.y=.3+Math.max(0,Math.sin(m+t))*.09,p[e].rotation.x=Math.sin(m+t)*.5}i.position.y=.62+Math.sin(m*2)*.025,o.position.y=.76+Math.sin(m*2+.6)*.02,d.rotation.z=Math.sin(t*3.2)*.3,f.position.x=Math.sin(t*3.2)*.12})}},Pp={name:`DR. KICKFLIP`,model:`Rogue_Hooded`,stance:`rusher`,hp:95,scale:1,speed:6.6,preferred:1.8,attackRange:2.4,telegraph:.3,recovery:.45,damage:11,cadence:1,tint:15263983,accent:6545515,attackClip:`Unarmed_Melee_Attack_Kick`,dress(e){let t=e.unit;e.hideParts(/sword|shield|axe|crossbow|dagger|mug|quiver|arrow|hat|cape/i);let n=new q(new xa(.185*t,.028*t,6,14),X(3093048));n.position.set(0,.06*t,0),n.rotation.x=Math.PI/2;let r=new q(new pa(.07*t,.07*t,.04*t,10),kp(.5,2.4,1));r.rotation.x=Math.PI/2,r.position.set(.08*t,.07*t,.16*t),e.hot(r);let i=r.clone();i.position.x=-.08*t,e.hot(i),$(e,e.head,n,1.5),$(e,e.head,r,1.5),$(e,e.head,i,1.5);let a=new q(Xu(.42*t,.5*t,.16*t,.05*t),X(16053498));a.position.set(0,-.12*t,-.02*t),$(e,e.spine,a,1);let o=new q(new ma(.08*t,.18*t,8),X(13625074));o.position.set(0,-.02*t,.04*t);let s=new q(new ba(.05*t,8,6),kp(.6,2.8,.9));s.position.set(0,-.05*t,.04*t),e.hot(s),$(e,e.handL,o,1),$(e,e.handL,s,1);let c=new An,l=new q(Xu(.26,.045,.86,.02),X(2830136));l.position.y=.11;let u=new q(new ua(.22,.01,.78),X(e.accent));u.position.y=.135,c.add(l,u);let d=[];for(let[e,t]of[[.11,.3],[-.11,.3],[.11,-.3],[-.11,-.3]]){let n=new q(new pa(.06,.06,.05,8),X(15786314));n.rotation.z=Math.PI/2,n.position.set(e,.06,t),d.push(n),c.add(n)}c.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),e.root.parent?.add(c),e.tick((e,t)=>{for(let t of d)t.rotation.y+=e*26;c.position.set(0,0,0),c.rotation.z=Math.sin(t*2.2)*.09})}},Fp={name:`BLAZE HOLLOWAY`,model:`Barbarian`,stance:`rusher`,hp:260,scale:1.14,speed:5.4,preferred:2.4,attackRange:3.4,telegraph:.4,recovery:.62,damage:18,cadence:.95,tint:2761264,accent:16742942,attackClip:`2H_Melee_Attack_Spin`,dress(e){let t=e.unit;e.hideParts(/hat|hair|helmet|beard|axe|shield|sword|mug|crossbow|dagger|quiver/i);let n=new An,r=new q(new ba(.4*t,14,11),X(15919830)),i=new q(Xu(.48*t,.14*t,.36*t,.05*t),X(14997950));i.position.set(0,.11*t,.06*t);let a=new q(Xu(.4*t,.18*t,.36*t,.05*t),X(15261382));a.position.set(0,-.26*t,.06*t);for(let e=0;e<5;e++){let r=new q(Xu(.05*t,.08*t,.035*t,.008*t),X(16643814));r.position.set((e-2)*.072*t,-.19*t,.24*t),n.add(r)}let o=new q(new ba(.1*t,9,7),kp(4.2,1.1,.12));o.position.set(.135*t,.01*t,.24*t),e.hot(o);let s=o.clone();s.position.x=-.135*t,e.hot(s),n.add(r,i,a,o,s),n.position.set(0,.3*t,.02*t),n.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),$(e,e.head,n,1.5);let c=[];for(let r=0;r<12;r++){let i=r/12*Math.PI*2,a=r<8?.28:.11,o=r<8?.55:1,s=r%2==0?kp(4,1.7,.2):kp(3.4,.8,.1),l=new q(new ma(.12*t,o*t,5),s);l.position.set(Math.cos(i)*a*t,(.3+o*.32)*t,Math.sin(i)*a*t),e.hot(l),c.push(l),n.add(l)}let l=new An,u=new q(Xu(.42*t,.1*t,.5*t,.08*t),X(9182506)),d=new q(Xu(.09*t,.05*t,.72*t,.02*t),X(4861468));d.position.z=.6*t;let f=new q(Xu(.13*t,.05*t,.16*t,.02*t),X(2890512));f.position.z=1.02*t;let p=new q(new ua(.06*t,.008*t,.7*t),kp(2.2,2,1.6));p.position.set(0,.04*t,.6*t),e.hot(p),l.add(u,d,f,p);for(let n=0;n<6;n++){let r=n/6*Math.PI*2,i=new q(new ma(.06*t,.28*t,5),kp(3.4,1.1,.15));i.position.set(Math.cos(r)*.16*t,.06*t,Math.sin(r)*.16*t),e.hot(i),c.push(i),l.add(i)}l.rotation.set(0,0,0),l.position.set(0,0,.1*t),$(e,e.handR,l,1),e.tick((e,t)=>{for(let e=0;e<c.length;e++){let n=c[e],r=.6+.55*Math.sin(t*13+e*1.7)+.25*Math.sin(t*27+e);n.scale.set(.8+.3*Math.sin(t*9+e),Math.max(.15,r),.8+.3*Math.cos(t*11+e)),n.rotation.y=t*2+e}let n=1+Math.sin(t*7)*.14;o.scale.setScalar(n),s.scale.setScalar(n)})}};function Ip(e,t,n,r,i,a){let o=e.unit,s=new q(new pa(t*o,(t+.02)*o,.022*o,14),X(r));s.position.set(0,.14*o,.01*o);let c=new q(new pa(.15*o,.17*o,n*o,12),X(i));if(c.position.set(0,(.15+n*.5)*o,.01*o),$(e,e.head,s,1.5),$(e,e.head,c,1.5),a!==void 0){let t=new q(new pa(.172*o,.176*o,.045*o,12),X(a));t.position.set(0,.175*o,.01*o),$(e,e.head,t,1.5)}}function Lp(e,t,n,r,i,a=.5,o=.26){let s=e.unit,c=[];for(let l=0;l<t;l++){let u=l/t*Math.PI*2,d=new q(new ma(.1*s,a*s,5),kp(n,r,i));d.position.set(Math.cos(u)*o*s,(.36+a*.3)*s,Math.sin(u)*o*s),e.hot(d),c.push(d),$(e,e.head,d,1.5)}return e.tick((e,t)=>{for(let e=0;e<c.length;e++){let n=.6+.5*Math.sin(t*12+e*1.6)+.2*Math.sin(t*25+e);c[e].scale.set(1,Math.max(.15,n),1),c[e].rotation.y=t*2+e}}),c}function Rp(e,t,n,r,i=.055){let a=e.unit,o=new q(new ba(i*a,8,6),kp(t,n,r));o.position.set(.085*a,.02*a,.17*a);let s=o.clone();s.position.x=-.085*a,e.hot(o),e.hot(s),$(e,e.head,o,1.5),$(e,e.head,s,1.5),e.tick((e,t)=>{let n=1+Math.sin(t*5)*.15;o.scale.setScalar(n),s.scale.setScalar(n)})}function zp(e,t){let n=e.unit,r=new q(new ma(.36*n,.62*n,8,1,!0),X(t));r.material.side=2,r.position.set(0,0,-.05*n),$(e,e.spine,r,1.15)}function Bp(e,t,n=!1){$(e,n?e.handL:e.handR,t,1)}var Vp=/sword|shield|axe|crossbow|dagger|mug|quiver|arrow|hat|cape|hood/i,Hp=[Ap,jp,Mp,Pp,Fp,{name:`CHEF FLAMBÉ`,model:`Barbarian`,stance:`shooter`,hp:120,scale:1.02,speed:3.6,preferred:6.5,attackRange:11,telegraph:.4,recovery:.5,damage:11,cadence:1.3,tint:15921126,accent:14241599,attackClip:`Throw`,dress(e){e.hideParts(Vp);let t=e.unit,n=new q(new pa(.2*t,.16*t,.34*t,12),X(16514038));n.position.set(0,.3*t,0);let r=new q(new ba(.2*t,10,8),X(16514038));r.position.set(0,.46*t,0),$(e,e.head,n,1.5),$(e,e.head,r,1.5);let i=new q(Xu(.22*t,.3*t,.03*t,.01*t),X(14212579));i.position.z=.16*t,Bp(e,i)}},{name:`THE MIME`,model:`Rogue_Hooded`,stance:`rusher`,hp:105,scale:1,speed:6.2,preferred:1.7,attackRange:2.3,telegraph:.26,recovery:.4,damage:12,cadence:.9,tint:16053495,accent:1842210,attackClip:`Unarmed_Melee_Attack_Punch_A`,dress(e){e.hideParts(Vp);let t=e.unit,n=new q(new ba(.2*t,10,6,0,Math.PI*2,0,Math.PI*.5),X(1842210));n.position.set(0,.16*t,0),n.rotation.z=.2,$(e,e.head,n,1.5);for(let n=0;n<4;n++){let r=new q(Xu(.44*t,.05*t,.34*t,.01*t),X(1842210));r.position.set(0,(.16-n*.11)*t,0),$(e,e.spine,r,1.1)}}},{name:`BUZZ & THE HIVE`,model:`Knight`,stance:`brawler`,hp:130,scale:1.02,speed:2.9,preferred:6.5,attackRange:3,telegraph:.5,recovery:.65,damage:10,cadence:2,tint:15262415,accent:16765501,attackClip:`1H_Melee_Attack_Slice_Horizontal`,packSize:4,pack:{name:`BEE`,model:``,stance:`beast`,hp:20,scale:1,speed:6.4,preferred:1.2,attackRange:1.8,telegraph:.25,recovery:.35,damage:5,cadence:.9,accent:16765501,attackClip:``,build(e){let t=e.root,n=new q(new ba(.22,10,8),X(16765501));n.position.y=1.1,n.scale.z=1.5;for(let e=0;e<3;e++){let n=new q(new xa(.2,.045,6,12),X(2761754));n.position.set(0,1.1,-.08+e*.13),n.rotation.y=Math.PI/2,n.rotation.z=Math.PI/2,t.add(n)}let r=new q(new ba(.16,7,5),new qr({color:new K(1.6,1.8,2.2),transparent:!0,opacity:.55}));r.position.set(.16,1.24,-.02),r.scale.set(1,.25,.7),r.layers.set(1);let i=r.clone();i.position.x=-.16;let a=new q(new ma(.05,.18,5),X(2761754));a.position.set(0,1.1,-.32),a.rotation.x=-Math.PI/2,t.add(n,r,i,a),t.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),e.tick((e,t)=>{let o=Math.sin(t*44);r.rotation.z=-.5+o*.7,i.rotation.z=.5-o*.7,n.position.y=1.1+Math.sin(t*6)*.09,r.position.y=i.position.y=n.position.y+.14,a.position.y=n.position.y})}},dress(e){e.hideParts(Vp);let t=e.unit,n=new q(new pa(.26*t,.3*t,.42*t,12,1,!0),new Pa({color:14605008,transparent:!0,opacity:.55,side:2}));n.position.set(0,.1*t,0);let r=new q(new pa(.3*t,.3*t,.04*t,12),X(15920866));r.position.set(0,.32*t,0),$(e,e.head,n,1.5),$(e,e.head,r,1.5);let i=new q(new pa(.08*t,.1*t,.26*t,8),X(9080726));i.position.z=.1*t,Bp(e,i)}},{name:`SIR CLANKALOT`,model:`Knight`,stance:`brawler`,hp:210,scale:1.16,speed:2.3,preferred:2,attackRange:3,telegraph:.7,recovery:.85,damage:20,cadence:1.7,tint:7239300,accent:13214247,attackClip:`2H_Melee_Attack_Chop`,dress(e){e.hideParts(/sword|axe|crossbow|dagger|mug|quiver|arrow|hat|cape/i);let t=e.unit;Rp(e,3,1.6,.3,.045);let n=new q(Xu(.06*t,.3*t,.34*t,.02*t),X(13214247));n.position.set(0,.34*t,0),$(e,e.head,n,1.5);let r=new q(new ba(.22*t,10,7,0,Math.PI*2,0,Math.PI*.55),X(9081502));r.position.set(.3*t,.3*t,0);let i=r.clone();i.position.x=-.3*t,$(e,e.spine,r,1.15),$(e,e.spine,i,1.15)}},{name:`THE RINGMASTER`,model:`Rogue`,stance:`brawler`,hp:340,scale:1.12,speed:4.4,preferred:4,attackRange:3.2,telegraph:.42,recovery:.6,damage:19,cadence:1.1,tint:2824750,accent:16726862,attackClip:`2H_Melee_Attack_Spin`,packSize:2,pack:{name:`CLOWN`,model:`Rogue`,stance:`rusher`,hp:45,scale:.92,speed:6.8,preferred:1.6,attackRange:2.2,telegraph:.24,recovery:.36,damage:7,cadence:.85,tint:15984361,accent:16734842,attackClip:`Unarmed_Melee_Attack_Punch_B`,dress(e){e.hideParts(Vp);let t=e.unit,n=new q(new ba(.07*t,8,6),X(16726862));n.position.set(0,-.01*t,.2*t),$(e,e.head,n,1.5);for(let n of[-1,1]){let r=new q(new ba(.13*t,8,6),X(16734842));r.position.set(n*.19*t,.12*t,0),$(e,e.head,r,1.5)}}},dress(e){e.hideParts(Vp),Ip(e,.3,.42,1708064,2364456,16726862),zp(e,11542326),Rp(e,3.2,.8,1,.04);let t=e.unit,n=new q(new pa(.025*t,.03*t,.86*t,6),X(1708064));n.rotation.x=Math.PI/2,n.position.z=.28*t;let r=new q(new ba(.07*t,9,7),kp(3,2.2,.6));r.position.z=.72*t,e.hot(r);let i=new An;i.add(n,r),Bp(e,i)}},{name:`FROSTBITE FINN`,model:`Barbarian`,stance:`rusher`,hp:230,scale:1.22,speed:5,preferred:2,attackRange:3.2,telegraph:.38,recovery:.6,damage:18,cadence:1.2,tint:14674418,accent:8374271,attackClip:`2H_Melee_Attack_Chop`,dress(e){e.hideParts(Vp),Rp(e,.6,2.2,3.4,.05);let t=e.unit;for(let n=0;n<7;n++){let r=n/7*Math.PI*2,i=new q(new ma(.06*t,.3*t,5),X(12575999));i.position.set(Math.cos(r)*.24*t,.3*t,Math.sin(r)*.24*t),i.rotation.set(Math.sin(r)*.3,0,Math.cos(r)*.3),$(e,e.head,i,1.5)}}},{name:`CAPTAIN BILGE`,model:`Rogue_Hooded`,stance:`shooter`,hp:150,scale:1.04,speed:4,preferred:7,attackRange:12,telegraph:.4,recovery:.5,damage:14,cadence:1.2,tint:4864853,accent:14729290,attackClip:`1H_Ranged_Shoot`,dress(e){e.hideParts(Vp),Ip(e,.32,.2,1906726,2366768,14729290),zp(e,3024192);let t=e.unit,n=new q(Xu(.1*t,.09*t,.02*t,.01*t),X(1315100));n.position.set(.085*t,.02*t,.19*t),$(e,e.head,n,1.5);let r=new q(Xu(.05*t,.05*t,.28*t,.015*t),X(3881794));r.position.z=.12*t,Bp(e,r)}},{name:`NEON`,model:`Rogue`,stance:`rusher`,hp:160,scale:1,speed:7.2,preferred:1.8,attackRange:2.4,telegraph:.26,recovery:.4,damage:14,cadence:.85,tint:2103344,accent:16732120,attackClip:`Dualwield_Melee_Attack_Slice`,dress(e){e.hideParts(Vp),Rp(e,3.4,.6,2.8,.05),Lp(e,5,3.2,.5,2.6,.4,.2);let t=e.unit;for(let n of[-1,1]){let r=new q(Xu(.05*t,.05*t,.5*t,.02*t),kp(3.4,.6,2.8));r.position.set(n*.22*t,.05*t,.06*t),e.hot(r),$(e,e.spine,r,1.1)}}},{name:`THE GARDENER`,model:`Barbarian`,stance:`brawler`,hp:200,scale:1.06,speed:3.2,preferred:4,attackRange:3.6,telegraph:.5,recovery:.7,damage:16,cadence:1.4,tint:7311186,accent:10147919,attackClip:`2H_Melee_Attack_Slice`,dress(e){e.hideParts(Vp);let t=e.unit;for(let n=0;n<9;n++){let r=n/9*Math.PI*2,i=new q(new ba(.13*t,8,6),X(n%2?7323455:9360469));i.position.set(Math.cos(r)*.24*t,.22*t,Math.sin(r)*.24*t),i.scale.set(1,.5,1.5),i.rotation.y=r,$(e,e.head,i,1.5)}let n=new q(new pa(.025*t,.03*t,.9*t,6),X(7031338));n.rotation.x=Math.PI/2,n.position.z=.3*t,Bp(e,n)}},{name:`THE KRAKEN`,model:`Barbarian`,stance:`brawler`,hp:520,scale:1.3,speed:3.6,preferred:3,attackRange:4.2,telegraph:.46,recovery:.72,damage:24,cadence:1.15,tint:3944299,accent:8343512,attackClip:`2H_Melee_Attack_Spin`,dress(e){e.hideParts(Vp),Rp(e,3.4,2.2,.5,.075);let t=e.unit,n=[];for(let r=0;r<8;r++){let i=r/8*Math.PI*2,a=new q(new ma(.09*t,.72*t,6),X(r%2?5981856:8343512));a.position.set(Math.cos(i)*.24*t,.06*t,Math.sin(i)*.24*t),n.push(a),$(e,e.head,a,1.5)}e.tick((e,t)=>{for(let e=0;e<n.length;e++){let r=e/n.length*Math.PI*2,i=Math.sin(t*2.4+e*.8)*.4;n[e].rotation.set(Math.cos(r)*(.9+i),0,-Math.sin(r)*(.9+i))}})}},{name:`VOLT`,model:`Knight`,stance:`shooter`,hp:210,scale:1.04,speed:4.6,preferred:8,attackRange:13,telegraph:.36,recovery:.46,damage:16,cadence:1,tint:2766160,accent:7334143,attackClip:`1H_Ranged_Shoot`,dress(e){e.hideParts(Vp),Rp(e,.5,2.8,3.6,.05),Lp(e,6,.6,2.6,3.6,.55,.22)}},{name:`THE COLLECTOR`,model:`Rogue_Hooded`,stance:`brawler`,hp:240,scale:1.06,speed:4.2,preferred:3.4,attackRange:3.2,telegraph:.4,recovery:.58,damage:18,cadence:1.1,tint:3814224,accent:14201423,attackClip:`Dualwield_Melee_Attack_Stab`,dress(e){e.hideParts(Vp),zp(e,2367288),Rp(e,3.2,2.4,.7,.045);let t=e.unit;for(let n=0;n<5;n++){let r=n/5*Math.PI*2,i=new q(new _a(.075*t,0),kp(2.8,2,.6));i.position.set(Math.cos(r)*.34*t,.16*t,Math.sin(r)*.34*t),e.hot(i),$(e,e.spine,i,1.2),e.tick(e=>{i.rotation.y+=e*2})}}},{name:`TWIN SPIRE`,model:`Knight`,stance:`brawler`,hp:200,scale:1.08,speed:4.4,preferred:2.4,attackRange:3,telegraph:.36,recovery:.55,damage:16,cadence:1.05,tint:7167880,accent:14209279,attackClip:`1H_Melee_Attack_Slice_Diagonal`,packSize:1,pack:{name:`SPIRE`,model:`Knight`,stance:`brawler`,hp:120,scale:1,speed:4.2,preferred:2.2,attackRange:2.7,telegraph:.4,recovery:.55,damage:13,cadence:1.2,tint:9404328,accent:14209279,attackClip:`1H_Melee_Attack_Stab`,dress(e){e.hideParts(Vp),Rp(e,2.6,2.4,3.4,.045)}},dress(e){e.hideParts(Vp),Rp(e,2.6,2.4,3.4,.05),Lp(e,4,1.6,1.5,3.2,.42,.2)}},{name:`NIGHTFALL`,model:`Rogue_Hooded`,stance:`rusher`,hp:250,scale:1.02,speed:7.6,preferred:1.8,attackRange:2.6,telegraph:.24,recovery:.38,damage:19,cadence:.8,tint:1315358,accent:9400319,attackClip:`Dualwield_Melee_Attack_Chop`,dress(e){e.hideParts(Vp),zp(e,986392),Rp(e,2.2,1.2,3.6,.055)}},{name:`THE ARCHITECT`,model:`Knight`,stance:`brawler`,hp:780,scale:1.34,speed:4,preferred:3.4,attackRange:4.4,telegraph:.44,recovery:.7,damage:28,cadence:1,tint:14208960,accent:16763230,attackClip:`2H_Melee_Attack_Chop`,dress(e){e.hideParts(Vp),Rp(e,4,3,1,.07);let t=e.unit,n=[];for(let r=0;r<10;r++){let r=new q(Xu(.18*t,.3*t,.06*t,.02*t),X(15524818));n.push(r),$(e,e.head,r,1.5)}let r=new q(new xa(.36*t,.035*t,6,22),kp(3.2,2.4,.8));r.rotation.x=Math.PI/2,r.position.y=.42*t,e.hot(r),$(e,e.head,r,1.5),e.tick((e,i)=>{for(let e=0;e<n.length;e++){let r=e/n.length*Math.PI*2+i*.5,a=(.44+Math.sin(i*1.3+e)*.09)*t;n[e].position.set(Math.cos(r)*a,(.3+Math.sin(i*2+e*.7)*.12)*t,Math.sin(r)*a),n[e].rotation.set(i*.6+e,r,0)}r.rotation.z+=e*.8})}}],Up=Hp.length,Wp=[4,9,14,19],Gp=[{clip:`1H_Melee_Attack_Chop`,startup:.075,active:.1,recovery:.21,lunge:6.4,reach:1.25,radius:1.15,power:.45,timeScale:1.55,lift:0},{clip:`1H_Melee_Attack_Slice_Horizontal`,startup:.065,active:.11,recovery:.23,lunge:7.2,reach:1.35,radius:1.3,power:.6,timeScale:1.6,lift:0},{clip:`2H_Melee_Attack_Spin`,startup:.11,active:.17,recovery:.34,lunge:8.6,reach:1.5,radius:1.75,power:1,timeScale:1.45,lift:2.6}],Kp=.4,qp=.28,Jp=9,Yp=5,Xp=4.5,Zp=.5,Qp=1.05,$p=3.4,em=class{ctrl;cam;dummies;phase=`idle`;index=-1;combo=0;perfectStreak=0;lastPerfect=!1;onHit=null;onSwing=null;onBegin=null;onPerfect=null;onFinisher=null;onFlow=null;t=0;buffered=!1;bufferedPerfect=!1;comboTimer=0;hitThisSwing=new Set;v1=new H;constructor(e,t,n){this.ctrl=e,this.cam=t,this.dummies=n}get active(){return this.phase!==`idle`}get cancelable(){return this.phase===`recovery`}cancelInto(){this.phase===`recovery`&&this.reset(!0)}enabled=!0;update(e,t){this.lastPerfect=!1;let n=this.index>=0?Gp[this.index]:null;if(this.phase===`idle`&&(this.comboTimer-=e,this.comboTimer<=0&&this.index>=0&&(this.index=-1,this.combo=0,this.perfectStreak=0)),this.phase===`recovery`&&(t.pressed(`ShiftLeft`)||t.pressed(`ShiftRight`))){this.reset(!0);return}if(t.mousePressed(0)&&this.enabled){if(this.phase===`idle`)this.begin(this.nextIndex(),!1,t);else if(this.phase===`recovery`&&n){let e=this.t-(n.startup+n.active)<=n.recovery*Kp;this.begin(this.nextIndex(),e,t)}else this.buffered=!0,this.bufferedPerfect=!1}if(!n)return;this.t+=e;let r=n.startup,i=n.startup+n.active,a=i+n.recovery,o=this.phase;if(this.phase=this.t<r?`startup`:this.t<i?`active`:this.t<a?`recovery`:`idle`,o!==`active`&&this.phase===`active`&&this.hitThisSwing.clear(),this.phase===`active`&&this.sweep(n),this.phase===`recovery`&&this.buffered){this.buffered=!1,this.begin(this.nextIndex(),this.bufferedPerfect,t);return}this.phase===`idle`&&o!==`idle`&&(this.comboTimer=qp,this.buffered=!1),!this.ctrl.grounded&&this.phase!==`idle`&&this.phase!==`recovery`&&(this.ctrl.hangTime=.05)}nextIndex(){return this.index<0?0:(this.index+1)%Gp.length}begin(e,t,n){let r=Gp[e];this.index=e,this.t=0,this.phase=`startup`,this.buffered=!1,this.hitThisSwing.clear(),this.comboTimer=qp,this.lastPerfect=t,t?(this.perfectStreak++,this.onPerfect?.(this.perfectStreak+this.combo),this.onFlow?.(Yp)):e===0&&(this.perfectStreak=0);let i=n.moveAxis();if(Math.abs(i.x)+Math.abs(i.y)>.01){let e=this.cam.forwardYaw,t=Math.sin(e),n=Math.cos(e),r=t*i.y-n*i.x,a=n*i.y+t*i.x;this.ctrl.yaw=Math.atan2(r,a)}let a=r.lunge*(t?1.25:1),o=this.dummies.nearestInCone(this.ctrl.pos.x,this.ctrl.pos.z,this.ctrl.yaw,Xp,Zp);if(o){let e=o.pos.x-this.ctrl.pos.x,t=o.pos.z-this.ctrl.pos.z;this.ctrl.yaw=Math.atan2(e,t);let n=Math.max(0,Math.hypot(e,t)-Qp);a=Math.min(a,n*$p)}this.ctrl.lunge(a,r.lift*(this.ctrl.grounded?1:.55)),this.ctrl.commit(r.startup+r.active+r.recovery*.55),this.onSwing?.(e===Gp.length-1),this.onBegin?.(r.clip,r.timeScale*(t?1.12:1),r.startup+r.active+r.recovery*.7)}reset(e){this.phase=`idle`,this.t=0,this.buffered=!1,this.ctrl.commit(0),e&&(this.comboTimer=qp)}sweep(e){let t=this.ctrl,n=Math.sin(t.yaw),r=Math.cos(t.yaw),i=t.pos.x+n*e.reach,a=t.pos.z+r*e.reach,o=t.pos.y+1;this.dummies.hitSphere(i,o,a,e.radius,n=>{if(this.hitThisSwing.has(n))return;this.hitThisSwing.add(n),this.combo++;let r=this.lastPerfect||this.perfectStreak>0,i=e.power*(r?1.35:1),a=n.pos.x-t.pos.x,o=n.pos.z-t.pos.z,s=1/Math.max(.001,Math.hypot(a,o));this.dummies.hit(n,a*s,o*s,8+16*i),this.onFlow?.(Jp*(r?1.4:1)),this.onHit?.(n,i,this.combo,r),this.index===Gp.length-1&&this.onFinisher?.()})}swingPoint(e){let t=this.index>=0?Gp[this.index]:Gp[0],n=this.ctrl,r=Ou((this.t-t.startup)/Math.max(.001,t.active)),i=n.yaw+(r-.5)*2.2;return e.set(n.pos.x+Math.sin(i)*t.reach,n.pos.y+1.05,n.pos.z+Math.cos(i)*t.reach)}currentClip(){if(this.index<0||this.phase===`idle`)return null;let e=Gp[this.index];return{clip:e.clip,timeScale:e.timeScale*(this.lastPerfect?1.12:1)}}},tm=150,nm=4,rm=`᛫ᚦᚨᛉᛊᛒᛗᛞᛟᚱᚲᚷᚹᚻᚾᛁᛃᛇᛈ`,im=`http://www.w3.org/2000/svg`,am=class{onPick;open=!1;el;svg;ringA;ringB;nodes=[];nameEl;blurbEl;primaryEl;secondaryEl;loadout=[null,null,null,null];selected=0;spin=0;cx=0;cy=0;constructor(e){this.onPick=e,this.el=document.getElementById(`wheel`),this.svg=this.el.querySelector(`svg`),this.ringA=this.svg.querySelector(`#wheel-ring-a`),this.ringB=this.svg.querySelector(`#wheel-ring-b`),this.nameEl=this.svg.querySelector(`#wheel-name`),this.blurbEl=this.svg.querySelector(`#wheel-blurb`),this.primaryEl=this.svg.querySelector(`#wheel-primary`),this.secondaryEl=this.svg.querySelector(`#wheel-secondary`),this.buildRunes(this.ringA,22,199,13),this.buildRunes(this.ringB,30,226,10),this.buildSlots()}buildRunes(e,t,n,r){for(let i=0;i<t;i++){let a=i/t*Math.PI*2,o=document.createElementNS(im,`text`),s=Math.cos(a)*n,c=Math.sin(a)*n;o.setAttribute(`x`,String(s)),o.setAttribute(`y`,String(c)),o.setAttribute(`font-size`,String(r)),o.setAttribute(`text-anchor`,`middle`),o.setAttribute(`dominant-baseline`,`central`),o.setAttribute(`transform`,`rotate(${a*180/Math.PI+90} ${s} ${c})`),o.textContent=rm[i%19],e.appendChild(o)}}buildSlots(){let e=this.svg.querySelector(`#wheel-nodes`);for(let t=0;t<nm;t++){let n=t/nm*Math.PI*2-Math.PI/2,r=document.createElementNS(im,`g`);r.setAttribute(`class`,`wheel-node empty`),r.setAttribute(`transform`,`translate(${Math.cos(n)*tm} ${Math.sin(n)*tm})`);let i=document.createElementNS(im,`circle`);i.setAttribute(`r`,`34`),i.setAttribute(`class`,`wheel-node-ring`);let a=document.createElementNS(im,`path`);a.setAttribute(`class`,`wheel-glyph`),a.setAttribute(`transform`,`translate(-22 -22) scale(0.44)`);let o=document.createElementNS(im,`text`);o.setAttribute(`y`,`52`),o.setAttribute(`class`,`wheel-label`),o.setAttribute(`text-anchor`,`middle`),r.append(i,a,o),e.appendChild(r),this.nodes.push({g:r,ring:i,glyph:a,label:o})}}setLoadout(e){for(this.loadout=[...e];this.loadout.length<nm;)this.loadout.push(null);for(let e=0;e<nm;e++){let t=this.loadout[e],n=this.nodes[e];n.g.classList.toggle(`empty`,!t),t?(n.glyph.setAttribute(`d`,t.glyph),n.label.textContent=t.name.toUpperCase(),n.g.style.setProperty(`--c`,om(t))):(n.glyph.setAttribute(`d`,``),n.label.textContent=`—`,n.g.style.setProperty(`--c`,`#8b8598`))}this.highlight(this.selected)}show(e){this.open||(this.open=!0,this.cx=0,this.cy=0,this.selected=e,this.el.classList.add(`on`),this.highlight(e))}hide(e){this.open&&(this.open=!1,this.el.classList.remove(`on`),e&&this.loadout[this.selected]&&this.onPick(this.selected))}aim(e,t){if(this.cx=sm(this.cx+e,240),this.cy=sm(this.cy+t,240),Math.hypot(this.cx,this.cy)<26)return;let n=Math.atan2(this.cy,this.cx)+Math.PI/2,r=(Math.round(n/(Math.PI*2)*nm)%nm+nm)%nm;r!==this.selected&&this.highlight(this.selected=r)}step(e){let t=this.loadout.map((e,t)=>e?t:-1).filter(e=>e>=0);if(!t.length)return;let n=t.indexOf(this.selected),r=t[((n<0?0:n+e)%t.length+t.length)%t.length];this.highlight(this.selected=r)}highlight(e){for(let t=0;t<nm;t++)this.nodes[t].g.classList.toggle(`sel`,t===e);let t=this.loadout[e];if(!t){this.nameEl.textContent=`EMPTY`,this.blurbEl.textContent=`buy a school at the hut between rounds`,this.primaryEl.textContent=``,this.secondaryEl.textContent=``,this.el.style.setProperty(`--sel`,`#8b8598`);return}this.nameEl.textContent=t.name.toUpperCase(),this.blurbEl.textContent=t.blurb,this.primaryEl.textContent=`LMB  ${t.primaryLabel}`,this.secondaryEl.textContent=`RMB  ${t.secondaryLabel}`,this.el.style.setProperty(`--sel`,om(t))}update(e){this.open&&(this.spin+=e,this.ringA.setAttribute(`transform`,`rotate(${this.spin*14})`),this.ringB.setAttribute(`transform`,`rotate(${-this.spin*9})`))}};function om(e){return`#`+e.color.clone().convertLinearToSRGB().getHexString()}function sm(e,t){return e>t?t:e<-t?-t:e}var cm=1.7,lm=class{spec;pos=new H;vel=new H;alive=!0;height;radius=.55;chill=0;hp;maxHp;yaw=0;group=new An;state=`idle`;ready=!1;onStrike=null;onDeath=null;onTelegraph=null;mixer=null;actions={};base=``;overlayUntil=0;tilt=new An;squash=new Fu(220,.5);mats=[];baseColors=[];ticks=[];flash=0;stateT=0;cooldown=0;struck=!1;strafe=1;strafeT=0;t=0;deadT=0;v1=new H;constructor(e,t,n,r=1){this.spec=e,this.hp=this.maxHp=e.hp*r,this.height=cm*e.scale,this.radius=.5*e.scale,this.pos.set(t,Z(t,n),n),this.group.add(this.tilt),this.cooldown=.6+Math.random()*.6,this.aggression=Math.min(1.8,r),this.load()}aggression=1;load(){if(this.spec.build){let e=new An;this.tilt.add(e),this.spec.build(this.dressContext(e,1)),e.traverse(e=>{let t=e;if(!t.isMesh)return;t.castShadow=!0;let n=t.material;n.isMeshToonMaterial&&(this.mats.push(n),this.baseColors.push(n.color.clone()))}),this.ready=!0;return}new pd().load(`/magic/models/${this.spec.model}.glb`,e=>{let t=e.scene,n=new er().setFromObject(t),r=n.getSize(new H),i=cm*this.spec.scale/Math.max(.01,r.y);t.scale.setScalar(i),t.position.y=-n.min.y*i;let a=this.spec.tint===void 0?null:new K(this.spec.tint);t.traverse(e=>{let t=e;if(!t.isMesh)return;t.castShadow=!0;let n=t.material,r=e=>{let t=new Pa({map:e.map??null,color:e.color.clone(),gradientMap:Ju()});return a&&t.color.lerp(a,.72),this.mats.push(t),this.baseColors.push(t.color.clone()),t};t.material=Array.isArray(n)?n.map(r):r(n)}),this.mixer=new is(t);for(let t of e.animations)this.actions[t.name]=this.mixer.clipAction(t);this.tilt.add(t),this.setBase(`Idle`),this.spec.dress?.(this.dressContext(t,1/i)),this.ready=!0})}dressContext(e,t){return{root:e,mount:this.tilt,height:cm*this.spec.scale,head:e.getObjectByName(`head`)??null,handR:e.getObjectByName(`handslotr`)??e.getObjectByName(`handr`)??null,handL:e.getObjectByName(`handslotl`)??e.getObjectByName(`handl`)??null,spine:e.getObjectByName(`spine`)??null,accent:this.spec.accent,unit:t,hot:e=>{e.layers.set(1)},hideParts:t=>{e.traverse(e=>{e.name&&t.test(e.name)&&(e.visible=!1)})},tick:e=>this.ticks.push(e)}}takeHit(e,t,n){if(!this.alive)return;let r=1+this.chill*.9;this.hp-=n*.55*r,this.flash=1,this.squash.impulse(-n*.16);let i=(1-this.chill*.6)*(12/Math.max(4,this.spec.hp*.12));if(this.vel.x+=e*n*.11*i,this.vel.z+=t*n*.11*i,this.hp<=0){this.die();return}n>13&&this.state!==`attack`&&this.enter(`stagger`)}takeChill(e){this.chill=Math.min(1,this.chill+e)}die(){this.alive=!1,this.state=`dead`,this.deadT=0,this.play(Math.random()<.5?`Death_A`:`Death_B`,1.1,4),this.onDeath?.(this)}update(e,t,n,r){if(this.t=t,this.stateT+=e,this.cooldown=Math.max(0,this.cooldown-e),this.chill=Math.max(0,this.chill-e*.26),this.state===`dead`){if(this.deadT+=e,this.vel.multiplyScalar(Math.max(0,1-6*e)),this.integrate(e),this.finishFrame(e),this.deadT>1.6){this.group.position.y-=e*.8;for(let t of this.mats)t.transparent=!0,t.opacity=Math.max(0,t.opacity-e*.8)}return}let i=n.x-this.pos.x,a=n.z-this.pos.z,o=Math.hypot(i,a),s=Math.atan2(i,a),c=this.spec,l=1-this.chill*.55,u=0,d=0,f=9;switch(this.state){case`idle`:r&&this.enter(`approach`);break;case`approach`:{let t=o-c.preferred,n=Du(t*.6,-1,1);u=i/Math.max(o,.001)*n,d=a/Math.max(o,.001)*n,this.strafeT-=e,this.strafeT<=0&&(this.strafeT=1.2+Math.random()*1.6,this.strafe=Math.random()<.5?-1:1);let r=.55*this.strafe*Ou(1-Math.abs(t)/4);u+=a/Math.max(o,.001)*r,d+=-(i/Math.max(o,.001))*r,o<=c.attackRange&&this.cooldown<=0&&this.enter(`telegraph`);break}case`reposition`:u=-(i/Math.max(o,.001)),d=-(a/Math.max(o,.001)),this.stateT>.5&&this.enter(`approach`);break;case`telegraph`:f=14,this.stateT>=Math.max(.22,c.telegraph/this.aggression)*(2-l)&&this.enter(`attack`);break;case`attack`:{f=2;let e=c.recovery*.32;if(!this.struck&&this.stateT>=e&&(this.struck=!0,o<=c.attackRange+1.1&&this.onStrike?.(this)),c.stance===`rusher`||c.stance===`beast`){let e=Ou(1-this.stateT/c.recovery);u=i/Math.max(o,.001)*e*1.6,d=a/Math.max(o,.001)*e*1.6}this.stateT>=c.recovery&&this.enter(`recover`);break}case`recover`:f=5,this.stateT>=c.recovery*.5&&(this.cooldown=c.cadence/this.aggression*(.75+Math.random()*.5),this.enter(o<c.preferred*.7?`reposition`:`approach`));break;case`stagger`:this.stateT>.42&&this.enter(`approach`)}let p=c.speed*l,m=Math.hypot(u,d);m>.001?(u=u/m*p,d=d/m*p):(u=0,d=0);let h=this.state===`attack`?14:8;this.vel.x=ju(this.vel.x,u,h,e),this.vel.z=ju(this.vel.z,d,h,e),this.integrate(e),this.state!==`stagger`&&(this.yaw=Nu(this.yaw,s,f*l,e)),this.drive(e,o),this.finishFrame(e)}integrate(e){this.pos.addScaledVector(this.vel,e),this.pos.y=Z(this.pos.x,this.pos.z);let t=Math.hypot(this.pos.x,this.pos.z);t>26&&(this.pos.x*=26/t,this.pos.z*=26/t)}enter(e){this.state=e,this.stateT=0,this.struck=!1;let t=this.spec;e===`telegraph`?(this.play(`Spellcast_Raise`,1/Math.max(.15,t.telegraph)*.5,2),this.onTelegraph?.(this)):e===`attack`?this.play(t.attackClip,1.15,3):e===`stagger`&&(this.play(t.hurtClip??`Hit_A`,1.3,2),this.squash.impulse(-2))}drive(e,t){if(this.t<this.overlayUntil)return;let n=Math.hypot(this.vel.x,this.vel.z);n<.4?this.setBase(`Idle`,1,.2):n<2.4?this.setBase(`Walking_A`,Du(n/1.6,.7,1.5),.15):this.setBase(`Running_A`,Du(n/4.2,.8,1.6),.15)}finishFrame(e){this.mixer?.update(e),this.group.position.copy(this.pos),this.group.rotation.y=this.yaw,this.squash.update(e);let t=Du(this.squash.value*.06,-.16,.14);this.tilt.scale.set(1-t*.6,1+t,1-t*.6),this.flash=ju(this.flash,0,9,e);let n=this.flash*this.flash,r=this.state===`telegraph`?.35+.35*Math.sin(this.t*30):0;for(let e=0;e<this.mats.length;e++){let t=this.mats[e];t.emissive.setRGB(n+r+this.chill*.14,n*.9+r*.45+this.chill*.28,n*.7+r*.1+this.chill*.4),t.color.copy(this.baseColors[e]).lerp(um,this.chill*.55)}for(let t of this.ticks)t(e,this.t)}setBase(e,t=1,n=.15){let r=this.actions[e];if(!r)return;if(this.base===e){r.setEffectiveTimeScale(t),r.setEffectiveWeight(1);return}let i=this.actions[this.base];r.reset(),r.setEffectiveTimeScale(t),r.setEffectiveWeight(1),r.play(),i&&r.crossFadeFrom(i,n,!1),this.base=e}play(e,t,n){let r=this.actions[e];if(!r)return;r.reset(),r.setLoop(N,1),r.clampWhenFinished=!0,r.setEffectiveTimeScale(t),r.setEffectiveWeight(1),r.fadeIn(.05),r.play();let i=this.actions[this.base];i&&i.setEffectiveWeight(.12),this.overlayUntil=this.t+n,this.base=``}dispose(e){e.remove(this.group)}},um=new K(10475760),dm=.62,fm=class{group=new An;rungs=[];marker;markerMat;glow;targetY=0;y=0;constructor(e,t,n){let r=Z(t,n);this.group.position.set(t,r,n),this.group.rotation.y=Math.atan2(-t,-n);let i=dm*(e+1)+.9,a=new q(new pa(.72,.86,.42,10),X(13089181));a.position.y=.21;let o=new q(Xu(.62,i,.42,.06),X(14274488));o.position.y=.42+i/2;let s=new q(new ma(.5,.5,4),X(13089181));s.position.y=.42+i+.2,s.rotation.y=Math.PI/4,a.castShadow=o.castShadow=s.castShadow=!0,a.receiveShadow=o.receiveShadow=!0,this.group.add(a,o,s);for(let t=0;t<e;t++){let e=.9+t*dm,n=new qr({color:new K(.18,.16,.14)}),r=new q(Xu(.46,.12,.06,.02),n);r.position.set(0,e,.22),r.layers.set(1),this.group.add(r),this.rungs.push({mesh:r,mat:n,y:e})}this.markerMat=new qr({color:new K(3,2,.6)}),this.marker=new q(new ma(.16,.28,4),this.markerMat),this.marker.rotation.z=-Math.PI/2,this.marker.layers.set(1),this.group.add(this.marker),this.glow=new q(new xa(.42,.035,6,20),new qr({color:new K(3,2,.6),transparent:!0,opacity:.6})),this.glow.layers.set(1),this.group.add(this.glow),this.y=this.targetY=this.rungs[0]?.y??1}setProgress(e){for(let t=0;t<this.rungs.length;t++){let n=this.rungs[t];t<e?n.mat.color.setRGB(2.4,1.6,.5):t===e?n.mat.color.setRGB(3,2.2,.8):n.mat.color.setRGB(.18,.16,.14)}let t=this.rungs[Math.min(e,this.rungs.length-1)];t&&(this.targetY=t.y)}update(e,t){this.y=ju(this.y,this.targetY,5,e);let n=Math.sin(t*2.6)*.03;this.marker.position.set(.45,this.y+n,.22),this.glow.position.set(0,this.y,.16),this.glow.rotation.z=t*.9;let r=.45+.25*Math.sin(t*3.4);this.glow.material.opacity=r;let i=Ou(Math.abs(this.targetY-this.y)*3);this.marker.scale.setScalar(1+i*.5)}},pm=2.4,mm=2.4,hm=4.5,gm=10,_m=25,vm=`story.best`,ym=class{scene;targets;phase=`prep`;round=0;coins=0;best=0;enemies=[];tower;playerHp=100;playerMaxHp=100;onAnnounce=null;onVictory=null;onRunOver=null;onRunStart=null;onPlayerHurt=null;onEnemyTelegraph=null;onEnemyDeath=null;invuln=0;phaseT=0;v1=new H;constructor(e,t){this.scene=e,this.targets=t,this.tower=new fm(Up,-13.5,-11.5),e.add(this.tower.group),this.best=Number(localStorage.getItem(vm)??0)||0}get spec(){return Hp[this.round]??null}get isBossRound(){return Wp.includes(this.round)}get roundNumber(){return this.round+1}get difficulty(){return 1+this.round*.055}begin(){this.round=0,this.coins=0,this.playerHp=this.playerMaxHp,this.clearEnemies(),this.tower.setProgress(0),this.phase=`prep`,this.phaseT=0,this.onRunStart?.()}startRound(){if(this.phase!==`prep`)return;this.phase=`announce`,this.phaseT=0,this.tower.setProgress(this.round);let e=this.spec;e&&this.onAnnounce?.(e.name,this.roundNumber,this.isBossRound)}spawn(){let e=this.spec;if(!e)return;let t=Math.random()*Math.PI*2;this.add(e,Math.cos(t)*7,Math.sin(t)*7);for(let n=0;n<(e.packSize??0);n++){let r=t+(n-((e.packSize??1)-1)/2)*.65;this.add(e.pack??Np,Math.cos(r)*6,Math.sin(r)*6)}}add(e,t,n){let r=new lm(e,t,n,this.difficulty);return r.onStrike=e=>this.strike(e),r.onTelegraph=e=>this.onEnemyTelegraph?.(e),r.onDeath=e=>this.onEnemyDeath?.(e),this.scene.add(r.group),this.targets.add(r),this.enemies.push(r),r}strike(e){if(this.phase!==`fight`||this.invuln>0)return;this.invuln=.5;let t=e.spec.damage*this.difficulty;this.playerHp=Math.max(0,this.playerHp-t),this.onPlayerHurt?.(t),this.playerHp<=0&&this.endRun()}endRun(){this.phase=`over`,this.phaseT=0;for(let e of this.enemies)e.state=`idle`;let e=this.roundNumber,t=e>this.best;t&&(this.best=e,localStorage.setItem(vm,String(this.best))),this.onRunOver?.(e,this.best,t)}clearEnemies(){for(let e of this.enemies)this.targets.remove(e),this.scene.remove(e.group);this.enemies.length=0}get pressure(){if(this.phase!==`fight`)return 0;let e=0;for(let t of this.enemies)t.alive&&e++;return Ou(e/2)}distanceToRing(e){return Math.hypot(e.x,e.z)}update(e,t,n){this.phaseT+=e,this.invuln=Math.max(0,this.invuln-e),this.tower.update(e,t);let r=this.phase===`fight`;for(let i of this.enemies)i.update(e,t,n,r&&this.playerHp>0);switch(this.phase){case`prep`:this.distanceToRing(n)<8&&this.startRound();break;case`announce`:this.phaseT>pm*.4&&!this.enemies.length&&this.spawn(),this.phaseT>=pm&&(this.phase=`fight`,this.phaseT=0);break;case`fight`:{let e=0;for(let t of this.enemies)t.alive&&e++;if(e===0&&this.enemies.length){this.phase=`won`,this.phaseT=0;let e=gm+(this.isBossRound?_m:0)+Math.round(this.round*1.5);this.coins+=e,this.playerHp=Math.min(this.playerMaxHp,this.playerHp+30),this.onVictory?.(this.spec?.name??``,e)}break}case`won`:this.phaseT>=mm&&(this.round++,this.tower.setProgress(this.round),this.clearEnemies(),this.round>=Up?(this.best=Math.max(this.best,Up+1),localStorage.setItem(vm,String(this.best)),this.onRunOver?.(Up,this.best,!0),this.phase=`over`,this.phaseT=0):(this.phase=`prep`,this.phaseT=0));break;case`over`:this.phaseT>=hm&&this.begin()}}},bm=new H(17,0,5),xm=4.2,Sm=2,Cm=2,wm=class{group=new An;stock=[];pool=[];lantern;sign;constructor(e){bm.y=Z(bm.x,bm.z),this.group.position.copy(bm),this.group.rotation.y=Math.atan2(-bm.x,-bm.z);let t=new q(Xu(3.2,.9,1.2,.08),X(12160860));t.position.set(0,.45,0);let n=new q(Xu(3.5,.12,1.5,.05),X(14201987));n.position.set(0,.96,0),this.group.add(t,n);for(let e of[-1.5,1.5]){let t=new q(new pa(.09,.1,2.6,7),X(9070144));t.position.set(e,1.3,-.55),this.group.add(t)}for(let e=0;e<7;e++){let t=new q(Xu(.52,.08,1.7,.03),X(e%2?14963535:16117728));t.position.set(-1.56+e*.52,2.5,-.1),t.rotation.x=-.22,this.group.add(t)}let r=new q(Xu(3.4,1.5,.12,.05),X(13349002));r.position.set(0,1.8,-.62),this.group.add(r),this.sign=new q(Xu(1.5,.42,.08,.04),X(5980026)),this.sign.position.set(0,2.95,-.5),this.group.add(this.sign),this.lantern=new q(new _a(.22,0),new qr({color:new K(3.2,2.2,.9)})),this.lantern.layers.set(1),this.lantern.position.set(0,2.2,.5),this.group.add(this.lantern),this.group.traverse(e=>{let t=e;t.isMesh&&t!==this.lantern&&(t.castShadow=!0,t.receiveShadow=!0)}),e.add(this.group)}newRun(e,t){this.pool=e.filter(e=>e!==t);for(let e=this.pool.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[this.pool[e],this.pool[t]]=[this.pool[t],this.pool[e]]}this.stock=[],this.restock(0)}restock(e){let t=Sm+Cm*e;for(;this.stock.length<t&&this.stock.length<this.pool.length;){let e=this.pool[this.stock.length];this.stock.push({id:e,price:45+this.stock.length*10,sold:!1})}}inRange(e){return Math.hypot(e.x-bm.x,e.z-bm.z)<xm}available(){return this.stock.filter(e=>!e.sold)}buy(e){e.sold=!0}update(e,t,n){this.lantern.rotation.y+=e*1.1,this.lantern.position.y=2.2+Math.sin(t*1.8)*.06;let r=n?3.4:1.6;this.lantern.material.color.setRGB(r,r*.68,r*.28),this.lantern.scale.setScalar(n?1.15+Math.sin(t*4)*.08:1)}};function Tm(e,t=220){return t*2**(e/12)}var Em=class{ctx;music;sfx;noise;ready=!1;master;limiter;reverb;constructor(e){if(e)this.ctx=e;else{let e=globalThis,t=e.AudioContext??e.webkitAudioContext;this.ctx=new t({latencyHint:`interactive`})}let t=this.ctx;this.limiter=t.createDynamicsCompressor(),this.limiter.threshold.value=-8,this.limiter.knee.value=6,this.limiter.ratio.value=12,this.limiter.attack.value=.003,this.limiter.release.value=.18,this.master=t.createGain(),this.master.gain.value=.85,this.master.connect(this.limiter).connect(t.destination),this.reverb=t.createConvolver(),this.reverb.buffer=this.impulse(2.2,2.6);let n=t.createGain();n.gain.value=.9,this.reverb.connect(n).connect(this.master),this.music=this.makeBus(.42,.6),this.sfx=this.makeBus(.22,1),this.noise=this.noiseBuffer(2)}makeBus(e,t){let n=this.ctx.createGain();n.gain.value=t,n.connect(this.master);let r=this.ctx.createGain();return r.gain.value=e,n.connect(r).connect(this.reverb),{input:n,send:r,level:t}}impulse(e,t){let n=this.ctx.sampleRate,r=Math.floor(n*e),i=this.ctx.createBuffer(2,r,n);for(let e=0;e<2;e++){let n=i.getChannelData(e),a=0;for(let e=0;e<r;e++){let i=(1-e/r)**t;a+=(Math.random()*2-1-a)*.42,n[e]=a*i}}return i}noiseBuffer(e){let t=this.ctx.sampleRate,n=Math.floor(t*e),r=this.ctx.createBuffer(1,n,t),i=r.getChannelData(0);for(let e=0;e<n;e++)i[e]=Math.random()*2-1;return r}resume(){if(typeof this.ctx.resume!=`function`){this.ready=!0;return}this.ctx.state===`running`?this.ready=!0:this.ctx.resume().then(()=>this.ready=!0)}get now(){return this.ctx.currentTime}setVolume(e){this.master.gain.setTargetAtTime(e,this.now,.02)}osc(e,t,n,r=0){let i=this.ctx.createOscillator();return i.type=e,i.frequency.setValueAtTime(t,n),r&&i.detune.setValueAtTime(r,n),i}gain(e=0){let t=this.ctx.createGain();return t.gain.value=e,t}filter(e,t,n=1){let r=this.ctx.createBiquadFilter();return r.type=e,r.frequency.value=t,r.Q.value=n,r}noiseSource(e,t=1){let n=this.ctx.createBufferSource();return n.buffer=this.noise,n.playbackRate.value=t,n.loop=!0,n.start(e,Math.random()*1.5),n}pluck(e,t,n,r,i){let a=e.gain;a.setValueAtTime(1e-4,t),a.exponentialRampToValueAtTime(Math.max(2e-4,n),t+r),a.exponentialRampToValueAtTime(1e-4,t+r+i)}},Dm=60/88,Om=Dm/4,km=128,Am=.15,jm=25,Mm=[{at:0,tones:[0,3,7],bass:-24},{at:32,tones:[-4,0,3],bass:-28},{at:64,tones:[3,7,10],bass:-21},{at:96,tones:[-2,2,5],bass:-26}],Nm=[[0,0,4],[3,4,4],[7,8,8],[5,16,4],[3,20,4],[0,24,8],[3,32,4],[8,36,4],[12,40,8],[10,48,4],[8,52,4],[3,56,8],[7,64,4],[10,68,4],[15,72,8],[14,80,4],[10,84,4],[7,88,8],[17,96,4],[14,100,4],[10,104,8],[14,112,4],[12,116,4],[10,120,8]],Pm=class{a;intensity=0;enabled=!0;scheduled=0;smooth=0;step=0;nextTime=0;timer=0;started=!1;constructor(e){this.a=e}start(){this.started||(this.started=!0,this.nextTime=this.a.now+.1,this.timer=window.setInterval(()=>this.pump(),jm))}stop(){clearInterval(this.timer),this.started=!1}primeOffline(e,t){let n=Math.ceil(e/Om);for(let e=0;e<n;e++){let n=e*Om;this.smooth=typeof t==`function`?t(n):t,this.emit(e%km,n)}}setEnabled(e){this.enabled=e,this.a.music.input.gain.setTargetAtTime(e?this.a.music.level:0,this.a.now,.15)}update(e,t){let n=t>this.smooth?2.2:.5;this.smooth=ju(this.smooth,Ou(t),n,e),this.intensity=this.smooth}currentChord(){let e=this.step%km,t=Mm[0];for(let n of Mm)e>=n.at&&(t=n);return{root:t.bass,tones:t.tones}}chordAt(e){let t=Mm[0];for(let n of Mm)e>=n.at&&(t=n);return t}pump(){if(!this.started)return;let e=this.a.now+Am,t=0;for(;this.nextTime<e&&t++<96;)this.emit(this.step%km,this.nextTime),this.step++,this.nextTime+=Om}emit(e,t){let n=this.smooth;e%32==0&&(this.strings(this.chordAt(e),t,.16+.1*n),this.scheduled++);for(let[r,i,a]of Nm)i===e&&(this.celesta(r+12,t,.3+.12*n,a*Om),this.scheduled++);let r=Ou((n-.3)/.35);if(r>.01&&e%2==0){let n=this.chordAt(e),i=e/2%6,a=i<3?n.tones[i]:n.tones[5-i];e%16!=0&&(this.harpNote(a,t,.085*r),this.scheduled++)}let i=Ou((n-.18)/.3);i>.01&&e%16==0&&this.bass(this.chordAt(e).bass,t,.34*i);let a=Ou((n-.55)/.3);a>.01&&(e%16==0?this.drum(t,.3*a,96):e%16==10&&this.drum(t,.18*a,132))}celesta(e,t,n,r){let i=this.a,a=Tm(e),o=i.gain(0);o.connect(this.a.music.input);let s=Math.max(r,.9);i.pluck(o,t,n,.008,s);for(let[e,n]of[[1,1],[2,.26],[3,.1]]){let r=i.osc(`sine`,a*e,t),c=i.gain(n);r.connect(c).connect(o),r.start(t),r.stop(t+s+.15)}}strings(e,t,n){let r=this.a,i=Om*32,a=r.gain(0),o=r.filter(`lowpass`,700,.6);a.connect(o).connect(this.a.music.input),a.gain.setValueAtTime(1e-4,t),a.gain.linearRampToValueAtTime(n,t+i*.45),a.gain.linearRampToValueAtTime(n*.8,t+i*.8),a.gain.linearRampToValueAtTime(1e-4,t+i*1.04);for(let n of e.tones)for(let e of[-5,5]){let o=r.osc(`triangle`,Tm(n-12),t,e);o.connect(a),o.start(t),o.stop(t+i*1.06)}}harpNote(e,t,n){let r=this.a,i=r.gain(0),a=r.filter(`lowpass`,2600,.9);i.connect(a).connect(this.a.music.input),r.pluck(i,t,n,.005,.5);let o=r.osc(`triangle`,Tm(e),t);o.connect(i),o.start(t),o.stop(t+.6)}bass(e,t,n){let r=this.a,i=r.gain(0),a=r.filter(`lowpass`,260,1.2);i.connect(a).connect(this.a.music.input),r.pluck(i,t,n,.02,Dm*1.9);let o=r.osc(`sine`,Tm(e),t);o.connect(i),o.start(t),o.stop(t+Dm*2.1)}drum(e,t,n){let r=this.a,i=r.gain(0),a=r.filter(`lowpass`,900,1);i.connect(a).connect(this.a.music.input),r.pluck(i,e,t,.004,.22);let o=r.osc(`sine`,n,e);o.frequency.exponentialRampToValueAtTime(n*.5,e+.1),o.connect(i),o.start(e),o.stop(e+.3);let s=r.gain(0),c=r.filter(`bandpass`,1800,1.2);s.connect(c).connect(this.a.music.input),r.pluck(s,e,t*.22,.002,.05);let l=r.noiseSource(e);l.connect(s),l.stop(e+.12)}},Fm=[[[0,3,7],[-4,0,3],[3,7,10],[-2,2,5]],[[3,7,10],[-2,2,5],[0,3,7],[-4,0,3]],[[3,7,10],[-5,-2,2],[-4,0,3],[-4,-1,3]],[[0,3,7],[-4,0,3],[-2,2,5],[-5,-2,2]]],Im=class{a;music;lastStep=0;chargeVoices=[];chargeGain=null;chargeFilter=null;progression=0;chordStep=0;constructor(e,t){this.a=e,this.music=t}chargeChord(){return Fm[this.progression][this.chordStep%4]}advanceChord(){if(this.chordStep++,this.chordStep%4==0){let e=this.progression;for(;e===this.progression&&Fm.length>1;)e=Math.floor(Math.random()*Fm.length);this.progression=e}}get chordBeat(){return this.chordStep%4}tone(e,t=0){let n=this.music.currentChord(),r=n.tones.length,i=(e%r+r)%r,a=Math.floor(e/r)*12;return n.tones[i]+a+t*12}out(){return this.a.sfx.input}step(e){let t=this.a.now;if(t-this.lastStep<.09)return;this.lastStep=t;let n=this.a,r=n.gain(0),i=n.filter(`bandpass`,900+Math.random()*500,1.1);r.connect(i).connect(this.out()),n.pluck(r,t,.1+.16*e,.003,.055+.03*e);let a=n.noiseSource(t,.8+Math.random()*.5);a.connect(r),a.stop(t+.14)}jump(){let e=this.a,t=e.now,n=e.gain(0),r=e.filter(`lowpass`,2200,1);n.connect(r).connect(this.out()),e.pluck(n,t,.24,.004,.18);let i=e.osc(`triangle`,220,t);i.frequency.exponentialRampToValueAtTime(560,t+.13),i.connect(n),i.start(t),i.stop(t+.24),this.air(.16,.9,2.2)}land(e){let t=this.a,n=t.now,r=Ou(e),i=t.gain(0),a=t.filter(`lowpass`,300+400*r,1.4);i.connect(a).connect(this.out()),t.pluck(i,n,.2+.5*r,.004,.16+.14*r);let o=t.osc(`sine`,150+40*r,n);o.frequency.exponentialRampToValueAtTime(48,n+.11),o.connect(i),o.start(n),o.stop(n+.34);let s=t.gain(0),c=t.filter(`bandpass`,1400,.8);s.connect(c).connect(this.out()),t.pluck(s,n,.12+.2*r,.002,.09);let l=t.noiseSource(n);l.connect(s),l.stop(n+.2)}dash(){let e=this.a,t=e.now;this.air(.34,1.6,4);let n=e.gain(0),r=e.filter(`lowpass`,1600,2);n.connect(r).connect(this.out()),e.pluck(n,t,.16,.006,.18);let i=e.osc(`sawtooth`,420,t);i.frequency.exponentialRampToValueAtTime(120,t+.2),i.connect(n),i.start(t),i.stop(t+.26)}air(e,t,n){let r=this.a,i=r.now,a=r.gain(0),o=r.filter(`bandpass`,700,.9);o.frequency.setValueAtTime(420,i),o.frequency.exponentialRampToValueAtTime(420*n,i+t*.32),o.frequency.exponentialRampToValueAtTime(300,i+t),a.connect(o).connect(this.out()),r.pluck(a,i,e,.02,t);let s=r.noiseSource(i);s.connect(a),s.stop(i+t+.1)}bolt(e){let t=this.a,n=t.now,r=Tm(this.tone(e,1)),i=t.gain(0),a=t.filter(`lowpass`,5200,1.1);i.connect(a).connect(this.out()),t.pluck(i,n,.26,.003,.34);let o=t.osc(`sine`,r,n),s=t.osc(`sine`,r*3.01,n),c=t.gain(r*2.2);c.gain.setValueAtTime(r*2.2,n),c.gain.exponentialRampToValueAtTime(r*.04,n+.16),s.connect(c).connect(o.frequency),o.connect(i),s.start(n),o.start(n),s.stop(n+.4),o.stop(n+.4),this.air(.1,.24,2.6)}fizzle(){let e=this.a,t=e.now,n=e.gain(0),r=e.filter(`bandpass`,1100,4);n.connect(r).connect(this.out()),e.pluck(n,t,.12,.004,.13);let i=e.osc(`square`,300,t);i.frequency.exponentialRampToValueAtTime(110,t+.12),i.connect(n),i.start(t),i.stop(t+.18)}chargeStart(){if(this.chargeVoices.length)return;let e=this.a,t=e.now,n=e.gain(1e-4),r=e.filter(`lowpass`,520,5);n.connect(r).connect(this.out()),n.gain.exponentialRampToValueAtTime(.13,t+.12),this.chargeChord().forEach((r,i)=>{let a=e.gain(i===0?.9:.5),o=e.osc(i===0?`sawtooth`:`triangle`,Tm(r),t,i*4-4);o.connect(a).connect(n),o.start(t),this.chargeVoices.push({osc:o,gain:a})}),this.chargeGain=n,this.chargeFilter=r}chargeUpdate(e){if(!this.chargeVoices.length||!this.chargeGain||!this.chargeFilter)return;let t=this.a.now,n=Ou(e),r=this.chargeChord();this.chargeVoices.forEach((e,i)=>{e.osc.frequency.setTargetAtTime(Tm(r[i%r.length]+12*n*(i===0?1:.5)),t,.06)}),this.chargeFilter.frequency.setTargetAtTime(520+3e3*n*n,t,.06),this.chargeGain.gain.setTargetAtTime(.1+.16*n,t,.05)}chargeStop(){if(!this.chargeGain)return;let e=this.a.now,t=this.chargeGain;t.gain.cancelScheduledValues(e),t.gain.setTargetAtTime(1e-4,e,.03);for(let t of this.chargeVoices)t.osc.stop(e+.2);this.chargeVoices=[],this.chargeGain=null,this.chargeFilter=null}switchSchool(){let e=this.a,t=e.now;this.air(.16,.34,3),this.chargeChord().forEach((n,r)=>{let i=e.gain(0);i.connect(this.out()),e.pluck(i,t+r*.018,.085,.003,.42);let a=e.osc(`sine`,Tm(n+24),t);a.connect(i),a.start(t),a.stop(t+.6)})}blast(e){let t=this.a,n=t.now,r=Ou(e);this.air(.3+.3*r,.7,3.4);let i=t.gain(0),a=t.filter(`lowpass`,900,1.2);i.connect(a).connect(this.out()),t.pluck(i,n,.4+.35*r,.004,.4+.2*r);let o=t.osc(`sine`,180,n);o.frequency.exponentialRampToValueAtTime(38,n+.22),o.connect(i),o.start(n),o.stop(n+.7),this.chargeChord().forEach((e,i)=>{let a=t.gain(0),o=t.filter(`lowpass`,4200,1);a.connect(o).connect(this.out()),t.pluck(a,n+i*.012,.13+.1*r,.004,.75);let s=t.osc(`triangle`,Tm(e+12),n);s.connect(a),s.start(n),s.stop(n+.95)}),this.advanceChord()}hit(e,t){let n=this.a,r=n.now,i=Ou(e),a=n.gain(0),o=n.filter(`bandpass`,420+500*i,.9);a.connect(o).connect(this.out()),n.pluck(a,r,.26+.24*i,.002,.1+.06*i);let s=n.noiseSource(r);s.connect(a),s.stop(r+.24);let c=n.gain(0);c.connect(this.out()),n.pluck(c,r,.16+.08*i,.003,.3);let l=n.osc(`triangle`,Tm(this.tone(t,1)),r);l.connect(c),l.start(r),l.stop(r+.4)}swing(e){this.air(e?.3:.2,e?.42:.26,e?2.4:3.2)}perfect(e){let t=this.a,n=t.now;for(let r=0;r<2;r++){let i=t.gain(0);i.connect(this.out()),t.pluck(i,n+r*.05,.14,.003,.55);let a=t.osc(`sine`,Tm(this.tone(e+r*2,2)),n);a.connect(i),a.start(n),a.stop(n+.7)}}finisher(){let e=this.a,t=e.now;this.music.currentChord().tones.forEach((n,r)=>{let i=e.gain(0);i.connect(this.out()),e.pluck(i,t+r*.028,.15,.004,.8);let a=e.osc(`triangle`,Tm(n+12),t);a.connect(i),a.start(t),a.stop(t+1.1)})}},Lm=1/60,Rm=5,zm=class{tick=0;accumulator=0;alpha=0;advance(e){this.accumulator+=Math.min(e,.25);let t=0;for(;this.accumulator>=.016666666666666666&&t<Rm;)this.accumulator-=Lm,t++;return this.accumulator>=.016666666666666666&&(this.accumulator=0),this.alpha=this.accumulator/Lm,t}consume(){this.tick++}reset(){this.tick=0,this.accumulator=0,this.alpha=0}},Bm=function(e){return e[e.Jump=1]=`Jump`,e[e.Dash=2]=`Dash`,e[e.Primary=4]=`Primary`,e[e.Secondary=8]=`Secondary`,e[e.Wheel=16]=`Wheel`,e}({}),Vm={tick:0,moveX:0,moveY:0,yaw:0,pitch:0,buttons:0,slot:0};function Hm(e,t,n=0){t.setUint32(n,e.tick>>>0,!0),t.setInt8(n+4,Math.round(Gm(e.moveX,-1,1)*127)),t.setInt8(n+5,Math.round(Gm(e.moveY,-1,1)*127)),t.setInt16(n+6,Math.round(Km(e.yaw)*1e4),!0),t.setInt16(n+8,Math.round(Gm(e.pitch,-1.6,1.6)*1e4),!0),t.setUint8(n+10,e.buttons&255),t.setUint8(n+11,e.slot&255)}function Um(e,t=0){return{tick:e.getUint32(t,!0),moveX:e.getInt8(t+4)/127,moveY:e.getInt8(t+5)/127,yaw:e.getInt16(t+6,!0)/1e4,pitch:e.getInt16(t+8,!0)/1e4,buttons:e.getUint8(t+10),slot:e.getUint8(t+11)}}function Wm(e){let t=new DataView(new ArrayBuffer(12));return Hm(e,t),Um(t)}function Gm(e,t,n){return e<t?t:e>n?n:e}function Km(e){let t=Math.PI*2;return(e%t+t+Math.PI)%t-Math.PI}var qm=30,Jm=class{transport;hooks;clock=new zm;stalledTicks=0;onDesync=null;queues=new Map;lastKnown=new Map;myChecksums=new Map;pendingOut=[];constructor(e,t){this.transport=e,this.hooks=t;for(let t of e.peers)this.queues.set(t,new Map),this.lastKnown.set(t,{...Vm})}get tick(){return this.clock.tick}get alpha(){return this.clock.alpha}get solo(){return this.transport.peers.length<=1}update(e,t){this.drain();let n=this.clock.advance(e),r=0;for(let e=0;e<n;e++){let e=this.clock.tick,n=e+4;if(!this.queues.get(this.transport.localId).has(n)){let e=Wm({...t(n),tick:n});this.queues.get(this.transport.localId).set(n,e),this.pendingOut.push(e)}if(!this.hasAllInputs(e)){this.stalledTicks++;break}let i=new Map;for(let t of this.transport.peers){let n=this.queues.get(t),r=n.get(e)??this.lastKnown.get(t);i.set(t,r),this.lastKnown.set(t,r),n.delete(e)}this.hooks.step(Lm,i,e),this.clock.consume(),r++,e%qm===0&&(this.myChecksums.set(e,this.hooks.hash()),this.trimChecksums())}return this.flush(),r}hasAllInputs(e){if(e<4)return!0;for(let t of this.transport.peers)if(!this.queues.get(t).has(e))return!1;return!0}drain(){for(let e of this.transport.receive()){let t=this.queues.get(e.from);if(t)for(let n of e.commands)t.set(n.tick,n);if(e.checksum){let t=this.myChecksums.get(e.checksum.tick);t!==void 0&&t!==e.checksum.hash&&this.onDesync?.(e.checksum.tick,t,e.checksum.hash,e.from)}}}flush(){!this.pendingOut.length&&!this.dueChecksum||(this.transport.send({commands:this.pendingOut,checksum:this.dueChecksum}),this.pendingOut=[],this.dueChecksum=void 0)}dueChecksum;publishChecksum(){let e=-1;for(let t of this.myChecksums.keys())t>e&&(e=t);e>=0&&(this.dueChecksum={tick:e,hash:this.myChecksums.get(e)})}trimChecksums(){if(this.myChecksums.size<64)return;let e=[...this.myChecksums.keys()].sort((e,t)=>e-t);for(let t=0;t<e.length-32;t++)this.myChecksums.delete(e[t])}close(){this.transport.close()}};function Ym(e,t){let n=Math.round(t*1e3)|0;return e^=n+2654435769+(e<<6|0)+(e>>>2),e|0}function Xm(e,t){return e^=(t|0)+2654435769+(e<<6|0)+(e>>>2),e|0}var Zm=class{localId=0;peers=[0];ready=!0;seed;inbox=[];constructor(e=Math.random()*4294967295>>>0){this.seed=e>>>0}send(e){this.inbox.push({...e,from:this.localId})}receive(){let e=this.inbox;return this.inbox=[],e}close(){this.inbox=[]}},Qm=class{cur={...Vm};prev={...Vm};set(e){this.prev=this.cur,this.cur=e}get command(){return this.cur}get yaw(){return this.cur.yaw}get pitch(){return this.cur.pitch}bit(e){switch(e){case`Space`:return Bm.Jump;case`ShiftLeft`:case`ShiftRight`:return Bm.Dash;default:return 0}}down(e){let t=this.bit(e);return t!==0&&(this.cur.buttons&t)!==0}pressed(e){let t=this.bit(e);return e!==`ShiftRight`&&t!==0&&(this.cur.buttons&t)!==0&&(this.prev.buttons&t)===0}mouseDown(e){let t=e===0?Bm.Primary:e===2?Bm.Secondary:0;return t!==0&&(this.cur.buttons&t)!==0}mousePressed(e){let t=e===0?Bm.Primary:e===2?Bm.Secondary:0;return t!==0&&(this.cur.buttons&t)!==0&&(this.prev.buttons&t)===0}moveAxis(){let e=this.cur.moveX,t=this.cur.moveY,n=Math.hypot(e,t);return n>1?{x:e/n,y:t/n}:{x:e,y:t}}},$m=new class{s;constructor(e){this.s=e>>>0||1}next(){this.s=this.s+1831565813>>>0;let e=this.s;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}range(e,t){return e+(t-e)*this.next()}int(e){return Math.floor(this.next()*e)}spread(e){return(this.next()*2-1)*e}pick(e){return e[this.int(e.length)]}chance(e){return this.next()<e}save(){return this.s}restore(e){this.s=e>>>0}reseed(e){this.s=e>>>0||1}}(24301),eh=document.getElementById(`game`),th=new Su({canvas:eh,antialias:!1,powerPreference:`high-performance`});th.setPixelRatio(Math.min(window.devicePixelRatio,2)),th.outputColorSpace=Ge,th.toneMapping=0,th.shadowMap.enabled=!0,th.shadowMap.type=2,th.setClearColor(16770237);var nh=new zn;nh.fog=new Rn(16769986,70,320);var rh=new gf(innerWidth/innerHeight);rh.camera.layers.enable(1);var ih=new od(nh),ah=ad(ih.dirToSun);nh.add(ah);var oh=new Qu;nh.add(oh.group);var sh=new id;nh.add(sh.group);var ch=new ud;ch.pos.set(0,Z(0,3),3);var lh=new mf;nh.add(lh.group);var uh=new cd(nh,220),dh=new cd(nh,150,new ba(1,5,4),1.6);dh.wind=(e,t,n)=>n.set(Math.sin(e*.5+t.z*.1)*.3,.1,Math.cos(e*.4+t.x*.08)*.3);var fh=new cd(nh,220,new ba(1,5,4),2),ph=new Ef,mh=new Tf(ph);nh.add(mh.group);var hh=new Em,gh=new Pm(hh),_h=new Im(hh,gh),vh=new Tu(eh),yh=new yf;vh.onLockChange=e=>{yh.setLocked(e),e&&(hh.resume(),gh.start())},eh.addEventListener(`mousedown`,()=>hh.resume(),{once:!0}),rh.onSensChange=e=>yh.toast(`sensitivity ${e}%  ·  [ and ] adjust`);var bh=new em(ch,rh,ph),xh=new Op(nh,ch,rh,lh,bh,ph,oh.monoliths,_h),Sh=0,Ch=0;xh.onHitStop=e=>{Sh=Math.max(Sh,e),Ch=1};function wh(e){return`#`+e.clone().convertLinearToSRGB().getHexString()}function Th(){let e=xh.school;bh.enabled=e.id===`arcane`,bh.enabled||bh.cancelInto(),lh.setCrystalColor(e.color),yh.setSchool(e.name,`${e.primaryLabel}  ·  ${e.secondaryLabel}`,wh(e.color))}var Eh=new wm(nh),Dh=new ym(nh,ph);function Oh(){let e=Object.keys(xh.all),t=e[Math.floor(Math.random()*e.length)];xh.reset(t),Eh.newRun(e,t),Ah(),yh.banner(`NEW RUN`,xh.school.name.toUpperCase(),`walk into the ring to begin`,!1)}Dh.onRunStart=()=>Oh(),Dh.onAnnounce=(e,t,n)=>{yh.banner(n?`ROUND ${t} · BOSS`:`ROUND ${t}`,e,n?`boss`:`challenger`,n),yh.setFoe(``,1),_h.finisher()},Dh.onVictory=(e,t)=>{yh.banner(`DEFEATED`,e,`+${t} coins`,!1),yh.setFoe(``,1),_h.finisher(),rh.addShake(.2),Eh.restock(Wp.filter(e=>e<Dh.round+1).length)},Dh.onRunOver=(e,t,n)=>{yh.banner(n?`NEW BEST`:`RUN OVER`,`ROUND ${e}`,`best · round ${t}`,n),yh.setFoe(``,1),_h.land(1)},Dh.onPlayerHurt=()=>{yh.hurtFlash(),rh.addShake(.32),rh.kick(-.5),Sh=Math.max(Sh,.07),_h.hit(.9,0)},Dh.onEnemyTelegraph=e=>{Nh.set(e.pos.x,e.pos.y+e.height*.9,e.pos.z),Rh(Nh,5,2.4,.05,!1)},Dh.onEnemyDeath=e=>{Nh.set(e.pos.x,e.pos.y+e.height*.5,e.pos.z),Rh(Nh,26,6,.09,!0),Lh(e.pos.x,e.pos.y,e.pos.z,14,2.4,.5,.09),rh.addShake(.26),_h.blast(.7),Sh=Math.max(Sh,.11)},mh.setVisible(!1);var kh=new am(e=>xh.selectSlot(e));xh.onSwitch=()=>Th();function Ah(){kh.setLoadout(xh.loadout.map(e=>xh.all[e]??null))}Dh.begin();var jh=Bu(th,nh,rh.camera);function Mh(){th.setSize(innerWidth,innerHeight,!1),rh.setAspect(innerWidth/innerHeight),jh.resize(innerWidth,innerHeight)}window.addEventListener(`resize`,Mh),Mh();var Nh=new H,Ph=new H,Fh=14931386,Ih=[16770728,16774878,16765034];function Lh(e,t,n,r,i,a,o=.07){for(let s=0;s<r;s++){let r=Math.random()*Math.PI*2,s=Math.random()*i;Nh.set(e+Math.cos(r)*.1,t+.05,n+Math.sin(r)*.1),Ph.set(Math.cos(r)*s,a*(.5+Math.random()),Math.sin(r)*s),uh.spawn(Nh,Ph,{life:.35+Math.random()*.3,size:o*(.7+Math.random()*.7),color:Fh,gravity:-1.4,drag:3})}}function Rh(e,t,n,r,i){for(let a=0;a<t;a++)Ph.set(Math.random()*2-1,Math.random()*1.6-.3,Math.random()*2-1).normalize().multiplyScalar(n*(.5+Math.random()*.8)),fh.spawn(e,Ph,{life:.25+Math.random()*.3,size:r*(.6+Math.random()*.8),color:i?16774352:Ih[Math.floor(Math.random()*Ih.length)],gravity:-4,drag:3.4})}bh.onSwing=e=>{_h.swing(e),Ch=1;let t=ch.pos;Lh(t.x,t.y,t.z,e?5:2,e?1.6:.9,.3,.06),e&&rh.kick(.5)},bh.onBegin=(e,t,n)=>lh.attack(e,t,n),bh.onPerfect=e=>{_h.perfect(e),rh.kick(.35),bh.swingPoint(Nh),Rh(Nh,10,4,.06,!0)},bh.onFinisher=()=>{_h.finisher(),rh.addShake(.3)},bh.onFlow=e=>{xh.flow=Du(xh.flow+e,0,Dp.max)},bh.onHit=(e,t,n,r)=>{_h.hit(t,n),Sh=Math.max(Sh,.05+t*.05),rh.addShake(.08+t*.18),Ch=1,Nh.set(e.pos.x,1.1,e.pos.z),Rh(Nh,Math.round(8+12*t),4+4*t,.07,r)};var zh=[16767392,16763352,16773832,16771504],Bh=0,Vh=0,Hh=0,Uh=0,Wh=0,Gh=new Qm,Kh={jump:!1,dash:!1,primary:!1,secondary:!1};function qh(){vh.pressed(`Space`)&&(Kh.jump=!0),(vh.pressed(`ShiftLeft`)||vh.pressed(`ShiftRight`))&&(Kh.dash=!0),vh.mousePressed(0)&&(Kh.primary=!0),vh.mousePressed(2)&&(Kh.secondary=!0)}function Jh(e){let t=vh.moveAxis(),n=0;return(vh.down(`Space`)||Kh.jump)&&(n|=Bm.Jump),(vh.down(`ShiftLeft`)||vh.down(`ShiftRight`)||Kh.dash)&&(n|=Bm.Dash),(vh.mouseDown(0)||Kh.primary)&&(n|=Bm.Primary),(vh.mouseDown(2)||Kh.secondary)&&(n|=Bm.Secondary),Kh.jump=Kh.dash=Kh.primary=Kh.secondary=!1,{tick:e,moveX:t.x,moveY:t.y,yaw:rh.forwardYaw,pitch:rh.pitch,buttons:n,slot:xh.slot}}function Yh(){let e=2166136261;e=Ym(e,ch.pos.x),e=Ym(e,ch.pos.y),e=Ym(e,ch.pos.z),e=Ym(e,ch.vel.x),e=Ym(e,ch.vel.y),e=Ym(e,ch.vel.z),e=Ym(e,ch.yaw),e=Xm(e,+!!ch.grounded),e=Ym(e,xh.flow),e=Xm(e,xh.slot),e=Xm(e,bh.index),e=Xm(e,bh.combo),e=Ym(e,Dh.playerHp),e=Xm(e,Dh.round);for(let t of Dh.enemies)e=Ym(e,t.pos.x),e=Ym(e,t.pos.z),e=Ym(e,t.hp),e=Xm(e,+!!t.alive);return e=Xm(e,$m.save()),e|0}var Xh=new Jm(new Zm,{step:(e,t)=>{let n=t.get(0);n&&Gh.set(n),eg(e)},hash:Yh});Xh.onDesync=(e,t,n)=>{console.warn(`[desync] tick ${e}: ${t} vs ${n}`),yh.toast(`desync detected`)},$m.reseed(Xh.solo?24301:0);var Zh=performance.now();function Qh(e){requestAnimationFrame(Qh);let t=Du((e-Zh)/1e3,1e-4,.25);Zh=e,qh(),$h(t),Xh.update(t,Jh),tg(t),vh.endFrame()}function $h(e){let t=vh.down(`KeyQ`);t&&!kh.open&&kh.show(xh.slot),!t&&kh.open&&kh.hide(!0),kh.open?(kh.aim(vh.mouseDX,vh.mouseDY),vh.wheelSteps&&kh.step(Math.sign(vh.wheelSteps)),vh.mouseDX=0,vh.mouseDY=0):vh.wheelSteps&&xh.cycle(Math.sign(vh.wheelSteps)),kh.update(e),vh.pressed(`KeyM`)&&(gh.setEnabled(!gh.enabled),yh.toast(gh.enabled?`music on`:`music off  ·  M toggles`)),rh.update(e,Uh,vh,ch);let n=Dh.phase===`prep`&&Eh.inRange(ch.pos);if(Eh.update(e,Uh,n),n){let e=Eh.stock;yh.setShop(!0,e.map((e,t)=>{let n=xh.all[e.id];return{key:String(t+1),name:n.name,blurb:n.blurb,price:e.price,afford:!e.sold&&Dh.coins>=e.price&&!xh.full,sold:e.sold}}),xh.full?`wheel is full — 4 is the limit`:`${4-xh.loadout.length} slot(s) open · press the number to buy`);for(let t=0;t<e.length&&t<9;t++){if(!vh.pressed(`Digit${t+1}`))continue;let n=e[t];if(n.sold||xh.full||Dh.coins<n.price){_h.fizzle();continue}Dh.coins-=n.price,Eh.buy(n),xh.equip(n.id),Ah(),_h.finisher(),yh.toast(`${xh.all[n.id].name} added to the wheel`)}}else yh.setShop(!1,[],``);if(Dh.phase===`prep`){let e=Dh.distanceToRing(ch.pos);yh.setCallout(n?``:e<11?`step into the ring — round ${Dh.roundNumber}`:`round ${Dh.roundNumber} · walk to the ring, or visit the hut`)}else yh.setCallout(``)}function eg(e){Sh=Math.max(0,Sh-e);let t=Sh>0?e*.06:e,n=t*(kh.open&&Xh.solo?.18:1);Uh+=t,bh.update(n,Gh),ch.update(n,Gh,Gh.yaw);let r=ch.pos;xh.update(n,Gh);let i=ch.events;if(i.dashed&&(rh.kick(1),_h.dash(),Lh(r.x,r.y,r.z,9,2.4,.4,.08)),i.jumped&&(_h.jump(),Lh(r.x,r.y,r.z,4,1.2,.3,.06)),i.land){let e=i.land;_h.land(e/20),Lh(r.x,r.y,r.z,Math.min(16,Math.round(e*.9)),1.2+e*.12,.35,.085),e>8&&rh.addShake(Math.min(.4,e*.016)),i.landedOnConstruct&&_h.step(1)}lh.update(t,Uh,ch);let a=Math.sin(lh.phase);ch.grounded&&ch.planarSpeed>1.6&&Hh*a<0&&(_h.step(ch.speed01),ch.planarSpeed>5.5&&Lh(r.x,r.y,r.z,2,.7,.35,.055)),Hh=a,Vh-=t,ch.skidding&&Vh<=0&&(Vh=.05,Lh(r.x-ch.vel.x*.04,r.y,r.z-ch.vel.z*.04,2,.5,.5,.06)),bh.phase===`active`&&(bh.swingPoint(Nh),Ph.set((Math.random()-.5)*1.2,(Math.random()-.5)*1.2,(Math.random()-.5)*1.2),fh.spawn(Nh,Ph,{life:.22,size:.05,color:12576511,drag:5})),Dh.update(n,Uh,r),xh.freeze(Dh.phase===`prep`||Dh.phase===`over`),mh.update(t)}function tg(e){let t=ch.pos;if(lh.group.position.copy(t),lh.group.rotation.y=ch.yaw,Bh-=e,Bh<=0){Bh=.09;let e=Math.random()*Math.PI*2,n=3+Math.random()*16,r=t.x+Math.cos(e)*n,i=t.z+Math.sin(e)*n;Nh.set(r,Z(r,i)+.4+Math.random()*4.2,i),Ph.set(0,.1+Math.random()*.2,0),dh.spawn(Nh,Ph,{life:3.5+Math.random()*4,size:.03+Math.random()*.035,color:zh[Math.floor(Math.random()*zh.length)],gravity:0,drag:0})}vh.locked&&(Wh+=e),Ch=ju(Ch,0,.75,e);let n=Ou(ch.planarSpeed/ld.sprint),r=ch.grounded?0:Ou(ch.airT*2);if(gh.update(e,.16+.5*n+.42*Ch+.1*r+.3*Dh.pressure),Dh.phase===`fight`){yh.banner(``,``,``);let e=null;for(let t of Dh.enemies)t.alive&&(!e||t.maxHp>e.maxHp)&&(e=t);e&&yh.setFoe(e.spec.name,e.hp/e.maxHp)}yh.setVitals(Dh.playerHp/Dh.playerMaxHp),yh.setPurse(Dh.coins,Dh.best),oh.update(Uh,e),sh.update(Uh,e),ih.follow(t),ah.position.copy(rh.camera.position),uh.update(e,Uh),dh.update(e,Uh),fh.update(e,Uh),Wh>12&&yh.retireHint(),yh.tick(e,ch.planarSpeed),yh.setMagic(xh.flow/Dp.max,xh.charge01,xh.lowFlow),yh.setCombo(bh.combo,bh.perfectStreak),yh.setPrompt(xh.school.prompt),jh.render()}requestAnimationFrame(Qh);