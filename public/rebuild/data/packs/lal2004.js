export default {
  ...
  tradeBlock: [
    ...
    { name: "Vince Carter", team: "TOR", pos: "SG", age: 27, sal: 13.0,
      ...
      cost: 170, from: 2004, until: 2004, direction: "retooling",
    ...
    { name: "Kwame Brown", team: "WAS", pos: "C", age: 22, sal: 5.0,
      ...
      cost: 70, from: 2004, until: 2004, direction: "retooling",
    ...
    { name: "Ron Artest", team: "IND", pos: "SF", age: 25, sal: 6.8,
      ...
      cost: 150, from: 2005, until: 2005, direction: "retooling",
    ...
    { name: "Mike Bibby", team: "SAC", pos: "PG", age: 27, sal: 11.5,
      ...
      cost: 170, from: 2005, until: 2006, direction: "retooling",
    ...
    { name: "Shawn Marion", team: "PHX", pos: "SF", age: 27, sal: 14.8,
      ...
      cost: 300, from: 2005, until: 2007, direction: "retooling",
    ...
    { name: "Jermaine O'Neal", team: "IND", pos: "PF", age: 27, sal: 18.1,
      ovr: { 2006: 84, 2007: 81 },
      cost: 250, from: 2006, until: 2007, direction: "retooling",
    ...
    { name: "Zach Randolph", team: "POR", pos: "PF", age: 25, sal: 12.9,
      ovr: { 2006: 80, 2007: 81 },
      cost: 140, from: 2006, until: 2007, direction: "retooling",
    ...
    { name: "Kevin Garnett", team: "MIN", pos: "PF", age: 31, sal: 23.8,
      ovr: { 2007: 91 },
      cost: 520, from: 2007, until: 2007, direction: "retooling",
