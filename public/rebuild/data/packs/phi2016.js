export default {
  ...
  tradeBlock: [
    { name: "Jimmy Butler", team: "MIN", pos: "SG", age: 28, sal: 19.3,
      ...
      cost: 480, from: 2017, until: 2018, direction: "contending",
    ...
    { name: "Kawhi Leonard", team: "SAS", pos: "SF", age: 27, sal: 23.1,
      ...
      cost: 520, from: 2018, until: 2018, direction: "contending",
    ...
    { name: "Paul George", team: "IND", pos: "SF", age: 27, sal: 18.3,
      ...
      cost: 420, from: 2017, until: 2017, direction: "retooling",
    ...
    { name: "Kyle Lowry", team: "TOR", pos: "PG", age: 30, sal: 12.0,
      ...
      cost: 300, from: 2016, until: 2017, direction: "retooling",
    ...
    { name: "DeMarcus Cousins", team: "SAC", pos: "C", age: 26, sal: 16.9,
      ...
      cost: 380, from: 2016, until: 2016, direction: "retooling",
    ...
    { name: "Tobias Harris", team: "LAC", pos: "PF", age: 26, sal: 14.8,
      ...
      cost: 250, from: 2018, until: 2018, direction: "retooling",
    ...
    { name: "Marc Gasol", team: "MEM", pos: "C", age: 33, sal: 24.1,
      ...
      cost: 150, from: 2018, until: 2018, direction: "retooling",
    ...
    { name: "Mike Conley", team: "MEM", pos: "PG", age: 31, sal: 30.5,
      ...
      cost: 200, from: 2018, until: 2019, direction: "retooling",
    ...
    { name: "Eric Bledsoe", team: "PHX", pos: "PG", age: 27, sal: 14.5,
      ...
      cost: 150, from: 2017, until: 2017, direction: "retooling",
