export default {
  ...
  tradeBlock: [
    { name: "Kevin Love", team: "MIN", pos: "PF", age: 25, sal: 15.7,
      ...
      cost: 380, from: 2014, until: 2014, direction: "rebuilding",
    ...
    { name: "Timofey Mozgov", team: "DEN", pos: "C", age: 28, sal: 4.7,
      ...
      cost: 80, from: 2014, until: 2014, direction: "retooling",
    ...
    { name: "Kyle Korver", team: "ATL", pos: "SG", age: 35, sal: 5.2,
      ovr: { 2016: 76, 2017: 74 },
      cost: 60, from: 2016, until: 2016, direction: "retooling",
    ...
    { name: "Channing Frye", team: "ORL", pos: "C", age: 32, sal: 8.2,
      ...
      cost: 40, from: 2015, until: 2016, direction: "retooling",
    ...
    { name: "Thaddeus Young", team: "PHI", pos: "PF", age: 26, sal: 9.4,
      ...
      cost: 110, from: 2014, until: 2014, direction: "rebuilding",
      note: "Philadelphia is tearing it down to the studs." },
    { name: "Paul George", team: "IND", pos: "SF", age: 27, sal: 19.5,
      ovr: { 2017: 89 },
      cost: 400, from: 2017, until: 2017, direction: "rebuilding",
    ...
    { name: "Eric Bledsoe", team: "PHX", pos: "PG", age: 27, sal: 14.5,
      ovr: { 2017: 83 },
      cost: 150, from: 2017, until: 2017, direction: "rebuilding",
    ...
    { name: "P.J. Tucker", team: "TOR", pos: "PF", age: 32, sal: 5.3,
      ovr: { 2016: 74, 2017: 74 },
      cost: 40, from: 2017, until: 2017, direction: "rebuilding",
