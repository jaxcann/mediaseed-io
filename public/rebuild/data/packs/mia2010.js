export default {
  ...
  tradeBlock: [
    { name: "Carmelo Anthony", team: "DEN", pos: "SF", age: 26, sal: 17.1,
      ...
      cost: 480, from: 2010, until: 2011, direction: "retooling",
    ...
    { name: "Chris Paul", team: "NOH", pos: "PG", age: 26, sal: 16.4,
      ...
      cost: 520, from: 2011, until: 2011, direction: "contending",
    ...
    { name: "Rajon Rondo", team: "BOS", pos: "PG", age: 24, sal: 10.0,
      ...
      cost: 350, from: 2010, until: 2012, direction: "retooling",
    ...
    { name: "Pau Gasol", team: "LAL", pos: "C", age: 31, sal: 18.7,
      ...
      cost: 300, from: 2011, until: 2013, direction: "retooling",
    ...
    { name: "Andre Iguodala", team: "PHI", pos: "SF", age: 26, sal: 12.3,
      ...
      cost: 260, from: 2010, until: 2011, direction: "retooling",
    ...
    { name: "Zach Randolph", team: "MEM", pos: "PF", age: 29, sal: 16.9,
      ...
      cost: 200, from: 2010, until: 2011, direction: "retooling",
    ...
    { name: "Rudy Gay", team: "MEM", pos: "SF", age: 24, sal: 13.6,
      ...
      cost: 220, from: 2010, until: 2012, direction: "retooling",
    ...
    { name: "Monta Ellis", team: "GSW", pos: "SG", age: 24, sal: 11.0,
      ...
      cost: 160, from: 2010, until: 2011, direction: "retooling",
    ...
    { name: "Marcin Gortat", team: "ORL", pos: "C", age: 26, sal: 6.3,
      ...
      cost: 90, from: 2010, until: 2011, direction: "retooling",
