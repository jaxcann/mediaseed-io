export default {
  ...
  tradeBlock: [
    { name: "Pau Gasol", team: "MEM", pos: "C", age: 27, sal: 13.7,
      ...
      cost: 300, from: 2007, until: 2007, direction: "retooling",
    ...
    { name: "Shaquille O'Neal", team: "MIA", pos: "C", age: 35, sal: 20.0,
      ...
      cost: 220, from: 2007, until: 2008, direction: "retooling",
    ...
    { name: "Mike Bibby", team: "SAC", pos: "PG", age: 29, sal: 13.5,
      ...
      cost: 120, from: 2007, until: 2007, direction: "rebuilding",
    ...
    { name: "Ron Artest", team: "SAC", pos: "SF", age: 27, sal: 7.4,
      ...
      cost: 160, from: 2007, until: 2008, direction: "rebuilding",
    ...
    { name: "Zach Randolph", team: "NYK", pos: "PF", age: 26, sal: 13.3,
      ...
      cost: 130, from: 2007, until: 2008, direction: "retooling",
    ...
    { name: "Marcus Camby", team: "DEN", pos: "C", age: 34, sal: 9.1,
      ...
      cost: 60, from: 2008, until: 2008, direction: "retooling",
    ...
    { name: "Vince Carter", team: "NJN", pos: "SG", age: 31, sal: 13.7,
      ...
      cost: 240, from: 2008, until: 2009, direction: "retooling",
    ...
    { name: "Richard Jefferson", team: "MIL", pos: "SF", age: 28, sal: 13.2,
      ...
      cost: 150, from: 2008, until: 2008, direction: "retooling",
    ...
    { name: "Stephen Jackson", team: "GSW", pos: "SF", age: 31, sal: 7.7,
      ovr: { 2009: 79, 2010: 77 },
      cost: 100, from: 2009, until: 2010, direction: "retooling",
    ...
    { name: "Antawn Jamison", team: "WAS", pos: "PF", age: 33, sal: 11.6,
      ovr: { 2009: 81, 2010: 78 },
      cost: 150, from: 2009, until: 2010, direction: "retooling",
